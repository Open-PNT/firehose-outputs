 ...
 */
#ifndef _aspn23_lcm_measurement_time_frequency_difference_h
#define _aspn23_lcm_measurement_time_frequency_difference_h
...
#define ASPN23_LCM_MEASUREMENT_TIME_FREQUENCY_DIFFERENCE_ERROR_MODEL_NONE 0
 ...
 */
typedef struct _aspn23_lcm_measurement_time_frequency_difference aspn23_lcm_measurement_time_frequency_difference;
struct _aspn23_lcm_measurement_time_frequency_difference
{
...
/**
 * Create a deep copy of a aspn23_lcm_measurement_time_frequency_difference.
 * When no longer needed, destroy it with aspn23_lcm_measurement_time_frequency_difference_destroy()
 */
aspn23_lcm_measurement_time_frequency_difference* aspn23_lcm_measurement_time_frequency_difference_copy(const aspn23_lcm_measurement_time_frequency_difference* to_copy);

/**
 * Destroy an instance of aspn23_lcm_measurement_time_frequency_difference created by aspn23_lcm_measurement_time_frequency_difference_copy()
 */
void aspn23_lcm_measurement_time_frequency_difference_destroy(aspn23_lcm_measurement_time_frequency_difference* to_destroy);

/**
 * Identifies a single subscription.  This is an opaque data type.
 */
typedef struct _aspn23_lcm_measurement_time_frequency_difference_subscription_t aspn23_lcm_measurement_time_frequency_difference_subscription_t;

/**
 * Prototype for a callback function invoked when a message of type
 * aspn23_lcm_measurement_time_frequency_difference is received.
 */
typedef void(*aspn23_lcm_measurement_time_frequency_difference_handler_t)(
    const lcm_recv_buf_t *rbuf, const char *channel,
    const aspn23_lcm_measurement_time_frequency_difference *msg, void *userdata);

/**
 * Publish a message of type aspn23_lcm_measurement_time_frequency_difference using LCM.
 *
 ...
 */
int aspn23_lcm_measurement_time_frequency_difference_publish(lcm_t *lcm, const char *channel, const aspn23_lcm_measurement_time_frequency_difference *msg);

/**
 * Subscribe to messages of type aspn23_lcm_measurement_time_frequency_difference using LCM.
 *
 ...
 */
aspn23_lcm_measurement_time_frequency_difference_subscription_t* aspn23_lcm_measurement_time_frequency_difference_subscribe(
    lcm_t *lcm, const char *channel, aspn23_lcm_measurement_time_frequency_difference_handler_t handler, void *userdata);

/**
 * Removes and destroys a subscription created by aspn23_lcm_measurement_time_frequency_difference_subscribe()
 */
 ...
 * @return 0 on success, <0 if an error occured
 */
int aspn23_lcm_measurement_time_frequency_difference_subscription_set_queue_capacity(
    aspn23_lcm_measurement_time_frequency_difference_subscription_t* subs, int num_messages);

/**
 * Encode a message of type aspn23_lcm_measurement_time_frequency_difference into binary form.
 *
 * @param buf The output buffer.
 * @param offset Encoding starts at this byte offset into @p buf.
 * @param maxlen Maximum number of bytes to write.  This should generally
 *               be equal to aspn23_lcm_measurement_time_frequency_difference_encoded_size().
...
/**
 * Decode a message of type aspn23_lcm_measurement_time_frequency_difference from binary form.
 * When decoding messages containing strings or variable-length arrays, this
 * function may allocate memory.  When finished with the decoded message,
 * release allocated resources with aspn23_lcm_measurement_time_frequency_difference_decode_cleanup().
 *
 ...
 */
int aspn23_lcm_measurement_time_frequency_difference_decode(const void *buf, int offset, int maxlen, aspn23_lcm_measurement_time_frequency_difference *msg);

/**
 * Release resources allocated by aspn23_lcm_measurement_time_frequency_difference_decode()
 * @return 0
 */
int aspn23_lcm_measurement_time_frequency_difference_decode_cleanup(aspn23_lcm_measurement_time_frequency_difference *p);

/**
 * Check how many bytes are required to encode a message of type aspn23_lcm_measurement_time_frequency_difference
 */
...
int __aspn23_lcm_measurement_time_frequency_difference_encode_array(
    void *buf, int offset, int maxlen, const aspn23_lcm_measurement_time_frequency_difference *p, int elements);
int __aspn23_lcm_measurement_time_frequency_difference_decode_array(
    const void *buf, int offset, int maxlen, aspn23_lcm_measurement_time_frequency_difference *p, int elements);
