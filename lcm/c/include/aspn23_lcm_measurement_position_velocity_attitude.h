 ...
 */
#ifndef _aspn23_lcm_measurement_position_velocity_attitude_h
#define _aspn23_lcm_measurement_position_velocity_attitude_h
 ...
 */
#define ASPN23_LCM_MEASUREMENT_POSITION_VELOCITY_ATTITUDE_REFERENCE_FRAME_ECI 0
 ...
 * omitted.
 */
#define ASPN23_LCM_MEASUREMENT_POSITION_VELOCITY_ATTITUDE_REFERENCE_FRAME_GEODETIC 1
/// No additional error model provided (num_error_model_params = 0).
#define ASPN23_LCM_MEASUREMENT_POSITION_VELOCITY_ATTITUDE_ERROR_MODEL_NONE 0
 ...
 */
typedef struct _aspn23_lcm_measurement_position_velocity_attitude aspn23_lcm_measurement_position_velocity_attitude;
struct _aspn23_lcm_measurement_position_velocity_attitude
{
...
/**
 * Create a deep copy of a aspn23_lcm_measurement_position_velocity_attitude.
 * When no longer needed, destroy it with aspn23_lcm_measurement_position_velocity_attitude_destroy()
 */
aspn23_lcm_measurement_position_velocity_attitude* aspn23_lcm_measurement_position_velocity_attitude_copy(const aspn23_lcm_measurement_position_velocity_attitude* to_copy);

/**
 * Destroy an instance of aspn23_lcm_measurement_position_velocity_attitude created by aspn23_lcm_measurement_position_velocity_attitude_copy()
 */
void aspn23_lcm_measurement_position_velocity_attitude_destroy(aspn23_lcm_measurement_position_velocity_attitude* to_destroy);

/**
 * Identifies a single subscription.  This is an opaque data type.
 */
typedef struct _aspn23_lcm_measurement_position_velocity_attitude_subscription_t aspn23_lcm_measurement_position_velocity_attitude_subscription_t;

/**
 * Prototype for a callback function invoked when a message of type
 * aspn23_lcm_measurement_position_velocity_attitude is received.
 */
typedef void(*aspn23_lcm_measurement_position_velocity_attitude_handler_t)(
    const lcm_recv_buf_t *rbuf, const char *channel,
    const aspn23_lcm_measurement_position_velocity_attitude *msg, void *userdata);

/**
 * Publish a message of type aspn23_lcm_measurement_position_velocity_attitude using LCM.
 *
 ...
 */
int aspn23_lcm_measurement_position_velocity_attitude_publish(lcm_t *lcm, const char *channel, const aspn23_lcm_measurement_position_velocity_attitude *msg);

/**
 * Subscribe to messages of type aspn23_lcm_measurement_position_velocity_attitude using LCM.
 *
 ...
 */
aspn23_lcm_measurement_position_velocity_attitude_subscription_t* aspn23_lcm_measurement_position_velocity_attitude_subscribe(
    lcm_t *lcm, const char *channel, aspn23_lcm_measurement_position_velocity_attitude_handler_t handler, void *userdata);

/**
 * Removes and destroys a subscription created by aspn23_lcm_measurement_position_velocity_attitude_subscribe()
 */
 ...
 * @return 0 on success, <0 if an error occured
 */
int aspn23_lcm_measurement_position_velocity_attitude_subscription_set_queue_capacity(
    aspn23_lcm_measurement_position_velocity_attitude_subscription_t* subs, int num_messages);

/**
 * Encode a message of type aspn23_lcm_measurement_position_velocity_attitude into binary form.
 *
 * @param buf The output buffer.
 * @param offset Encoding starts at this byte offset into @p buf.
 * @param maxlen Maximum number of bytes to write.  This should generally
 *               be equal to aspn23_lcm_measurement_position_velocity_attitude_encoded_size().
...
/**
 * Decode a message of type aspn23_lcm_measurement_position_velocity_attitude from binary form.
 * When decoding messages containing strings or variable-length arrays, this
 * function may allocate memory.  When finished with the decoded message,
 * release allocated resources with aspn23_lcm_measurement_position_velocity_attitude_decode_cleanup().
 *
 ...
 */
int aspn23_lcm_measurement_position_velocity_attitude_decode(const void *buf, int offset, int maxlen, aspn23_lcm_measurement_position_velocity_attitude *msg);

/**
 * Release resources allocated by aspn23_lcm_measurement_position_velocity_attitude_decode()
 * @return 0
 */
int aspn23_lcm_measurement_position_velocity_attitude_decode_cleanup(aspn23_lcm_measurement_position_velocity_attitude *p);

/**
 * Check how many bytes are required to encode a message of type aspn23_lcm_measurement_position_velocity_attitude
 */
...
int __aspn23_lcm_measurement_position_velocity_attitude_encode_array(
    void *buf, int offset, int maxlen, const aspn23_lcm_measurement_position_velocity_attitude *p, int elements);
int __aspn23_lcm_measurement_position_velocity_attitude_decode_array(
    const void *buf, int offset, int maxlen, aspn23_lcm_measurement_position_velocity_attitude *p, int elements);
