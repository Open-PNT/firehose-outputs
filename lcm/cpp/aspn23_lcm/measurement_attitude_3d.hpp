 ...
 */
#ifndef __aspn23_lcm_measurement_attitude_3d_hpp__
#define __aspn23_lcm_measurement_attitude_3d_hpp__
...
class measurement_attitude_3d
{
    ...
    public:
        ...
        /**
         * Returns "measurement_attitude_3d"
         */
...
int measurement_attitude_3d::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int measurement_attitude_3d::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int measurement_attitude_3d::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t measurement_attitude_3d::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* measurement_attitude_3d::getTypeName()
{
    return "measurement_attitude_3d";
}

int measurement_attitude_3d::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;

    tlen = __int8_t_encode_array(buf, offset + pos, maxlen - pos, &this->icd_measurement_attitude_3d, 1);
    if(tlen < 0) return tlen; else pos += tlen;
    ...
    for (int a0 = 0; a0 < 3; a0++) {
        tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->tilt_error_covariance[a0][0], 3);
        if(tlen < 0) return tlen; else pos += tlen;
    }
...
int measurement_attitude_3d::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;

    tlen = __int8_t_decode_array(buf, offset + pos, maxlen - pos, &this->icd_measurement_attitude_3d, 1);
    if(tlen < 0) return tlen; else pos += tlen;
    ...
    for (int a0 = 0; a0 < 3; a0++) {
        tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->tilt_error_covariance[a0][0], 3);
        if(tlen < 0) return tlen; else pos += tlen;
    }
...
int measurement_attitude_3d::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t measurement_attitude_3d::_computeHash(const __lcm_hash_ptr *p)
{
    const __lcm_hash_ptr *fp;
    for(fp = p; fp != NULL; fp = fp->parent)
        if(fp->v == measurement_attitude_3d::getHash)
            return 0;
    const __lcm_hash_ptr cp = { p, measurement_attitude_3d::getHash };

    uint64_t hash = 0x2ad08882568b8806LL +
