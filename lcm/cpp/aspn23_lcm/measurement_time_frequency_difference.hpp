 ...
 */
#ifndef __aspn23_lcm_measurement_time_frequency_difference_hpp__
#define __aspn23_lcm_measurement_time_frequency_difference_hpp__
 ...
 */
class measurement_time_frequency_difference
{
    public:
        /**
    ...
    public:
        ...
        /**
         * Returns "measurement_time_frequency_difference"
         */
...
int measurement_time_frequency_difference::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int measurement_time_frequency_difference::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int measurement_time_frequency_difference::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t measurement_time_frequency_difference::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* measurement_time_frequency_difference::getTypeName()
{
    return "measurement_time_frequency_difference";
}

int measurement_time_frequency_difference::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;

    tlen = __int8_t_encode_array(buf, offset + pos, maxlen - pos, &this->icd_measurement_time_frequency_difference, 1);
    if(tlen < 0) return tlen; else pos += tlen;
    ...
    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->freq_diff, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int measurement_time_frequency_difference::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;

    tlen = __int8_t_decode_array(buf, offset + pos, maxlen - pos, &this->icd_measurement_time_frequency_difference, 1);
    if(tlen < 0) return tlen; else pos += tlen;
    ...
    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->freq_diff, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int measurement_time_frequency_difference::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t measurement_time_frequency_difference::_computeHash(const __lcm_hash_ptr *p)
{
    const __lcm_hash_ptr *fp;
    for(fp = p; fp != NULL; fp = fp->parent)
        if(fp->v == measurement_time_frequency_difference::getHash)
            return 0;
    const __lcm_hash_ptr cp = { p, measurement_time_frequency_difference::getHash };

    uint64_t hash = 0xbbe2231dfc38c878LL +
