 ...
 */
public final class measurement_altitude implements lcm.lcm.LCMEncodable
{
    /**
     * Non ASPN. Do not use. Extra field encoding the struct name to disambiguate LCM type fingerprint hashes.
     */
    public byte icd_measurement_altitude;
    ...
    public measurement_altitude()
    {
    }
 
    public static final long LCM_FINGERPRINT;
    public static final long LCM_FINGERPRINT_BASE = 0x5b7a67ef03e44e6bL;
     ...
     */
    public static final byte ERROR_MODEL_FOGM = (byte) 1;
    ...
    {
        if (classes.contains(aspn23_lcm.measurement_altitude.class))
            return 0L;
 
        classes.add(aspn23_lcm.measurement_altitude.class);
    ...
    {
        outs.writeByte(this.icd_measurement_altitude); 
    ...
    public measurement_altitude(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public measurement_altitude(DataInput ins) throws IOException
    {
    ...
    public static aspn23_lcm.measurement_altitude _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        aspn23_lcm.measurement_altitude o = new aspn23_lcm.measurement_altitude();
    ...
    {
        this.icd_measurement_altitude = ins.readByte();
    ...
    public aspn23_lcm.measurement_altitude copy()
    {
        aspn23_lcm.measurement_altitude outobj = new aspn23_lcm.measurement_altitude();
        outobj.icd_measurement_altitude = this.icd_measurement_altitude;
