 ...
 */
public final class measurement_speed implements lcm.lcm.LCMEncodable
{
    /**
     * Non ASPN. Do not use. Extra field encoding the struct name to disambiguate LCM type fingerprint hashes.
     */
    public byte icd_measurement_speed;
    ...
    public measurement_speed()
    {
    }
 
    public static final long LCM_FINGERPRINT;
    public static final long LCM_FINGERPRINT_BASE = 0xdcd9871ed249b71aL;
 
    /**
     * Speed with respect to air measured as true airspeed (TAS) with respect to air mass expressed in
     * sensor coordinate frame.
     */
    public static final byte REFERENCE_TAS = (byte) 0;
    /**
    ...
    {
        if (classes.contains(aspn23_lcm.measurement_speed.class))
            return 0L;
 
        classes.add(aspn23_lcm.measurement_speed.class);
    ...
    {
        outs.writeByte(this.icd_measurement_speed); 
    ...
    public measurement_speed(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public measurement_speed(DataInput ins) throws IOException
    {
    ...
    public static aspn23_lcm.measurement_speed _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        aspn23_lcm.measurement_speed o = new aspn23_lcm.measurement_speed();
    ...
    {
        this.icd_measurement_speed = ins.readByte();
    ...
    public aspn23_lcm.measurement_speed copy()
    {
        aspn23_lcm.measurement_speed outobj = new aspn23_lcm.measurement_speed();
        outobj.icd_measurement_speed = this.icd_measurement_speed;
