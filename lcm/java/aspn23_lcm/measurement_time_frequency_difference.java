 ...
 */
public final class measurement_time_frequency_difference implements lcm.lcm.LCMEncodable
{
    /**
     * Non ASPN. Do not use. Extra field encoding the struct name to disambiguate LCM type fingerprint hashes.
     */
    public byte icd_measurement_time_frequency_difference;
    ...
    public measurement_time_frequency_difference()
    {
        covariance = new double[2][2];
    }
 
    public static final long LCM_FINGERPRINT;
    public static final long LCM_FINGERPRINT_BASE = 0xbbe2231dfc38c878L;
    ...
    {
        if (classes.contains(aspn23_lcm.measurement_time_frequency_difference.class))
            return 0L;
 
        classes.add(aspn23_lcm.measurement_time_frequency_difference.class);
    ...
    {
        outs.writeByte(this.icd_measurement_time_frequency_difference); 
        ...
        outs.writeDouble(this.freq_diff); 
    ...
    public measurement_time_frequency_difference(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public measurement_time_frequency_difference(DataInput ins) throws IOException
    {
    ...
    public static aspn23_lcm.measurement_time_frequency_difference _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        aspn23_lcm.measurement_time_frequency_difference o = new aspn23_lcm.measurement_time_frequency_difference();
    ...
    {
        this.icd_measurement_time_frequency_difference = ins.readByte();
    ...
    public aspn23_lcm.measurement_time_frequency_difference copy()
    {
        aspn23_lcm.measurement_time_frequency_difference outobj = new aspn23_lcm.measurement_time_frequency_difference();
        outobj.icd_measurement_time_frequency_difference = this.icd_measurement_time_frequency_difference;
        ...
        outobj.freq_diff = this.freq_diff;
