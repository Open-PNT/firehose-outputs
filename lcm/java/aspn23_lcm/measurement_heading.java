 ...
 */
public final class measurement_heading implements lcm.lcm.LCMEncodable
{
    /**
     * Non ASPN. Do not use. Extra field encoding the struct name to disambiguate LCM type fingerprint hashes.
     */
    public byte icd_measurement_heading;
    ...
    public measurement_heading()
    {
    }
 
    public static final long LCM_FINGERPRINT;
    public static final long LCM_FINGERPRINT_BASE = 0x0f518028c3b85f11L;
     ...
     */
    public static final byte REFERENCE_TRUE_HEADING = (byte) 0;
    /**
     ...
     */
    public static final byte REFERENCE_MAGNETIC_HEADING = (byte) 1;
    /**
    ...
    {
        if (classes.contains(aspn23_lcm.measurement_heading.class))
            return 0L;
 
        classes.add(aspn23_lcm.measurement_heading.class);
    ...
    {
        outs.writeByte(this.icd_measurement_heading); 
    ...
    public measurement_heading(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public measurement_heading(DataInput ins) throws IOException
    {
    ...
    public static aspn23_lcm.measurement_heading _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        aspn23_lcm.measurement_heading o = new aspn23_lcm.measurement_heading();
    ...
    {
        this.icd_measurement_heading = ins.readByte();
    ...
    public aspn23_lcm.measurement_heading copy()
    {
        aspn23_lcm.measurement_heading outobj = new aspn23_lcm.measurement_heading();
        outobj.icd_measurement_heading = this.icd_measurement_heading;
