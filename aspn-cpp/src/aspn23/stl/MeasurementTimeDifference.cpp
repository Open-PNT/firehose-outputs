...
std::vector<double> MeasurementTimeDifference::get_error_model_params() const {
	nullptr_check();
...
void MeasurementTimeDifference::set_error_model_params(std::vector<double> error_model_params) {
	nullptr_check();
