...
MeasurementImu::MeasurementImu(TypeHeader header,
                               ...
                               std::vector<double> meas_accel,
                               std::vector<double> meas_gyro,
...
std::vector<double> MeasurementImu::get_meas_accel() const {
	nullptr_check();

	return {&c_struct->meas_accel[0], &c_struct->meas_accel[0] + 3};
}

void MeasurementImu::set_meas_accel(std::vector<double> meas_accel) {
	nullptr_check();
	memcpy(c_struct->meas_accel, meas_accel.data(), 3 * sizeof(double));
}

std::vector<double> MeasurementImu::get_meas_gyro() const {
	nullptr_check();

	return {&c_struct->meas_gyro[0], &c_struct->meas_gyro[0] + 3};
}

void MeasurementImu::set_meas_gyro(std::vector<double> meas_gyro) {
	nullptr_check();
