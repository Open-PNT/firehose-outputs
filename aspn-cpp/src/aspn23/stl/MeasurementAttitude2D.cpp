...
std::vector<double> MeasurementAttitude2D::get_attitude2d() const {
	nullptr_check();

	return {&c_struct->attitude2d[0], &c_struct->attitude2d[0] + 2};
}

void MeasurementAttitude2D::set_attitude2d(std::vector<double> attitude2d) {
	nullptr_check();
	memcpy(c_struct->attitude2d, attitude2d.data(), 2 * sizeof(double));
}

std::vector<double> MeasurementAttitude2D::get_covariance() const {
	nullptr_check();

	return {&c_struct->covariance[0][0], &c_struct->covariance[0][0] + 2 * 2};
}

void MeasurementAttitude2D::set_covariance(std::vector<double> covariance) {
	nullptr_check();
...
std::vector<double> MeasurementAttitude2D::get_error_model_params() const {
	nullptr_check();
...
void MeasurementAttitude2D::set_error_model_params(std::vector<double> error_model_params) {
	nullptr_check();
