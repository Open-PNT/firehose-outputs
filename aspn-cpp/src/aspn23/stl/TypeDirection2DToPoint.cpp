...
std::vector<double> TypeDirection2DToPoint::get_error_model_params() const {
	nullptr_check();
...
void TypeDirection2DToPoint::set_error_model_params(std::vector<double> error_model_params) {
	nullptr_check();
