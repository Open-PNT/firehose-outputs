...
bool is_core_message(std::shared_ptr<aspn23_stl::AspnBase> base);

TypeTimestamp get_time(std::shared_ptr<aspn23_stl::AspnBase> parent);
void set_time(std::shared_ptr<aspn23_stl::AspnBase> parent, TypeTimestamp time);
 ...
 * Aspn23TypeHeader.
 */
std::shared_ptr<aspn23_stl::AspnBase> convert_message(
    Aspn23TypeHeader* parent,
    bool take_ownership = true,
    std::function<void(aspn23_stl::AspnBase*)> custom_deleter =
        std::default_delete<aspn23_stl::AspnBase>());
 ...
 *
 * Warning: this function should only be called with message type that has
 * been up-casted to a TypeHeader (aspn23_stl::AspnBase), never an actual TypeHeader.
 */
std::shared_ptr<aspn23_stl::AspnBase> copy_message(std::shared_ptr<aspn23_stl::AspnBase> parent);
