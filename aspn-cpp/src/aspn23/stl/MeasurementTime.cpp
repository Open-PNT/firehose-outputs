...
std::vector<uint8_t> MeasurementTime::get_clock_id() const {
	nullptr_check();
	if (c_struct->clock_id == nullptr) return {};
	return {c_struct->clock_id, c_struct->clock_id + c_struct->num_obs};
}

void MeasurementTime::set_clock_id(std::vector<uint8_t> clock_id) {
	nullptr_check();
	memcpy(c_struct->clock_id, clock_id.data(), c_struct->num_obs * sizeof(uint8_t));
	c_struct->num_obs = clock_id.size();
}

std::vector<int64_t> MeasurementTime::get_elapsed_nsec() const {
	nullptr_check();
	if (c_struct->elapsed_nsec == nullptr) return {};
	return {c_struct->elapsed_nsec, c_struct->elapsed_nsec + c_struct->num_obs};
}

void MeasurementTime::set_elapsed_nsec(std::vector<int64_t> elapsed_nsec) {
	nullptr_check();
	memcpy(c_struct->elapsed_nsec, elapsed_nsec.data(), c_struct->num_obs * sizeof(int64_t));
	c_struct->num_obs = elapsed_nsec.size();
}

std::vector<int32_t> MeasurementTime::get_elapsed_attosec() const {
	nullptr_check();
	if (c_struct->elapsed_attosec == nullptr) return {};
	return {c_struct->elapsed_attosec, c_struct->elapsed_attosec + c_struct->num_obs};
}

void MeasurementTime::set_elapsed_attosec(std::vector<int32_t> elapsed_attosec) {
	nullptr_check();
...
std::vector<double> MeasurementTime::get_covariance() const {
	nullptr_check();
	if (c_struct->covariance == nullptr) return {};
	return {c_struct->covariance, c_struct->covariance + c_struct->num_obs * c_struct->num_obs};
}

void MeasurementTime::set_covariance(std::vector<double> covariance) {
	nullptr_check();
	memcpy(c_struct->covariance,
	       covariance.data(),
	       c_struct->num_obs * c_struct->num_obs * sizeof(double));

	c_struct->num_obs = sqrt(covariance.size());
}
...
std::vector<double> MeasurementTime::get_error_model_params() const {
	nullptr_check();
...
void MeasurementTime::set_error_model_params(std::vector<double> error_model_params) {
	nullptr_check();
