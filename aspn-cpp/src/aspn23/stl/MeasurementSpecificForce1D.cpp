...
std::vector<double> MeasurementSpecificForce1D::get_error_model_params() const {
	nullptr_check();
...
void MeasurementSpecificForce1D::set_error_model_params(std::vector<double> error_model_params) {
	nullptr_check();
