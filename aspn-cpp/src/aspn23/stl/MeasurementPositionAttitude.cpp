...
std::vector<double> MeasurementPositionAttitude::get_quaternion() const {
	nullptr_check();

	return {&c_struct->quaternion[0], &c_struct->quaternion[0] + 4};
}

void MeasurementPositionAttitude::set_quaternion(std::vector<double> quaternion) {
	nullptr_check();
	memcpy(c_struct->quaternion, quaternion.data(), 4 * sizeof(double));
}

std::vector<double> MeasurementPositionAttitude::get_covariance() const {
	nullptr_check();

	return {&c_struct->covariance[0][0], &c_struct->covariance[0][0] + 6 * 6};
}

void MeasurementPositionAttitude::set_covariance(std::vector<double> covariance) {
	nullptr_check();
...
std::vector<double> MeasurementPositionAttitude::get_error_model_params() const {
	nullptr_check();
...
void MeasurementPositionAttitude::set_error_model_params(std::vector<double> error_model_params) {
	nullptr_check();
