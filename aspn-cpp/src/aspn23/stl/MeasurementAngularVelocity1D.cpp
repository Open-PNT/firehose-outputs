...
std::vector<double> MeasurementAngularVelocity1D::get_error_model_params() const {
	nullptr_check();
...
void MeasurementAngularVelocity1D::set_error_model_params(std::vector<double> error_model_params) {
	nullptr_check();
