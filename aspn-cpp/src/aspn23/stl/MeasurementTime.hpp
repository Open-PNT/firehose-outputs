...
public:
	 ...
	 */
	std::vector<uint8_t> get_clock_id() const;
	 ...
	 * 7-50: Reserved for future additional time scale representations.
	 */
	void set_clock_id(std::vector<uint8_t>);
	 ...
	 */
	std::vector<int64_t> get_elapsed_nsec() const;
	 ...
	 * are included as `digits_of_precision`.
	 */
	void set_elapsed_nsec(std::vector<int64_t>);
	 ...
	 */
	std::vector<int32_t> get_elapsed_attosec() const;
	 ...
	 * produces the desired result.
	 */
	void set_elapsed_attosec(std::vector<int32_t>);
