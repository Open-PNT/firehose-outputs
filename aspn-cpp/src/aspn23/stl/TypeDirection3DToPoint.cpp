...
std::vector<double> TypeDirection3DToPoint::get_obs() const {
	nullptr_check();

	return {&c_struct->obs[0], &c_struct->obs[0] + 2};
}

void TypeDirection3DToPoint::set_obs(std::vector<double> obs) {
	nullptr_check();
	memcpy(c_struct->obs, obs.data(), 2 * sizeof(double));
}

std::vector<double> TypeDirection3DToPoint::get_covariance() const {
	nullptr_check();

	return {&c_struct->covariance[0][0], &c_struct->covariance[0][0] + 2 * 2};
}

void TypeDirection3DToPoint::set_covariance(std::vector<double> covariance) {
	nullptr_check();
...
std::vector<double> TypeDirection3DToPoint::get_error_model_params() const {
	nullptr_check();
...
void TypeDirection3DToPoint::set_error_model_params(std::vector<double> error_model_params) {
	nullptr_check();
