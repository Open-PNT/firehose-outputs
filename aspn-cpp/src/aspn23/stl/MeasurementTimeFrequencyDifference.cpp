...
std::vector<double> MeasurementTimeFrequencyDifference::get_covariance() const {
	nullptr_check();

	return {&c_struct->covariance[0][0], &c_struct->covariance[0][0] + 2 * 2};
}

void MeasurementTimeFrequencyDifference::set_covariance(std::vector<double> covariance) {
	nullptr_check();
...
std::vector<double> MeasurementTimeFrequencyDifference::get_error_model_params() const {
	nullptr_check();
