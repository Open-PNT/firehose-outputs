...
MeasurementPositionVelocityAttitude::MeasurementPositionVelocityAttitude(
	...
	this->c_struct = aspn23_measurement_position_velocity_attitude_new(header_prep,
...
std::vector<double> MeasurementPositionVelocityAttitude::get_quaternion() const {
	nullptr_check();

	return {&c_struct->quaternion[0], &c_struct->quaternion[0] + 4};
}

void MeasurementPositionVelocityAttitude::set_quaternion(std::vector<double> quaternion) {
	nullptr_check();
...
std::vector<double> MeasurementPositionVelocityAttitude::get_covariance() const {
	nullptr_check();
	if (c_struct->covariance == nullptr) return {};
	return {c_struct->covariance, c_struct->covariance + c_struct->num_meas * c_struct->num_meas};
}

void MeasurementPositionVelocityAttitude::set_covariance(std::vector<double> covariance) {
	nullptr_check();
...
std::vector<double> MeasurementPositionVelocityAttitude::get_error_model_params() const {
	nullptr_check();
