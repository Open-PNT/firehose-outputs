...
std::vector<double> MeasurementAngularVelocity::get_meas() const {
	nullptr_check();

	return {&c_struct->meas[0], &c_struct->meas[0] + 3};
}

void MeasurementAngularVelocity::set_meas(std::vector<double> meas) {
	nullptr_check();
	memcpy(c_struct->meas, meas.data(), 3 * sizeof(double));
}

std::vector<double> MeasurementAngularVelocity::get_covariance() const {
	nullptr_check();

	return {&c_struct->covariance[0][0], &c_struct->covariance[0][0] + 3 * 3};
}

void MeasurementAngularVelocity::set_covariance(std::vector<double> covariance) {
	nullptr_check();
...
std::vector<double> MeasurementAngularVelocity::get_error_model_params() const {
	nullptr_check();
...
void MeasurementAngularVelocity::set_error_model_params(std::vector<double> error_model_params) {
	nullptr_check();
