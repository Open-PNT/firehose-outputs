...
std::vector<double> MeasurementPosition::get_covariance() const {
	nullptr_check();
	if (c_struct->covariance == nullptr) return {};
	return {c_struct->covariance, c_struct->covariance + c_struct->num_meas * c_struct->num_meas};
}

void MeasurementPosition::set_covariance(std::vector<double> covariance) {
	nullptr_check();
...
std::vector<double> MeasurementPosition::get_error_model_params() const {
	nullptr_check();
...
void MeasurementPosition::set_error_model_params(std::vector<double> error_model_params) {
	nullptr_check();
