...
std::vector<uint8_t> MeasurementImage::get_image_data() const {
	nullptr_check();
	if (c_struct->image_data == nullptr) return {};
	return {c_struct->image_data, c_struct->image_data + c_struct->image_data_length};
}

void MeasurementImage::set_image_data(std::vector<uint8_t> image_data) {
	nullptr_check();
...
std::vector<double> MeasurementImage::get_model_coefficients() const {
	nullptr_check();
	if (c_struct->model_coefficients == nullptr) return {};
	return {c_struct->model_coefficients,
	        c_struct->model_coefficients + c_struct->num_model_coefficients};
}

void MeasurementImage::set_model_coefficients(std::vector<double> model_coefficients) {
	nullptr_check();
