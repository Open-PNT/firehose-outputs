...
xt::pyarray<double> MeasurementPosition::get_covariance() const {
	nullptr_check();
...
void MeasurementPosition::set_covariance(xt::pyarray<double> covariance) {
	nullptr_check();
...
xt::pyarray<double> MeasurementPosition::get_error_model_params() const {
	nullptr_check();
...
void MeasurementPosition::set_error_model_params(xt::pyarray<double> error_model_params) {
	nullptr_check();
