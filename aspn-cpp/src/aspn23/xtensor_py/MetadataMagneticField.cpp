...
xt::pyarray<double> MetadataMagneticField::get_k() const {
	nullptr_check();
...
void MetadataMagneticField::set_k(xt::pyarray<double> k) {
	nullptr_check();
...
xt::pyarray<double> MetadataMagneticField::get_b() const {
	nullptr_check();
...
void MetadataMagneticField::set_b(xt::pyarray<double> b) {
	nullptr_check();
