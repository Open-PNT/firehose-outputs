...
xt::pyarray<double> MeasurementTemperature::get_error_model_params() const {
	nullptr_check();
...
void MeasurementTemperature::set_error_model_params(xt::pyarray<double> error_model_params) {
	nullptr_check();
