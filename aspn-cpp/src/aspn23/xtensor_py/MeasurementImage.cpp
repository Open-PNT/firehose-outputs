...
MeasurementImage::MeasurementImage(TypeHeader header,
                                   ...
                                   xt::pyarray<uint8_t> image_data,
                                   Aspn23MeasurementImageCameraModel camera_model,
                                   xt::pyarray<double> model_coefficients,
...
xt::pyarray<uint8_t> MeasurementImage::get_image_data() const {
	nullptr_check();
...
void MeasurementImage::set_image_data(xt::pyarray<uint8_t> image_data) {
	nullptr_check();
...
xt::pyarray<double> MeasurementImage::get_model_coefficients() const {
	nullptr_check();
...
void MeasurementImage::set_model_coefficients(xt::pyarray<double> model_coefficients) {
	nullptr_check();
