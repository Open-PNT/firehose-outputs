...
xt::pyarray<double> MeasurementMagneticField::get_covariance() const {
	nullptr_check();
...
void MeasurementMagneticField::set_covariance(xt::pyarray<double> covariance) {
	nullptr_check();
...
xt::pyarray<double> MeasurementMagneticField::get_error_model_params() const {
	nullptr_check();
...
void MeasurementMagneticField::set_error_model_params(xt::pyarray<double> error_model_params) {
	nullptr_check();
