...
xt::xarray<double> MeasurementDeltaRangeToPoint::get_error_model_params() const {
	nullptr_check();
...
void MeasurementDeltaRangeToPoint::set_error_model_params(xt::xarray<double> error_model_params) {
	nullptr_check();
