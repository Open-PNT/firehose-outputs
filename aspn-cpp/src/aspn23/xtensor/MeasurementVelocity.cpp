...
xt::xarray<double> MeasurementVelocity::get_covariance() const {
	nullptr_check();
...
void MeasurementVelocity::set_covariance(xt::xarray<double> covariance) {
	nullptr_check();
...
xt::xarray<double> MeasurementVelocity::get_error_model_params() const {
	nullptr_check();
...
void MeasurementVelocity::set_error_model_params(xt::xarray<double> error_model_params) {
	nullptr_check();
