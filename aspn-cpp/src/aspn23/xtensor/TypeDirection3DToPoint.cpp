...
xt::xarray<double> TypeDirection3DToPoint::get_obs() const {
	nullptr_check();
...
void TypeDirection3DToPoint::set_obs(xt::xarray<double> obs) {
	nullptr_check();
	memcpy(c_struct->obs, obs.data(), 2 * sizeof(double));
}

xt::xarray<double> TypeDirection3DToPoint::get_covariance() const {
	nullptr_check();
...
void TypeDirection3DToPoint::set_covariance(xt::xarray<double> covariance) {
	nullptr_check();
...
xt::xarray<double> TypeDirection3DToPoint::get_error_model_params() const {
	nullptr_check();
...
void TypeDirection3DToPoint::set_error_model_params(xt::xarray<double> error_model_params) {
	nullptr_check();
