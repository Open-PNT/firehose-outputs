...
Eigen::Matrix<uint8_t, Eigen::Dynamic, 1> TypeImageFeature::get_descriptor() const {
	nullptr_check();
	if (c_struct->descriptor == nullptr) return {};
	return Eigen::Map<Eigen::Matrix<uint8_t, Eigen::Dynamic, 1>>(c_struct->descriptor,
	                                                             c_struct->descriptor_size);
}

void TypeImageFeature::set_descriptor(Eigen::Matrix<uint8_t, Eigen::Dynamic, 1> descriptor) {
	nullptr_check();
