...
MeasurementPosition::MeasurementPosition(
	...
	this->c_struct = aspn23_measurement_position_new(header_prep,
...
MeasurementPosition::get_covariance() const {
	nullptr_check();
...
void MeasurementPosition::set_covariance(
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> covariance) {
	nullptr_check();
...
Eigen::Matrix<double, Eigen::Dynamic, 1> MeasurementPosition::get_error_model_params() const {
	nullptr_check();
...
void MeasurementPosition::set_error_model_params(
    Eigen::Matrix<double, Eigen::Dynamic, 1> error_model_params) {
	nullptr_check();
