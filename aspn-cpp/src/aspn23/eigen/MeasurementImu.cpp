...
Eigen::Matrix<double, Eigen::Dynamic, 1> MeasurementImu::get_meas_accel() const {
	nullptr_check();

	return Eigen::Map<Eigen::Matrix<double, Eigen::Dynamic, 1>>(&c_struct->meas_accel[0], 3);
}

void MeasurementImu::set_meas_accel(Eigen::Matrix<double, Eigen::Dynamic, 1> meas_accel) {
	nullptr_check();
	memcpy(c_struct->meas_accel, meas_accel.data(), 3 * sizeof(double));
}

Eigen::Matrix<double, Eigen::Dynamic, 1> MeasurementImu::get_meas_gyro() const {
	nullptr_check();

	return Eigen::Map<Eigen::Matrix<double, Eigen::Dynamic, 1>>(&c_struct->meas_gyro[0], 3);
}

void MeasurementImu::set_meas_gyro(Eigen::Matrix<double, Eigen::Dynamic, 1> meas_gyro) {
	nullptr_check();
