...
TypeRemotePoint::TypeRemotePoint(const TypeRemotePoint& other) {
	...
	this->c_struct = aspn23_type_remote_point_new(other.get_included_terms(),
	                                              ...
	                                              other.get_position2(),
	                                              other.get_position3(),
	                                              other.get_position_covariance().cols(),
...
TypeRemotePoint::get_position_covariance() const {
	nullptr_check();
...
void TypeRemotePoint::set_position_covariance(
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> position_covariance) {
	nullptr_check();
	...
	c_struct->num_position_components = position_covariance.cols();
}
