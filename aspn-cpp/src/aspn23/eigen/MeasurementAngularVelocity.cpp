...
MeasurementAngularVelocity::MeasurementAngularVelocity(
    ...
    Eigen::Matrix<double, Eigen::Dynamic, 1> meas,
...
Eigen::Matrix<double, Eigen::Dynamic, 1> MeasurementAngularVelocity::get_meas() const {
	nullptr_check();

	return Eigen::Map<Eigen::Matrix<double, Eigen::Dynamic, 1>>(&c_struct->meas[0], 3);
}

void MeasurementAngularVelocity::set_meas(Eigen::Matrix<double, Eigen::Dynamic, 1> meas) {
	nullptr_check();
	memcpy(c_struct->meas, meas.data(), 3 * sizeof(double));
}

Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>
MeasurementAngularVelocity::get_covariance() const {
	nullptr_check();

	return Eigen::Map<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>>(
	    &c_struct->covariance[0][0], 3, 3);
}
...
Eigen::Matrix<double, Eigen::Dynamic, 1> MeasurementAngularVelocity::get_error_model_params()
    const {
	nullptr_check();
