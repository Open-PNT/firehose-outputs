...
Eigen::Matrix<int8_t, Eigen::Dynamic, 1> MeasurementSatnavSubframe::get_data_vector() const {
	nullptr_check();
	if (c_struct->data_vector == nullptr) return {};
	return Eigen::Map<Eigen::Matrix<int8_t, Eigen::Dynamic, 1>>(c_struct->data_vector,
	                                                            c_struct->num_bytes);
}

void MeasurementSatnavSubframe::set_data_vector(
    Eigen::Matrix<int8_t, Eigen::Dynamic, 1> data_vector) {
	nullptr_check();
