...
MeasurementAttitude2D::MeasurementAttitude2D(
    ...
    Eigen::Matrix<double, Eigen::Dynamic, 1> attitude2d,
...
Eigen::Matrix<double, Eigen::Dynamic, 1> MeasurementAttitude2D::get_attitude2d() const {
	nullptr_check();

	return Eigen::Map<Eigen::Matrix<double, Eigen::Dynamic, 1>>(&c_struct->attitude2d[0], 2);
}

void MeasurementAttitude2D::set_attitude2d(Eigen::Matrix<double, Eigen::Dynamic, 1> attitude2d) {
	nullptr_check();
	memcpy(c_struct->attitude2d, attitude2d.data(), 2 * sizeof(double));
}

Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>
MeasurementAttitude2D::get_covariance() const {
	nullptr_check();
...
void MeasurementAttitude2D::set_covariance(
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> covariance) {
	nullptr_check();
...
Eigen::Matrix<double, Eigen::Dynamic, 1> MeasurementAttitude2D::get_error_model_params() const {
	nullptr_check();
...
void MeasurementAttitude2D::set_error_model_params(
    Eigen::Matrix<double, Eigen::Dynamic, 1> error_model_params) {
	nullptr_check();
