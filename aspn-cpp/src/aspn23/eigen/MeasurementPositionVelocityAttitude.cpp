...
Eigen::Matrix<double, Eigen::Dynamic, 1> MeasurementPositionVelocityAttitude::get_quaternion()
    const {
	nullptr_check();
...
MeasurementPositionVelocityAttitude::get_covariance() const {
	nullptr_check();
	if (c_struct->covariance == nullptr) return {};
	return Eigen::Map<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>>(
	    c_struct->covariance, c_struct->num_meas, c_struct->num_meas);
}

void MeasurementPositionVelocityAttitude::set_covariance(
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> covariance) {
	nullptr_check();
	...
	c_struct->num_meas = covariance.cols();
}
...
MeasurementPositionVelocityAttitude::get_error_model_params() const {
	nullptr_check();
