...
MeasurementVelocity::get_covariance() const {
	nullptr_check();
...
void MeasurementVelocity::set_covariance(
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> covariance) {
	nullptr_check();
...
Eigen::Matrix<double, Eigen::Dynamic, 1> MeasurementVelocity::get_error_model_params() const {
	nullptr_check();
...
void MeasurementVelocity::set_error_model_params(
    Eigen::Matrix<double, Eigen::Dynamic, 1> error_model_params) {
	nullptr_check();
