...
MeasurementDeltaPosition::MeasurementDeltaPosition(
	...
	this->c_struct = aspn23_measurement_delta_position_new(header_prep,
...
MeasurementDeltaPosition::get_covariance() const {
	nullptr_check();
...
void MeasurementDeltaPosition::set_covariance(
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> covariance) {
	nullptr_check();
...
Eigen::Matrix<double, Eigen::Dynamic, 1> MeasurementDeltaPosition::get_error_model_params() const {
	nullptr_check();
...
void MeasurementDeltaPosition::set_error_model_params(
    Eigen::Matrix<double, Eigen::Dynamic, 1> error_model_params) {
	nullptr_check();
