...
Eigen::Matrix<double, Eigen::Dynamic, 1> TypeDirection3DToPoint::get_obs() const {
	nullptr_check();

	return Eigen::Map<Eigen::Matrix<double, Eigen::Dynamic, 1>>(&c_struct->obs[0], 2);
}

void TypeDirection3DToPoint::set_obs(Eigen::Matrix<double, Eigen::Dynamic, 1> obs) {
	nullptr_check();
	memcpy(c_struct->obs, obs.data(), 2 * sizeof(double));
}

Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>
TypeDirection3DToPoint::get_covariance() const {
	nullptr_check();
...
Eigen::Matrix<double, Eigen::Dynamic, 1> TypeDirection3DToPoint::get_error_model_params() const {
	nullptr_check();
...
void TypeDirection3DToPoint::set_error_model_params(
    Eigen::Matrix<double, Eigen::Dynamic, 1> error_model_params) {
	nullptr_check();
