...
MeasurementMagneticField::get_covariance() const {
	nullptr_check();
...
void MeasurementMagneticField::set_covariance(
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> covariance) {
	nullptr_check();
...
Eigen::Matrix<double, Eigen::Dynamic, 1> MeasurementMagneticField::get_error_model_params() const {
	nullptr_check();
...
void MeasurementMagneticField::set_error_model_params(
    Eigen::Matrix<double, Eigen::Dynamic, 1> error_model_params) {
	nullptr_check();
