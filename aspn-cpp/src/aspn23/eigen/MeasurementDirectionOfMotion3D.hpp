...
public:
	 ...
	 * Direction of motion represented as a unit vector.
	 */
	Eigen::Matrix<double, Eigen::Dynamic, 1> get_obs() const;

	/**
	 * Direction of motion represented as a unit vector.
	 */
	void set_obs(Eigen::Matrix<double, Eigen::Dynamic, 1>);
	 ...
	 */
	Eigen::Matrix<double, Eigen::Dynamic, 1> get_error_vector() const;

	/**
	 * Error is expressed as rotation uncertainty about two axes, error_vector and and a second
	 * error vector that is orthogonal to both the obs vector and the error_vector.
	 */
	void set_error_vector(Eigen::Matrix<double, Eigen::Dynamic, 1>);
