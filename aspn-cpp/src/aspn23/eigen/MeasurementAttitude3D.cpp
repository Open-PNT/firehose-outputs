...
MeasurementAttitude3D::MeasurementAttitude3D(
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> tilt_error_covariance,
...
Eigen::Matrix<double, Eigen::Dynamic, 1> MeasurementAttitude3D::get_quaternion() const {
	nullptr_check();

	return Eigen::Map<Eigen::Matrix<double, Eigen::Dynamic, 1>>(&c_struct->quaternion[0], 4);
}

void MeasurementAttitude3D::set_quaternion(Eigen::Matrix<double, Eigen::Dynamic, 1> quaternion) {
	nullptr_check();
	memcpy(c_struct->quaternion, quaternion.data(), 4 * sizeof(double));
}

Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>
MeasurementAttitude3D::get_tilt_error_covariance() const {
	nullptr_check();

	return Eigen::Map<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>>(
	    &c_struct->tilt_error_covariance[0][0], 3, 3);
}
...
Eigen::Matrix<double, Eigen::Dynamic, 1> MeasurementAttitude3D::get_error_model_params() const {
	nullptr_check();
...
void MeasurementAttitude3D::set_error_model_params(
    Eigen::Matrix<double, Eigen::Dynamic, 1> error_model_params) {
	nullptr_check();
