...
Eigen::Matrix<uint8_t, Eigen::Dynamic, 1> MeasurementTime::get_clock_id() const {
	nullptr_check();
	if (c_struct->clock_id == nullptr) return {};
	return Eigen::Map<Eigen::Matrix<uint8_t, Eigen::Dynamic, 1>>(c_struct->clock_id,
	                                                             c_struct->num_obs);
}

void MeasurementTime::set_clock_id(Eigen::Matrix<uint8_t, Eigen::Dynamic, 1> clock_id) {
	nullptr_check();
	memcpy(c_struct->clock_id, clock_id.data(), c_struct->num_obs * sizeof(uint8_t));
	c_struct->num_obs = clock_id.size();
}

Eigen::Matrix<int64_t, Eigen::Dynamic, 1> MeasurementTime::get_elapsed_nsec() const {
	nullptr_check();
	if (c_struct->elapsed_nsec == nullptr) return {};
	return Eigen::Map<Eigen::Matrix<int64_t, Eigen::Dynamic, 1>>(c_struct->elapsed_nsec,
	                                                             c_struct->num_obs);
}

void MeasurementTime::set_elapsed_nsec(Eigen::Matrix<int64_t, Eigen::Dynamic, 1> elapsed_nsec) {
	nullptr_check();
	memcpy(c_struct->elapsed_nsec, elapsed_nsec.data(), c_struct->num_obs * sizeof(int64_t));
	c_struct->num_obs = elapsed_nsec.size();
}

Eigen::Matrix<int32_t, Eigen::Dynamic, 1> MeasurementTime::get_elapsed_attosec() const {
	nullptr_check();
	if (c_struct->elapsed_attosec == nullptr) return {};
	return Eigen::Map<Eigen::Matrix<int32_t, Eigen::Dynamic, 1>>(c_struct->elapsed_attosec,
	                                                             c_struct->num_obs);
}

void MeasurementTime::set_elapsed_attosec(
    Eigen::Matrix<int32_t, Eigen::Dynamic, 1> elapsed_attosec) {
	nullptr_check();
...
MeasurementTime::get_covariance() const {
	nullptr_check();
	if (c_struct->covariance == nullptr) return {};
	return Eigen::Map<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>>(
	    c_struct->covariance, c_struct->num_obs, c_struct->num_obs);
}

void MeasurementTime::set_covariance(
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> covariance) {
	nullptr_check();
	...
	c_struct->num_obs = covariance.cols();
}
...
Eigen::Matrix<double, Eigen::Dynamic, 1> MeasurementTime::get_error_model_params() const {
	nullptr_check();
...
void MeasurementTime::set_error_model_params(
    Eigen::Matrix<double, Eigen::Dynamic, 1> error_model_params) {
	nullptr_check();
