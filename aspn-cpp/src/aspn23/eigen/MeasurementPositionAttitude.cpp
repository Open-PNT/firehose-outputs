...
Eigen::Matrix<double, Eigen::Dynamic, 1> MeasurementPositionAttitude::get_quaternion() const {
	nullptr_check();
...
MeasurementPositionAttitude::get_covariance() const {
	nullptr_check();

	return Eigen::Map<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>>(
	    &c_struct->covariance[0][0], 6, 6);
}
...
Eigen::Matrix<double, Eigen::Dynamic, 1> MeasurementPositionAttitude::get_error_model_params()
    const {
	nullptr_check();
