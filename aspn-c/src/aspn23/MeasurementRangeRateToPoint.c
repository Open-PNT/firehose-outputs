...
Aspn23MeasurementRangeRateToPoint* ASPN_NULLABLE aspn23_measurement_range_rate_to_point_new(
	...
	Aspn23MeasurementRangeRateToPoint* self = (struct Aspn23MeasurementRangeRateToPoint*)malloc(
	    sizeof(Aspn23MeasurementRangeRateToPoint));
	...
	if (error_model_params != NULL && num_error_model_params != 0) {
		if (num_error_model_params == 0)
			...
			fprintf(
			    ...
			    "error_model_params");
			aspn23_measurement_range_rate_to_point_free(self);
			return NULL;
		}
	}
...
aspn23_measurement_range_rate_to_point_copy(Aspn23MeasurementRangeRateToPoint* input) {
	...
	Aspn23MeasurementRangeRateToPoint* out =
...
void aspn23_measurement_range_rate_to_point_free(void* pointer) {
	Aspn23MeasurementRangeRateToPoint* self = (Aspn23MeasurementRangeRateToPoint*)pointer;
	if (NULL == self) return;
	aspn23_measurement_range_rate_to_point_free_members(self);
	free(self);
}
