...
class TypeMounting:
    ...
    lever_arm_sigma - NDArray[np.float64]:
            3x1 lever arm uncertainty vector as standard deviations in the platform body frame.

    orientation_quaternion - Optional[Optional[NDArray[np.float64]]]:
    ...
    orientation_tilt_error_covariance - Optional[Optional[NDArray[np.float64]]]:
    ...
    lever_arm: NDArray[np.float64]
    lever_arm_sigma: NDArray[np.float64]
    orientation_quaternion: Optional[NDArray[np.float64]]
    orientation_tilt_error_covariance: Optional[NDArray[np.float64]]
