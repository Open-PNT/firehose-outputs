...
bool aspn23_ros_interfaces__msg__measurement_direction_of_motion2_d__convert_from_py(
  ...
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aspn23_ros_interfaces.msg._measurement_direction_of_"
                   "motion2_d.MeasurementDirectionOfMotion2D",
...
aspn23_ros_interfaces__msg__measurement_direction_of_motion2_d__convert_to_py(
    void *raw_ros_message) {
  /* NOTE(esteve): Call constructor of MeasurementDirectionOfMotion2D */
  PyObject *_pymessage = NULL;
  {
    PyObject *pymessage_module = PyImport_ImportModule(
        "aspn23_ros_interfaces.msg._measurement_direction_of_motion2_d");
    assert(pymessage_module);
    PyObject *pymessage_class = PyObject_GetAttrString(
        pymessage_module, "MeasurementDirectionOfMotion2D");
