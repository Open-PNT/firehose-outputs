...
class Metaclass_MeasurementDirection3DToPoints(type):
    """Metaclass of message 'MeasurementDirection3DToPoints'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__measurement_direction3_d_to_points
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__measurement_direction3_d_to_points
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__measurement_direction3_d_to_points
            cls._TYPE_SUPPORT = module.type_support_msg__msg__measurement_direction3_d_to_points
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__measurement_direction3_d_to_points

            from aspn23_ros_interfaces.msg import TypeDirection3DToPoint
            if TypeDirection3DToPoint.__class__._TYPE_SUPPORT is None:
                TypeDirection3DToPoint.__class__.__import_type_support__()
...
class MeasurementDirection3DToPoints(metaclass=Metaclass_MeasurementDirection3DToPoints):
    """Message class 'MeasurementDirection3DToPoints'."""
    ...
    _fields_and_field_types = {
        ...
        'num_obs': 'uint16',
        'obs': 'sequence<aspn23_ros_interfaces/TypeDirection3DToPoint>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['aspn23_ros_interfaces', 'msg'], 'TypeDirection3DToPoint')),  # noqa: E501
    )
    ...
    def num_obs(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 65536, \
                "The 'num_obs' field must be an unsigned integer in [0, 65535]"
        self._num_obs = value
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, TypeDirection3DToPoint) for v in value) and
                 True), \
                "The 'obs' field must be a set or sequence and each value of type 'TypeDirection3DToPoint'"
        self._obs = value
