...
class Metaclass_MeasurementDirection2DToPoints(type):
    """Metaclass of message 'MeasurementDirection2DToPoints'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__measurement_direction2_d_to_points
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__measurement_direction2_d_to_points
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__measurement_direction2_d_to_points
            cls._TYPE_SUPPORT = module.type_support_msg__msg__measurement_direction2_d_to_points
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__measurement_direction2_d_to_points

            from aspn23_ros_interfaces.msg import TypeDirection2DToPoint
            if TypeDirection2DToPoint.__class__._TYPE_SUPPORT is None:
                TypeDirection2DToPoint.__class__.__import_type_support__()
...
class MeasurementDirection2DToPoints(metaclass=Metaclass_MeasurementDirection2DToPoints):
    """Message class 'MeasurementDirection2DToPoints'."""
    ...
    _fields_and_field_types = {
        ...
        'num_obs': 'uint16',
        'obs': 'sequence<aspn23_ros_interfaces/TypeDirection2DToPoint>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['aspn23_ros_interfaces', 'msg'], 'TypeDirection2DToPoint')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, TypeDirection2DToPoint) for v in value) and
                 True), \
                "The 'obs' field must be a set or sequence and each value of type 'TypeDirection2DToPoint'"
        self._obs = value
