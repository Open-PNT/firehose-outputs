...
# Member 'quaternion'
# Member 'tilt_error_covariance'
import numpy  # noqa: E402, I100

import rosidl_parser.definition  # noqa: E402, I100


class Metaclass_MeasurementAttitude3D(type):
    """Metaclass of message 'MeasurementAttitude3D'."""
    ...
    __constants = {
        'ASPN23_MEASUREMENT_ATTITUDE_3D_REFERENCE_FRAME_ECI': 0,
        'ASPN23_MEASUREMENT_ATTITUDE_3D_REFERENCE_FRAME_ECEF': 1,
        'ASPN23_MEASUREMENT_ATTITUDE_3D_REFERENCE_FRAME_NED': 2,
        'ASPN23_MEASUREMENT_ATTITUDE_3D_ERROR_MODEL_NONE': 0,
    }
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__measurement_attitude3_d
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__measurement_attitude3_d
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__measurement_attitude3_d
            cls._TYPE_SUPPORT = module.type_support_msg__msg__measurement_attitude3_d
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__measurement_attitude3_d
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'ASPN23_MEASUREMENT_ATTITUDE_3D_REFERENCE_FRAME_ECI': cls.__constants['ASPN23_MEASUREMENT_ATTITUDE_3D_REFERENCE_FRAME_ECI'],
            'ASPN23_MEASUREMENT_ATTITUDE_3D_REFERENCE_FRAME_ECEF': cls.__constants['ASPN23_MEASUREMENT_ATTITUDE_3D_REFERENCE_FRAME_ECEF'],
            'ASPN23_MEASUREMENT_ATTITUDE_3D_REFERENCE_FRAME_NED': cls.__constants['ASPN23_MEASUREMENT_ATTITUDE_3D_REFERENCE_FRAME_NED'],
            'ASPN23_MEASUREMENT_ATTITUDE_3D_ERROR_MODEL_NONE': cls.__constants['ASPN23_MEASUREMENT_ATTITUDE_3D_ERROR_MODEL_NONE'],
        }

    @property
    def ASPN23_MEASUREMENT_ATTITUDE_3D_REFERENCE_FRAME_ECI(self):
        """Message constant 'ASPN23_MEASUREMENT_ATTITUDE_3D_REFERENCE_FRAME_ECI'."""
        return Metaclass_MeasurementAttitude3D.__constants['ASPN23_MEASUREMENT_ATTITUDE_3D_REFERENCE_FRAME_ECI']

    @property
    def ASPN23_MEASUREMENT_ATTITUDE_3D_REFERENCE_FRAME_ECEF(self):
        """Message constant 'ASPN23_MEASUREMENT_ATTITUDE_3D_REFERENCE_FRAME_ECEF'."""
        return Metaclass_MeasurementAttitude3D.__constants['ASPN23_MEASUREMENT_ATTITUDE_3D_REFERENCE_FRAME_ECEF']

    @property
    def ASPN23_MEASUREMENT_ATTITUDE_3D_REFERENCE_FRAME_NED(self):
        """Message constant 'ASPN23_MEASUREMENT_ATTITUDE_3D_REFERENCE_FRAME_NED'."""
        return Metaclass_MeasurementAttitude3D.__constants['ASPN23_MEASUREMENT_ATTITUDE_3D_REFERENCE_FRAME_NED']

    @property
    def ASPN23_MEASUREMENT_ATTITUDE_3D_ERROR_MODEL_NONE(self):
        """Message constant 'ASPN23_MEASUREMENT_ATTITUDE_3D_ERROR_MODEL_NONE'."""
        return Metaclass_MeasurementAttitude3D.__constants['ASPN23_MEASUREMENT_ATTITUDE_3D_ERROR_MODEL_NONE']


class MeasurementAttitude3D(metaclass=Metaclass_MeasurementAttitude3D):
    """
    Message class 'MeasurementAttitude3D'.
    ...
    _fields_and_field_types = {
        ...
        'quaternion': 'double[4]',
        'tilt_error_covariance': 'double[9]',
        'error_model': 'uint8',
    ...
    def __init__(self, **kwargs):
        ...
        if 'tilt_error_covariance' not in kwargs:
            self.tilt_error_covariance = numpy.zeros(9, dtype=numpy.float64)
        else:
            self.tilt_error_covariance = kwargs.get('tilt_error_covariance')
    ...
    def __eq__(self, other):
        ...
        if any(self.quaternion != other.quaternion):
            return False
        if any(self.tilt_error_covariance != other.tilt_error_covariance):
            return False
    ...
    @builtins.property
    def tilt_error_covariance(self):
        """Message field 'tilt_error_covariance'."""
        return self._tilt_error_covariance

    @tilt_error_covariance.setter
    def tilt_error_covariance(self, value):
        if isinstance(value, numpy.ndarray):
            assert value.dtype == numpy.float64, \
                "The 'tilt_error_covariance' numpy.ndarray() must have the dtype of 'numpy.float64'"
            assert value.size == 9, \
                "The 'tilt_error_covariance' numpy.ndarray() must have a size of 9"
            self._tilt_error_covariance = value
            return
        if __debug__:
            from collections.abc import Sequence
            from collections.abc import Set
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(not (val < -1.7976931348623157e+308 or val > 1.7976931348623157e+308) or math.isinf(val) for val in value)), \
                "The 'tilt_error_covariance' field must be a set or sequence with length 9 and each value of type 'float' and each double in [-.000000, .000000]"
        self._tilt_error_covariance = numpy.array(value, dtype=numpy.float64)
