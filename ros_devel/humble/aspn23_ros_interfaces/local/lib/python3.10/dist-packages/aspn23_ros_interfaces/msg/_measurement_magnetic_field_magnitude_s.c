...
bool aspn23_ros_interfaces__msg__measurement_magnetic_field_magnitude__convert_from_py(
  ...
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aspn23_ros_interfaces.msg._measurement_magnetic_field_"
                   "magnitude.MeasurementMagneticFieldMagnitude",
                   full_classname_dest, 97) == 0);
  }
  ...
  { // field_strength
    PyObject *field = PyObject_GetAttrString(_pymsg, "field_strength");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->field_strength = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  { // variance
...
aspn23_ros_interfaces__msg__measurement_magnetic_field_magnitude__convert_to_py(
    void *raw_ros_message) {
  /* NOTE(esteve): Call constructor of MeasurementMagneticFieldMagnitude */
  PyObject *_pymessage = NULL;
  {
    PyObject *pymessage_module = PyImport_ImportModule(
        "aspn23_ros_interfaces.msg._measurement_magnetic_field_magnitude");
    assert(pymessage_module);
    PyObject *pymessage_class = PyObject_GetAttrString(
        pymessage_module, "MeasurementMagneticFieldMagnitude");
  ...
  { // field_strength
    PyObject *field = NULL;
    field = PyFloat_FromDouble(ros_message->field_strength);
    {
      int rc = PyObject_SetAttrString(_pymessage, "field_strength", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
