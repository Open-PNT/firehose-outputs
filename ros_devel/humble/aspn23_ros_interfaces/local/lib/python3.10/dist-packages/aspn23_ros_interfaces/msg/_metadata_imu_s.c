...
bool aspn23_ros_interfaces__msg__metadata_imu__convert_from_py(
  ...
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aspn23_ros_interfaces.msg._metadata_imu.MetadataImu",
                   full_classname_dest, 51) == 0);
  }
  aspn23_ros_interfaces__msg__MetadataImu *ros_message = _ros_message;
  { // info
...
aspn23_ros_interfaces__msg__metadata_imu__convert_to_py(void *raw_ros_message) {
  /* NOTE(esteve): Call constructor of MetadataImu */
  PyObject *_pymessage = NULL;
  {
    PyObject *pymessage_module =
        PyImport_ImportModule("aspn23_ros_interfaces.msg._metadata_imu");
    assert(pymessage_module);
    PyObject *pymessage_class =
        PyObject_GetAttrString(pymessage_module, "MetadataImu");
