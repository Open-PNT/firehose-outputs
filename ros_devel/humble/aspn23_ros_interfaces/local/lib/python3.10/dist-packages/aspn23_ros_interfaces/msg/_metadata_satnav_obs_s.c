...
bool aspn23_ros_interfaces__msg__metadata_satnav_obs__convert_from_py(
  ...
  // check that the passed message is of the expected Python class
  {
    ...
    assert(
        strncmp(
            "aspn23_ros_interfaces.msg._metadata_satnav_obs.MetadataSatnavObs",
            full_classname_dest, 64) == 0);
  }
  aspn23_ros_interfaces__msg__MetadataSatnavObs *ros_message = _ros_message;
  { // info
  ...
  { // deltarange_interval_start
    PyObject *field =
        PyObject_GetAttrString(_pymsg, "deltarange_interval_start");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->deltarange_interval_start = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  { // deltarange_interval_stop
    PyObject *field =
        PyObject_GetAttrString(_pymsg, "deltarange_interval_stop");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->deltarange_interval_stop = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject *aspn23_ros_interfaces__msg__metadata_satnav_obs__convert_to_py(
    void *raw_ros_message) {
  /* NOTE(esteve): Call constructor of MetadataSatnavObs */
  PyObject *_pymessage = NULL;
  {
    PyObject *pymessage_module =
        PyImport_ImportModule("aspn23_ros_interfaces.msg._metadata_satnav_obs");
    assert(pymessage_module);
    PyObject *pymessage_class =
        PyObject_GetAttrString(pymessage_module, "MetadataSatnavObs");
  ...
  { // deltarange_interval_start
    PyObject *field = NULL;
    field = PyFloat_FromDouble(ros_message->deltarange_interval_start);
    {
      int rc = PyObject_SetAttrString(_pymessage, "deltarange_interval_start",
                                      field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
  ...
  { // deltarange_interval_stop
    PyObject *field = NULL;
    field = PyFloat_FromDouble(ros_message->deltarange_interval_stop);
    {
      int rc =
          PyObject_SetAttrString(_pymessage, "deltarange_interval_stop", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
