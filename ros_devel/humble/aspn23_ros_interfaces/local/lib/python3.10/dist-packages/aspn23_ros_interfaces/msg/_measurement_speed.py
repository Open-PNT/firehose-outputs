...
class Metaclass_MeasurementSpeed(type):
    """Metaclass of message 'MeasurementSpeed'."""
    ...
    __constants = {
        'ASPN23_MEASUREMENT_SPEED_REFERENCE_TAS': 0,
        'ASPN23_MEASUREMENT_SPEED_REFERENCE_IAS': 1,
        'ASPN23_MEASUREMENT_SPEED_REFERENCE_WATER': 2,
        'ASPN23_MEASUREMENT_SPEED_REFERENCE_GROUND': 3,
        'ASPN23_MEASUREMENT_SPEED_ERROR_MODEL_NONE': 0,
    }
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__measurement_speed
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__measurement_speed
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__measurement_speed
            cls._TYPE_SUPPORT = module.type_support_msg__msg__measurement_speed
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__measurement_speed
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'ASPN23_MEASUREMENT_SPEED_REFERENCE_TAS': cls.__constants['ASPN23_MEASUREMENT_SPEED_REFERENCE_TAS'],
            'ASPN23_MEASUREMENT_SPEED_REFERENCE_IAS': cls.__constants['ASPN23_MEASUREMENT_SPEED_REFERENCE_IAS'],
            'ASPN23_MEASUREMENT_SPEED_REFERENCE_WATER': cls.__constants['ASPN23_MEASUREMENT_SPEED_REFERENCE_WATER'],
            'ASPN23_MEASUREMENT_SPEED_REFERENCE_GROUND': cls.__constants['ASPN23_MEASUREMENT_SPEED_REFERENCE_GROUND'],
            'ASPN23_MEASUREMENT_SPEED_ERROR_MODEL_NONE': cls.__constants['ASPN23_MEASUREMENT_SPEED_ERROR_MODEL_NONE'],
        }

    @property
    def ASPN23_MEASUREMENT_SPEED_REFERENCE_TAS(self):
        """Message constant 'ASPN23_MEASUREMENT_SPEED_REFERENCE_TAS'."""
        return Metaclass_MeasurementSpeed.__constants['ASPN23_MEASUREMENT_SPEED_REFERENCE_TAS']

    @property
    def ASPN23_MEASUREMENT_SPEED_REFERENCE_IAS(self):
        """Message constant 'ASPN23_MEASUREMENT_SPEED_REFERENCE_IAS'."""
        return Metaclass_MeasurementSpeed.__constants['ASPN23_MEASUREMENT_SPEED_REFERENCE_IAS']

    @property
    def ASPN23_MEASUREMENT_SPEED_REFERENCE_WATER(self):
        """Message constant 'ASPN23_MEASUREMENT_SPEED_REFERENCE_WATER'."""
        return Metaclass_MeasurementSpeed.__constants['ASPN23_MEASUREMENT_SPEED_REFERENCE_WATER']

    @property
    def ASPN23_MEASUREMENT_SPEED_REFERENCE_GROUND(self):
        """Message constant 'ASPN23_MEASUREMENT_SPEED_REFERENCE_GROUND'."""
        return Metaclass_MeasurementSpeed.__constants['ASPN23_MEASUREMENT_SPEED_REFERENCE_GROUND']

    @property
    def ASPN23_MEASUREMENT_SPEED_ERROR_MODEL_NONE(self):
        """Message constant 'ASPN23_MEASUREMENT_SPEED_ERROR_MODEL_NONE'."""
        return Metaclass_MeasurementSpeed.__constants['ASPN23_MEASUREMENT_SPEED_ERROR_MODEL_NONE']


class MeasurementSpeed(metaclass=Metaclass_MeasurementSpeed):
    """
    Message class 'MeasurementSpeed'.
