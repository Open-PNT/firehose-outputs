...
class Metaclass_MeasurementMagneticField(type):
    """Metaclass of message 'MeasurementMagneticField'."""
    ...
    __constants = {
        'ASPN23_MEASUREMENT_MAGNETIC_FIELD_ERROR_MODEL_NONE': 0,
    }
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__measurement_magnetic_field
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__measurement_magnetic_field
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__measurement_magnetic_field
            cls._TYPE_SUPPORT = module.type_support_msg__msg__measurement_magnetic_field
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__measurement_magnetic_field
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'ASPN23_MEASUREMENT_MAGNETIC_FIELD_ERROR_MODEL_NONE': cls.__constants['ASPN23_MEASUREMENT_MAGNETIC_FIELD_ERROR_MODEL_NONE'],
        }

    @property
    def ASPN23_MEASUREMENT_MAGNETIC_FIELD_ERROR_MODEL_NONE(self):
        """Message constant 'ASPN23_MEASUREMENT_MAGNETIC_FIELD_ERROR_MODEL_NONE'."""
        return Metaclass_MeasurementMagneticField.__constants['ASPN23_MEASUREMENT_MAGNETIC_FIELD_ERROR_MODEL_NONE']


class MeasurementMagneticField(metaclass=Metaclass_MeasurementMagneticField):
    """
    Message class 'MeasurementMagneticField'.
    ...
    _fields_and_field_types = {
        ...
        'num_meas': 'uint8',
        'x_field_strength': 'double',
        'y_field_strength': 'double',
        'z_field_strength': 'double',
    ...
    def __init__(self, **kwargs):
        ...
        self.x_field_strength = kwargs.get('x_field_strength', float())
        self.y_field_strength = kwargs.get('y_field_strength', float())
        self.z_field_strength = kwargs.get('z_field_strength', float())
    ...
    def __eq__(self, other):
        ...
        if self.num_meas != other.num_meas:
            return False
        if self.x_field_strength != other.x_field_strength:
            return False
        if self.y_field_strength != other.y_field_strength:
            return False
        if self.z_field_strength != other.z_field_strength:
            return False
    ...
    @builtins.property
    def x_field_strength(self):
        """Message field 'x_field_strength'."""
        return self._x_field_strength

    @x_field_strength.setter
    def x_field_strength(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'x_field_strength' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'x_field_strength' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._x_field_strength = value

    @builtins.property
    def y_field_strength(self):
        """Message field 'y_field_strength'."""
        return self._y_field_strength

    @y_field_strength.setter
    def y_field_strength(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'y_field_strength' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'y_field_strength' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._y_field_strength = value

    @builtins.property
    def z_field_strength(self):
        """Message field 'z_field_strength'."""
        return self._z_field_strength

    @z_field_strength.setter
    def z_field_strength(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'z_field_strength' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'z_field_strength' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._z_field_strength = value
