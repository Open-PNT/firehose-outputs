...
bool aspn23_ros_interfaces__msg__measurement_position_velocity_attitude__convert_from_py(
  ...
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aspn23_ros_interfaces.msg._measurement_position_velocity_"
                   "attitude.MeasurementPositionVelocityAttitude",
  ...
  { // p1
    ...
    ros_message->p1 = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  { // p2
    ...
    assert(PyFloat_Check(field));
    ros_message->p2 = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  { // p3
    ...
    assert(PyFloat_Check(field));
    ros_message->p3 = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  { // v1
  ...
  { // v3
    ...
    assert(PyFloat_Check(field));
    ros_message->v3 = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  { // quaternion
...
aspn23_ros_interfaces__msg__measurement_position_velocity_attitude__convert_to_py(
    void *raw_ros_message) {
  /* NOTE(esteve): Call constructor of MeasurementPositionVelocityAttitude */
  PyObject *_pymessage = NULL;
  {
    PyObject *pymessage_module = PyImport_ImportModule(
        "aspn23_ros_interfaces.msg._measurement_position_velocity_attitude");
    assert(pymessage_module);
    PyObject *pymessage_class = PyObject_GetAttrString(
        pymessage_module, "MeasurementPositionVelocityAttitude");
  ...
  { // p3
    PyObject *field = NULL;
    field = PyFloat_FromDouble(ros_message->p3);
    {
