...
class Metaclass_MeasurementAttitude2D(type):
    """Metaclass of message 'MeasurementAttitude2D'."""
    ...
    __constants = {
        'ASPN23_MEASUREMENT_ATTITUDE_2D_REFERENCE_FRAME_NE': 0,
        'ASPN23_MEASUREMENT_ATTITUDE_2D_REFERENCE_FRAME_ND': 1,
        'ASPN23_MEASUREMENT_ATTITUDE_2D_REFERENCE_FRAME_ED': 2,
        'ASPN23_MEASUREMENT_ATTITUDE_2D_ERROR_MODEL_NONE': 0,
    }
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__measurement_attitude2_d
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__measurement_attitude2_d
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__measurement_attitude2_d
            cls._TYPE_SUPPORT = module.type_support_msg__msg__measurement_attitude2_d
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__measurement_attitude2_d
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'ASPN23_MEASUREMENT_ATTITUDE_2D_REFERENCE_FRAME_NE': cls.__constants['ASPN23_MEASUREMENT_ATTITUDE_2D_REFERENCE_FRAME_NE'],
            'ASPN23_MEASUREMENT_ATTITUDE_2D_REFERENCE_FRAME_ND': cls.__constants['ASPN23_MEASUREMENT_ATTITUDE_2D_REFERENCE_FRAME_ND'],
            'ASPN23_MEASUREMENT_ATTITUDE_2D_REFERENCE_FRAME_ED': cls.__constants['ASPN23_MEASUREMENT_ATTITUDE_2D_REFERENCE_FRAME_ED'],
            'ASPN23_MEASUREMENT_ATTITUDE_2D_ERROR_MODEL_NONE': cls.__constants['ASPN23_MEASUREMENT_ATTITUDE_2D_ERROR_MODEL_NONE'],
        }

    @property
    def ASPN23_MEASUREMENT_ATTITUDE_2D_REFERENCE_FRAME_NE(self):
        """Message constant 'ASPN23_MEASUREMENT_ATTITUDE_2D_REFERENCE_FRAME_NE'."""
        return Metaclass_MeasurementAttitude2D.__constants['ASPN23_MEASUREMENT_ATTITUDE_2D_REFERENCE_FRAME_NE']

    @property
    def ASPN23_MEASUREMENT_ATTITUDE_2D_REFERENCE_FRAME_ND(self):
        """Message constant 'ASPN23_MEASUREMENT_ATTITUDE_2D_REFERENCE_FRAME_ND'."""
        return Metaclass_MeasurementAttitude2D.__constants['ASPN23_MEASUREMENT_ATTITUDE_2D_REFERENCE_FRAME_ND']

    @property
    def ASPN23_MEASUREMENT_ATTITUDE_2D_REFERENCE_FRAME_ED(self):
        """Message constant 'ASPN23_MEASUREMENT_ATTITUDE_2D_REFERENCE_FRAME_ED'."""
        return Metaclass_MeasurementAttitude2D.__constants['ASPN23_MEASUREMENT_ATTITUDE_2D_REFERENCE_FRAME_ED']

    @property
    def ASPN23_MEASUREMENT_ATTITUDE_2D_ERROR_MODEL_NONE(self):
        """Message constant 'ASPN23_MEASUREMENT_ATTITUDE_2D_ERROR_MODEL_NONE'."""
        return Metaclass_MeasurementAttitude2D.__constants['ASPN23_MEASUREMENT_ATTITUDE_2D_ERROR_MODEL_NONE']


class MeasurementAttitude2D(metaclass=Metaclass_MeasurementAttitude2D):
    """
    Message class 'MeasurementAttitude2D'.
    ...
    def __init__(self, **kwargs):
        ...
        if 'attitude2d' not in kwargs:
            self.attitude2d = numpy.zeros(2, dtype=numpy.float64)
        else:
            self.attitude2d = kwargs.get('attitude2d')
    ...
    def __eq__(self, other):
        ...
        if self.reference_frame != other.reference_frame:
            return False
        if any(self.attitude2d != other.attitude2d):
            return False
    ...
    @builtins.property
    def attitude2d(self):
        """Message field 'attitude2d'."""
        return self._attitude2d

    @attitude2d.setter
    def attitude2d(self, value):
        if isinstance(value, numpy.ndarray):
            assert value.dtype == numpy.float64, \
                "The 'attitude2d' numpy.ndarray() must have the dtype of 'numpy.float64'"
            assert value.size == 2, \
                "The 'attitude2d' numpy.ndarray() must have a size of 2"
            self._attitude2d = value
            return
        if __debug__:
            ...
            assert \
                ...
                "The 'attitude2d' field must be a set or sequence with length 2 and each value of type 'float' and each double in [-.000000, .000000]"
        self._attitude2d = numpy.array(value, dtype=numpy.float64)
