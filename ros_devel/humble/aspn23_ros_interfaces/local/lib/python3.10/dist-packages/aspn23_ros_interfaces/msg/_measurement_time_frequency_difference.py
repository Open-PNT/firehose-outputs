...
# with input from aspn23_ros_interfaces:msg/MeasurementTimeFrequencyDifference.idl
...
class Metaclass_MeasurementTimeFrequencyDifference(type):
    """Metaclass of message 'MeasurementTimeFrequencyDifference'."""
    ...
    __constants = {
        'ASPN23_MEASUREMENT_TIME_FREQUENCY_DIFFERENCE_ERROR_MODEL_NONE': 0,
    }
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__measurement_time_frequency_difference
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__measurement_time_frequency_difference
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__measurement_time_frequency_difference
            cls._TYPE_SUPPORT = module.type_support_msg__msg__measurement_time_frequency_difference
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__measurement_time_frequency_difference
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'ASPN23_MEASUREMENT_TIME_FREQUENCY_DIFFERENCE_ERROR_MODEL_NONE': cls.__constants['ASPN23_MEASUREMENT_TIME_FREQUENCY_DIFFERENCE_ERROR_MODEL_NONE'],
        }

    @property
    def ASPN23_MEASUREMENT_TIME_FREQUENCY_DIFFERENCE_ERROR_MODEL_NONE(self):
        """Message constant 'ASPN23_MEASUREMENT_TIME_FREQUENCY_DIFFERENCE_ERROR_MODEL_NONE'."""
        return Metaclass_MeasurementTimeFrequencyDifference.__constants['ASPN23_MEASUREMENT_TIME_FREQUENCY_DIFFERENCE_ERROR_MODEL_NONE']


class MeasurementTimeFrequencyDifference(metaclass=Metaclass_MeasurementTimeFrequencyDifference):
    """
    Message class 'MeasurementTimeFrequencyDifference'.
    ...
    _fields_and_field_types = {
        ...
        'clock_id1': 'uint8',
        'clock_id2': 'uint8',
        'time_diff_nsec': 'int64',
        'time_diff_attosec': 'int32',
    ...
    def __init__(self, **kwargs):
        ...
        self.clock_id1 = kwargs.get('clock_id1', int())
        self.clock_id2 = kwargs.get('clock_id2', int())
        self.time_diff_nsec = kwargs.get('time_diff_nsec', int())
        self.time_diff_attosec = kwargs.get('time_diff_attosec', int())
        self.digits_of_precision = kwargs.get('digits_of_precision', int())
        self.freq_diff = kwargs.get('freq_diff', float())
    ...
    def __eq__(self, other):
        ...
        if self.time_of_validity_attosec != other.time_of_validity_attosec:
            return False
        if self.clock_id1 != other.clock_id1:
            return False
        if self.clock_id2 != other.clock_id2:
            return False
        if self.time_diff_nsec != other.time_diff_nsec:
            return False
        if self.time_diff_attosec != other.time_diff_attosec:
            return False
        if self.digits_of_precision != other.digits_of_precision:
            return False
        if self.freq_diff != other.freq_diff:
            return False
    ...
    @builtins.property
    def clock_id1(self):
        """Message field 'clock_id1'."""
        return self._clock_id1

    @clock_id1.setter
    def clock_id1(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'clock_id1' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'clock_id1' field must be an unsigned integer in [0, 255]"
        self._clock_id1 = value

    @builtins.property
    def clock_id2(self):
        """Message field 'clock_id2'."""
        return self._clock_id2

    @clock_id2.setter
    def clock_id2(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'clock_id2' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'clock_id2' field must be an unsigned integer in [0, 255]"
        self._clock_id2 = value

    @builtins.property
    def time_diff_nsec(self):
        """Message field 'time_diff_nsec'."""
        return self._time_diff_nsec

    @time_diff_nsec.setter
    def time_diff_nsec(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'time_diff_nsec' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'time_diff_nsec' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._time_diff_nsec = value

    @builtins.property
    def time_diff_attosec(self):
        """Message field 'time_diff_attosec'."""
        return self._time_diff_attosec

    @time_diff_attosec.setter
    def time_diff_attosec(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'time_diff_attosec' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'time_diff_attosec' field must be an integer in [-2147483648, 2147483647]"
        self._time_diff_attosec = value
    ...
    @builtins.property
    def freq_diff(self):
        """Message field 'freq_diff'."""
        return self._freq_diff

    @freq_diff.setter
    def freq_diff(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'freq_diff' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'freq_diff' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._freq_diff = value
