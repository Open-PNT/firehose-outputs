...
class Metaclass_MeasurementTdoa2Tx1Rx(type):
    """Metaclass of message 'MeasurementTdoa2Tx1Rx'."""
    ...
    __constants = {
        'ASPN23_MEASUREMENT_TDOA_2TX_1RX_ERROR_MODEL_NONE': 0,
    }
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__measurement_tdoa2_tx1_rx
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__measurement_tdoa2_tx1_rx
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__measurement_tdoa2_tx1_rx
            cls._TYPE_SUPPORT = module.type_support_msg__msg__measurement_tdoa2_tx1_rx
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__measurement_tdoa2_tx1_rx
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'ASPN23_MEASUREMENT_TDOA_2TX_1RX_ERROR_MODEL_NONE': cls.__constants['ASPN23_MEASUREMENT_TDOA_2TX_1RX_ERROR_MODEL_NONE'],
        }

    @property
    def ASPN23_MEASUREMENT_TDOA_2TX_1RX_ERROR_MODEL_NONE(self):
        """Message constant 'ASPN23_MEASUREMENT_TDOA_2TX_1RX_ERROR_MODEL_NONE'."""
        return Metaclass_MeasurementTdoa2Tx1Rx.__constants['ASPN23_MEASUREMENT_TDOA_2TX_1RX_ERROR_MODEL_NONE']


class MeasurementTdoa2Tx1Rx(metaclass=Metaclass_MeasurementTdoa2Tx1Rx):
    """
    Message class 'MeasurementTdoa2Tx1Rx'.
    ...
    __slots__ = [
        '_header',
        '_time_of_validity',
        '_tx1_position_and_covariance',
        '_tx2_position_and_covariance',
        '_obs',
        '_variance',
        '_error_model',
    ...
    _fields_and_field_types = {
        ...
        'tx1_position_and_covariance': 'aspn23_ros_interfaces/TypeRemotePoint',
        'tx2_position_and_covariance': 'aspn23_ros_interfaces/TypeRemotePoint',
        'obs': 'double',
        'variance': 'double',
        'error_model': 'uint8',
    ...
    def __init__(self, **kwargs):
        ...
        from aspn23_ros_interfaces.msg import TypeRemotePoint
        self.tx1_position_and_covariance = kwargs.get('tx1_position_and_covariance', TypeRemotePoint())
        from aspn23_ros_interfaces.msg import TypeRemotePoint
        self.tx2_position_and_covariance = kwargs.get('tx2_position_and_covariance', TypeRemotePoint())
    ...
    def __eq__(self, other):
        ...
        if self.time_of_validity != other.time_of_validity:
            return False
        if self.tx1_position_and_covariance != other.tx1_position_and_covariance:
            return False
        if self.tx2_position_and_covariance != other.tx2_position_and_covariance:
            return False
    ...
    @builtins.property
    def tx1_position_and_covariance(self):
        """Message field 'tx1_position_and_covariance'."""
        return self._tx1_position_and_covariance

    @tx1_position_and_covariance.setter
    def tx1_position_and_covariance(self, value):
        if __debug__:
            from aspn23_ros_interfaces.msg import TypeRemotePoint
            assert \
                isinstance(value, TypeRemotePoint), \
                "The 'tx1_position_and_covariance' field must be a sub message of type 'TypeRemotePoint'"
        self._tx1_position_and_covariance = value

    @builtins.property
    def tx2_position_and_covariance(self):
        """Message field 'tx2_position_and_covariance'."""
        return self._tx2_position_and_covariance

    @tx2_position_and_covariance.setter
    def tx2_position_and_covariance(self, value):
        if __debug__:
            from aspn23_ros_interfaces.msg import TypeRemotePoint
            assert \
                isinstance(value, TypeRemotePoint), \
                "The 'tx2_position_and_covariance' field must be a sub message of type 'TypeRemotePoint'"
        self._tx2_position_and_covariance = value
