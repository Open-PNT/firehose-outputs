...
bool aspn23_ros_interfaces__msg__type_satnav_satellite_system__convert_from_py(
  ...
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aspn23_ros_interfaces.msg._type_satnav_satellite_system."
  ...
  { // satellite_system
    ...
    ros_message->satellite_system = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
aspn23_ros_interfaces__msg__type_satnav_satellite_system__convert_to_py(
  ...
  /* NOTE(esteve): Call constructor of TypeSatnavSatelliteSystem */
  PyObject *_pymessage = NULL;
  {
    PyObject *pymessage_module = PyImport_ImportModule(
        "aspn23_ros_interfaces.msg._type_satnav_satellite_system");
    assert(pymessage_module);
    PyObject *pymessage_class =
        PyObject_GetAttrString(pymessage_module, "TypeSatnavSatelliteSystem");
  ...
  { // satellite_system
    PyObject *field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->satellite_system);
    {
