...
bool aspn23_ros_interfaces__msg__measurement_attitude2_d__convert_from_py(
  ...
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aspn23_ros_interfaces.msg._measurement_attitude2_d."
                   "MeasurementAttitude2D",
                   full_classname_dest, 72) == 0);
  }
  aspn23_ros_interfaces__msg__MeasurementAttitude2D *ros_message = _ros_message;
  { // header
  ...
  { // attitude2d
    PyObject *field = PyObject_GetAttrString(_pymsg, "attitude2d");
    if (!field) {
      return false;
    }
    {
      ...
      Py_ssize_t size = 2;
      double *dest = ros_message->attitude2d;
...
PyObject *aspn23_ros_interfaces__msg__measurement_attitude2_d__convert_to_py(
    void *raw_ros_message) {
  /* NOTE(esteve): Call constructor of MeasurementAttitude2D */
  PyObject *_pymessage = NULL;
  {
    PyObject *pymessage_module = PyImport_ImportModule(
        "aspn23_ros_interfaces.msg._measurement_attitude2_d");
    assert(pymessage_module);
    PyObject *pymessage_class =
        PyObject_GetAttrString(pymessage_module, "MeasurementAttitude2D");
  ...
  { // attitude2d
    PyObject *field = NULL;
    field = PyObject_GetAttrString(_pymessage, "attitude2d");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    double *src = &(ros_message->attitude2d[0]);
