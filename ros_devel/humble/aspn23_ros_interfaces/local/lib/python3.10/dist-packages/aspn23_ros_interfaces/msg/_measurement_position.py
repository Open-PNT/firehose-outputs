...
class Metaclass_MeasurementPosition(type):
    """Metaclass of message 'MeasurementPosition'."""
    ...
    __constants = {
        'ASPN23_MEASUREMENT_POSITION_REFERENCE_FRAME_ECI': 0,
        'ASPN23_MEASUREMENT_POSITION_REFERENCE_FRAME_GEODETIC': 1,
        'ASPN23_MEASUREMENT_POSITION_ERROR_MODEL_NONE': 0,
    }
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__measurement_position
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__measurement_position
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__measurement_position
            cls._TYPE_SUPPORT = module.type_support_msg__msg__measurement_position
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__measurement_position
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'ASPN23_MEASUREMENT_POSITION_REFERENCE_FRAME_ECI': cls.__constants['ASPN23_MEASUREMENT_POSITION_REFERENCE_FRAME_ECI'],
            'ASPN23_MEASUREMENT_POSITION_REFERENCE_FRAME_GEODETIC': cls.__constants['ASPN23_MEASUREMENT_POSITION_REFERENCE_FRAME_GEODETIC'],
            'ASPN23_MEASUREMENT_POSITION_ERROR_MODEL_NONE': cls.__constants['ASPN23_MEASUREMENT_POSITION_ERROR_MODEL_NONE'],
        }

    @property
    def ASPN23_MEASUREMENT_POSITION_REFERENCE_FRAME_ECI(self):
        """Message constant 'ASPN23_MEASUREMENT_POSITION_REFERENCE_FRAME_ECI'."""
        return Metaclass_MeasurementPosition.__constants['ASPN23_MEASUREMENT_POSITION_REFERENCE_FRAME_ECI']

    @property
    def ASPN23_MEASUREMENT_POSITION_REFERENCE_FRAME_GEODETIC(self):
        """Message constant 'ASPN23_MEASUREMENT_POSITION_REFERENCE_FRAME_GEODETIC'."""
        return Metaclass_MeasurementPosition.__constants['ASPN23_MEASUREMENT_POSITION_REFERENCE_FRAME_GEODETIC']

    @property
    def ASPN23_MEASUREMENT_POSITION_ERROR_MODEL_NONE(self):
        """Message constant 'ASPN23_MEASUREMENT_POSITION_ERROR_MODEL_NONE'."""
        return Metaclass_MeasurementPosition.__constants['ASPN23_MEASUREMENT_POSITION_ERROR_MODEL_NONE']


class MeasurementPosition(metaclass=Metaclass_MeasurementPosition):
    """
    Message class 'MeasurementPosition'.
