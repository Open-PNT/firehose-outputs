...
# with input from aspn23_ros_interfaces:msg/MeasurementAccumulatedDistanceTraveled.idl
...
class Metaclass_MeasurementAccumulatedDistanceTraveled(type):
    """Metaclass of message 'MeasurementAccumulatedDistanceTraveled'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__measurement_accumulated_distance_traveled
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__measurement_accumulated_distance_traveled
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__measurement_accumulated_distance_traveled
            cls._TYPE_SUPPORT = module.type_support_msg__msg__measurement_accumulated_distance_traveled
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__measurement_accumulated_distance_traveled
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'ASPN23_MEASUREMENT_ACCUMULATED_DISTANCE_TRAVELED_ERROR_MODEL_NONE': cls.__constants['ASPN23_MEASUREMENT_ACCUMULATED_DISTANCE_TRAVELED_ERROR_MODEL_NONE'],
        }

    @property
    def ASPN23_MEASUREMENT_ACCUMULATED_DISTANCE_TRAVELED_ERROR_MODEL_NONE(self):
        """Message constant 'ASPN23_MEASUREMENT_ACCUMULATED_DISTANCE_TRAVELED_ERROR_MODEL_NONE'."""
        return Metaclass_MeasurementAccumulatedDistanceTraveled.__constants['ASPN23_MEASUREMENT_ACCUMULATED_DISTANCE_TRAVELED_ERROR_MODEL_NONE']


class MeasurementAccumulatedDistanceTraveled(metaclass=Metaclass_MeasurementAccumulatedDistanceTraveled):
    """
    Message class 'MeasurementAccumulatedDistanceTraveled'.
