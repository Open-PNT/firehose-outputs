...
class Metaclass_MeasurementSpecificForce1D(type):
    """Metaclass of message 'MeasurementSpecificForce1D'."""
    ...
    __constants = {
        'ASPN23_MEASUREMENT_SPECIFIC_FORCE_1D_SENSOR_TYPE_INTEGRATED': 0,
        'ASPN23_MEASUREMENT_SPECIFIC_FORCE_1D_SENSOR_TYPE_SAMPLED': 1,
        'ASPN23_MEASUREMENT_SPECIFIC_FORCE_1D_ERROR_MODEL_NONE': 0,
    }
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__measurement_specific_force1_d
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__measurement_specific_force1_d
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__measurement_specific_force1_d
            cls._TYPE_SUPPORT = module.type_support_msg__msg__measurement_specific_force1_d
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__measurement_specific_force1_d
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'ASPN23_MEASUREMENT_SPECIFIC_FORCE_1D_SENSOR_TYPE_INTEGRATED': cls.__constants['ASPN23_MEASUREMENT_SPECIFIC_FORCE_1D_SENSOR_TYPE_INTEGRATED'],
            'ASPN23_MEASUREMENT_SPECIFIC_FORCE_1D_SENSOR_TYPE_SAMPLED': cls.__constants['ASPN23_MEASUREMENT_SPECIFIC_FORCE_1D_SENSOR_TYPE_SAMPLED'],
            'ASPN23_MEASUREMENT_SPECIFIC_FORCE_1D_ERROR_MODEL_NONE': cls.__constants['ASPN23_MEASUREMENT_SPECIFIC_FORCE_1D_ERROR_MODEL_NONE'],
        }

    @property
    def ASPN23_MEASUREMENT_SPECIFIC_FORCE_1D_SENSOR_TYPE_INTEGRATED(self):
        """Message constant 'ASPN23_MEASUREMENT_SPECIFIC_FORCE_1D_SENSOR_TYPE_INTEGRATED'."""
        return Metaclass_MeasurementSpecificForce1D.__constants['ASPN23_MEASUREMENT_SPECIFIC_FORCE_1D_SENSOR_TYPE_INTEGRATED']

    @property
    def ASPN23_MEASUREMENT_SPECIFIC_FORCE_1D_SENSOR_TYPE_SAMPLED(self):
        """Message constant 'ASPN23_MEASUREMENT_SPECIFIC_FORCE_1D_SENSOR_TYPE_SAMPLED'."""
        return Metaclass_MeasurementSpecificForce1D.__constants['ASPN23_MEASUREMENT_SPECIFIC_FORCE_1D_SENSOR_TYPE_SAMPLED']

    @property
    def ASPN23_MEASUREMENT_SPECIFIC_FORCE_1D_ERROR_MODEL_NONE(self):
        """Message constant 'ASPN23_MEASUREMENT_SPECIFIC_FORCE_1D_ERROR_MODEL_NONE'."""
        return Metaclass_MeasurementSpecificForce1D.__constants['ASPN23_MEASUREMENT_SPECIFIC_FORCE_1D_ERROR_MODEL_NONE']


class MeasurementSpecificForce1D(metaclass=Metaclass_MeasurementSpecificForce1D):
    """
    Message class 'MeasurementSpecificForce1D'.
