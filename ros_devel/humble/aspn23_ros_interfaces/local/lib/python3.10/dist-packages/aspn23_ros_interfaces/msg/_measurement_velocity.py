...
class Metaclass_MeasurementVelocity(type):
    """Metaclass of message 'MeasurementVelocity'."""
    ...
    __constants = {
        'ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_ECI': 0,
        'ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_ECEF': 1,
        'ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_NED': 2,
        'ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_SENSOR': 3,
        'ASPN23_MEASUREMENT_VELOCITY_ERROR_MODEL_NONE': 0,
    }
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__measurement_velocity
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__measurement_velocity
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__measurement_velocity
            cls._TYPE_SUPPORT = module.type_support_msg__msg__measurement_velocity
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__measurement_velocity
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_ECI': cls.__constants['ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_ECI'],
            'ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_ECEF': cls.__constants['ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_ECEF'],
            'ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_NED': cls.__constants['ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_NED'],
            'ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_SENSOR': cls.__constants['ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_SENSOR'],
            'ASPN23_MEASUREMENT_VELOCITY_ERROR_MODEL_NONE': cls.__constants['ASPN23_MEASUREMENT_VELOCITY_ERROR_MODEL_NONE'],
        }

    @property
    def ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_ECI(self):
        """Message constant 'ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_ECI'."""
        return Metaclass_MeasurementVelocity.__constants['ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_ECI']

    @property
    def ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_ECEF(self):
        """Message constant 'ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_ECEF'."""
        return Metaclass_MeasurementVelocity.__constants['ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_ECEF']

    @property
    def ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_NED(self):
        """Message constant 'ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_NED'."""
        return Metaclass_MeasurementVelocity.__constants['ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_NED']

    @property
    def ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_SENSOR(self):
        """Message constant 'ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_SENSOR'."""
        return Metaclass_MeasurementVelocity.__constants['ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_SENSOR']

    @property
    def ASPN23_MEASUREMENT_VELOCITY_ERROR_MODEL_NONE(self):
        """Message constant 'ASPN23_MEASUREMENT_VELOCITY_ERROR_MODEL_NONE'."""
        return Metaclass_MeasurementVelocity.__constants['ASPN23_MEASUREMENT_VELOCITY_ERROR_MODEL_NONE']


class MeasurementVelocity(metaclass=Metaclass_MeasurementVelocity):
    """
    Message class 'MeasurementVelocity'.
