...
class Metaclass_MeasurementDirectionOfMotion2D(type):
    """Metaclass of message 'MeasurementDirectionOfMotion2D'."""
    ...
    __constants = {
        'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_NE': 0,
        'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_ND': 1,
        'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_ED': 2,
        'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_SENSOR': 3,
        'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_ERROR_MODEL_NONE': 0,
    }
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__measurement_direction_of_motion2_d
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__measurement_direction_of_motion2_d
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__measurement_direction_of_motion2_d
            cls._TYPE_SUPPORT = module.type_support_msg__msg__measurement_direction_of_motion2_d
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__measurement_direction_of_motion2_d
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_NE': cls.__constants['ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_NE'],
            'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_ND': cls.__constants['ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_ND'],
            'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_ED': cls.__constants['ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_ED'],
            'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_SENSOR': cls.__constants['ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_SENSOR'],
            'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_ERROR_MODEL_NONE': cls.__constants['ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_ERROR_MODEL_NONE'],
        }

    @property
    def ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_NE(self):
        """Message constant 'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_NE'."""
        return Metaclass_MeasurementDirectionOfMotion2D.__constants['ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_NE']

    @property
    def ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_ND(self):
        """Message constant 'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_ND'."""
        return Metaclass_MeasurementDirectionOfMotion2D.__constants['ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_ND']

    @property
    def ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_ED(self):
        """Message constant 'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_ED'."""
        return Metaclass_MeasurementDirectionOfMotion2D.__constants['ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_ED']

    @property
    def ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_SENSOR(self):
        """Message constant 'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_SENSOR'."""
        return Metaclass_MeasurementDirectionOfMotion2D.__constants['ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_SENSOR']

    @property
    def ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_ERROR_MODEL_NONE(self):
        """Message constant 'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_ERROR_MODEL_NONE'."""
        return Metaclass_MeasurementDirectionOfMotion2D.__constants['ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_ERROR_MODEL_NONE']


class MeasurementDirectionOfMotion2D(metaclass=Metaclass_MeasurementDirectionOfMotion2D):
    """
    Message class 'MeasurementDirectionOfMotion2D'.
