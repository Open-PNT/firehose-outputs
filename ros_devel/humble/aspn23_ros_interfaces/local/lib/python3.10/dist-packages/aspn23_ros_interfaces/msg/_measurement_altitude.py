...
class Metaclass_MeasurementAltitude(type):
    """Metaclass of message 'MeasurementAltitude'."""
    ...
    __constants = {
        'ASPN23_MEASUREMENT_ALTITUDE_REFERENCE_AGL': 0,
        'ASPN23_MEASUREMENT_ALTITUDE_REFERENCE_MSL': 1,
        'ASPN23_MEASUREMENT_ALTITUDE_REFERENCE_HAE': 2,
        'ASPN23_MEASUREMENT_ALTITUDE_ERROR_MODEL_NONE': 0,
        'ASPN23_MEASUREMENT_ALTITUDE_ERROR_MODEL_FOGM': 1,
    }
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__measurement_altitude
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__measurement_altitude
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__measurement_altitude
            cls._TYPE_SUPPORT = module.type_support_msg__msg__measurement_altitude
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__measurement_altitude
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'ASPN23_MEASUREMENT_ALTITUDE_REFERENCE_AGL': cls.__constants['ASPN23_MEASUREMENT_ALTITUDE_REFERENCE_AGL'],
            'ASPN23_MEASUREMENT_ALTITUDE_REFERENCE_MSL': cls.__constants['ASPN23_MEASUREMENT_ALTITUDE_REFERENCE_MSL'],
            'ASPN23_MEASUREMENT_ALTITUDE_REFERENCE_HAE': cls.__constants['ASPN23_MEASUREMENT_ALTITUDE_REFERENCE_HAE'],
            'ASPN23_MEASUREMENT_ALTITUDE_ERROR_MODEL_NONE': cls.__constants['ASPN23_MEASUREMENT_ALTITUDE_ERROR_MODEL_NONE'],
            'ASPN23_MEASUREMENT_ALTITUDE_ERROR_MODEL_FOGM': cls.__constants['ASPN23_MEASUREMENT_ALTITUDE_ERROR_MODEL_FOGM'],
        }

    @property
    def ASPN23_MEASUREMENT_ALTITUDE_REFERENCE_AGL(self):
        """Message constant 'ASPN23_MEASUREMENT_ALTITUDE_REFERENCE_AGL'."""
        return Metaclass_MeasurementAltitude.__constants['ASPN23_MEASUREMENT_ALTITUDE_REFERENCE_AGL']

    @property
    def ASPN23_MEASUREMENT_ALTITUDE_REFERENCE_MSL(self):
        """Message constant 'ASPN23_MEASUREMENT_ALTITUDE_REFERENCE_MSL'."""
        return Metaclass_MeasurementAltitude.__constants['ASPN23_MEASUREMENT_ALTITUDE_REFERENCE_MSL']

    @property
    def ASPN23_MEASUREMENT_ALTITUDE_REFERENCE_HAE(self):
        """Message constant 'ASPN23_MEASUREMENT_ALTITUDE_REFERENCE_HAE'."""
        return Metaclass_MeasurementAltitude.__constants['ASPN23_MEASUREMENT_ALTITUDE_REFERENCE_HAE']

    @property
    def ASPN23_MEASUREMENT_ALTITUDE_ERROR_MODEL_NONE(self):
        """Message constant 'ASPN23_MEASUREMENT_ALTITUDE_ERROR_MODEL_NONE'."""
        return Metaclass_MeasurementAltitude.__constants['ASPN23_MEASUREMENT_ALTITUDE_ERROR_MODEL_NONE']

    @property
    def ASPN23_MEASUREMENT_ALTITUDE_ERROR_MODEL_FOGM(self):
        """Message constant 'ASPN23_MEASUREMENT_ALTITUDE_ERROR_MODEL_FOGM'."""
        return Metaclass_MeasurementAltitude.__constants['ASPN23_MEASUREMENT_ALTITUDE_ERROR_MODEL_FOGM']


class MeasurementAltitude(metaclass=Metaclass_MeasurementAltitude):
    """
    Message class 'MeasurementAltitude'.
