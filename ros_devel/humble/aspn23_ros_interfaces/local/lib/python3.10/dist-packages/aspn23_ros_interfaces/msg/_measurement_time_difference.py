...
class Metaclass_MeasurementTimeDifference(type):
    """Metaclass of message 'MeasurementTimeDifference'."""
    ...
    __constants = {
        'ASPN23_MEASUREMENT_TIME_DIFFERENCE_ERROR_MODEL_NONE': 0,
    }
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__measurement_time_difference
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__measurement_time_difference
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__measurement_time_difference
            cls._TYPE_SUPPORT = module.type_support_msg__msg__measurement_time_difference
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__measurement_time_difference
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'ASPN23_MEASUREMENT_TIME_DIFFERENCE_ERROR_MODEL_NONE': cls.__constants['ASPN23_MEASUREMENT_TIME_DIFFERENCE_ERROR_MODEL_NONE'],
        }

    @property
    def ASPN23_MEASUREMENT_TIME_DIFFERENCE_ERROR_MODEL_NONE(self):
        """Message constant 'ASPN23_MEASUREMENT_TIME_DIFFERENCE_ERROR_MODEL_NONE'."""
        return Metaclass_MeasurementTimeDifference.__constants['ASPN23_MEASUREMENT_TIME_DIFFERENCE_ERROR_MODEL_NONE']


class MeasurementTimeDifference(metaclass=Metaclass_MeasurementTimeDifference):
    """
    Message class 'MeasurementTimeDifference'.
