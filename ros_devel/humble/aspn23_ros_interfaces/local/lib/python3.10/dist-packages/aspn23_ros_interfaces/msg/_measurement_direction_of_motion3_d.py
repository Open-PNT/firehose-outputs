...
class Metaclass_MeasurementDirectionOfMotion3D(type):
    """Metaclass of message 'MeasurementDirectionOfMotion3D'."""
    ...
    __constants = {
        'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_ECI': 0,
        'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_ECEF': 1,
        'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_NED': 2,
        'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_SENSOR': 3,
        'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_ERROR_MODEL_NONE': 0,
    }
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__measurement_direction_of_motion3_d
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__measurement_direction_of_motion3_d
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__measurement_direction_of_motion3_d
            cls._TYPE_SUPPORT = module.type_support_msg__msg__measurement_direction_of_motion3_d
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__measurement_direction_of_motion3_d
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_ECI': cls.__constants['ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_ECI'],
            'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_ECEF': cls.__constants['ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_ECEF'],
            'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_NED': cls.__constants['ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_NED'],
            'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_SENSOR': cls.__constants['ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_SENSOR'],
            'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_ERROR_MODEL_NONE': cls.__constants['ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_ERROR_MODEL_NONE'],
        }

    @property
    def ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_ECI(self):
        """Message constant 'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_ECI'."""
        return Metaclass_MeasurementDirectionOfMotion3D.__constants['ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_ECI']

    @property
    def ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_ECEF(self):
        """Message constant 'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_ECEF'."""
        return Metaclass_MeasurementDirectionOfMotion3D.__constants['ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_ECEF']

    @property
    def ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_NED(self):
        """Message constant 'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_NED'."""
        return Metaclass_MeasurementDirectionOfMotion3D.__constants['ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_NED']

    @property
    def ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_SENSOR(self):
        """Message constant 'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_SENSOR'."""
        return Metaclass_MeasurementDirectionOfMotion3D.__constants['ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_SENSOR']

    @property
    def ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_ERROR_MODEL_NONE(self):
        """Message constant 'ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_ERROR_MODEL_NONE'."""
        return Metaclass_MeasurementDirectionOfMotion3D.__constants['ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_ERROR_MODEL_NONE']


class MeasurementDirectionOfMotion3D(metaclass=Metaclass_MeasurementDirectionOfMotion3D):
    """
    Message class 'MeasurementDirectionOfMotion3D'.
    ...
    def __init__(self, **kwargs):
        ...
        if 'obs' not in kwargs:
            self.obs = numpy.zeros(3, dtype=numpy.float64)
        else:
            self.obs = kwargs.get('obs')
        if 'error_vector' not in kwargs:
            self.error_vector = numpy.zeros(3, dtype=numpy.float64)
        else:
            self.error_vector = kwargs.get('error_vector')
    ...
    def __eq__(self, other):
        ...
        if any(self.obs != other.obs):
            return False
        if any(self.error_vector != other.error_vector):
            return False
    ...
    def obs(self, value):
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 3, \
                "The 'obs' numpy.ndarray() must have a size of 3"
            self._obs = value
            return
        if __debug__:
            ...
            assert \
                ...
                "The 'obs' field must be a set or sequence with length 3 and each value of type 'float' and each double in [-.000000, .000000]"
        self._obs = numpy.array(value, dtype=numpy.float64)

    @builtins.property
    def error_vector(self):
        """Message field 'error_vector'."""
    ...
    def error_vector(self, value):
        if isinstance(value, numpy.ndarray):
            assert value.dtype == numpy.float64, \
                "The 'error_vector' numpy.ndarray() must have the dtype of 'numpy.float64'"
            assert value.size == 3, \
                "The 'error_vector' numpy.ndarray() must have a size of 3"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(not (val < -1.7976931348623157e+308 or val > 1.7976931348623157e+308) or math.isinf(val) for val in value)), \
                "The 'error_vector' field must be a set or sequence with length 3 and each value of type 'float' and each double in [-.000000, .000000]"
        self._error_vector = numpy.array(value, dtype=numpy.float64)
