...
class Metaclass_MeasurementDeltaPosition(type):
    """Metaclass of message 'MeasurementDeltaPosition'."""
    ...
    __constants = {
        'ASPN23_MEASUREMENT_DELTA_POSITION_REFERENCE_FRAME_NED': 0,
        'ASPN23_MEASUREMENT_DELTA_POSITION_REFERENCE_FRAME_SENSOR_START': 1,
        'ASPN23_MEASUREMENT_DELTA_POSITION_REFERENCE_FRAME_SENSOR_END': 2,
        'ASPN23_MEASUREMENT_DELTA_POSITION_ERROR_MODEL_NONE': 0,
    }
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__measurement_delta_position
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__measurement_delta_position
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__measurement_delta_position
            cls._TYPE_SUPPORT = module.type_support_msg__msg__measurement_delta_position
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__measurement_delta_position
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'ASPN23_MEASUREMENT_DELTA_POSITION_REFERENCE_FRAME_NED': cls.__constants['ASPN23_MEASUREMENT_DELTA_POSITION_REFERENCE_FRAME_NED'],
            'ASPN23_MEASUREMENT_DELTA_POSITION_REFERENCE_FRAME_SENSOR_START': cls.__constants['ASPN23_MEASUREMENT_DELTA_POSITION_REFERENCE_FRAME_SENSOR_START'],
            'ASPN23_MEASUREMENT_DELTA_POSITION_REFERENCE_FRAME_SENSOR_END': cls.__constants['ASPN23_MEASUREMENT_DELTA_POSITION_REFERENCE_FRAME_SENSOR_END'],
            'ASPN23_MEASUREMENT_DELTA_POSITION_ERROR_MODEL_NONE': cls.__constants['ASPN23_MEASUREMENT_DELTA_POSITION_ERROR_MODEL_NONE'],
        }

    @property
    def ASPN23_MEASUREMENT_DELTA_POSITION_REFERENCE_FRAME_NED(self):
        """Message constant 'ASPN23_MEASUREMENT_DELTA_POSITION_REFERENCE_FRAME_NED'."""
        return Metaclass_MeasurementDeltaPosition.__constants['ASPN23_MEASUREMENT_DELTA_POSITION_REFERENCE_FRAME_NED']

    @property
    def ASPN23_MEASUREMENT_DELTA_POSITION_REFERENCE_FRAME_SENSOR_START(self):
        """Message constant 'ASPN23_MEASUREMENT_DELTA_POSITION_REFERENCE_FRAME_SENSOR_START'."""
        return Metaclass_MeasurementDeltaPosition.__constants['ASPN23_MEASUREMENT_DELTA_POSITION_REFERENCE_FRAME_SENSOR_START']

    @property
    def ASPN23_MEASUREMENT_DELTA_POSITION_REFERENCE_FRAME_SENSOR_END(self):
        """Message constant 'ASPN23_MEASUREMENT_DELTA_POSITION_REFERENCE_FRAME_SENSOR_END'."""
        return Metaclass_MeasurementDeltaPosition.__constants['ASPN23_MEASUREMENT_DELTA_POSITION_REFERENCE_FRAME_SENSOR_END']

    @property
    def ASPN23_MEASUREMENT_DELTA_POSITION_ERROR_MODEL_NONE(self):
        """Message constant 'ASPN23_MEASUREMENT_DELTA_POSITION_ERROR_MODEL_NONE'."""
        return Metaclass_MeasurementDeltaPosition.__constants['ASPN23_MEASUREMENT_DELTA_POSITION_ERROR_MODEL_NONE']


class MeasurementDeltaPosition(metaclass=Metaclass_MeasurementDeltaPosition):
    """
    Message class 'MeasurementDeltaPosition'.
    ...
    def __init__(self, **kwargs):
        ...
        self.term1 = kwargs.get('term1', float())
        self.term2 = kwargs.get('term2', float())
        self.term3 = kwargs.get('term3', float())
    ...
    def __eq__(self, other):
        ...
        if self.term1 != other.term1:
            return False
        if self.term2 != other.term2:
            return False
        if self.term3 != other.term3:
            return False
    ...
    def delta_t(self, value):
        if __debug__:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'delta_t' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._delta_t = value
    ...
    @term1.setter
    def term1(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'term1' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'term1' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._term1 = value
    ...
    @term2.setter
    def term2(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'term2' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'term2' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._term2 = value
    ...
    @term3.setter
    def term3(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'term3' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'term3' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._term3 = value
