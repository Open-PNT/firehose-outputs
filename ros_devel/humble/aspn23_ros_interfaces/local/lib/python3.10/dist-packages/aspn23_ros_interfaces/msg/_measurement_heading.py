...
class Metaclass_MeasurementHeading(type):
    """Metaclass of message 'MeasurementHeading'."""
    ...
    __constants = {
        'ASPN23_MEASUREMENT_HEADING_REFERENCE_TRUE_HEADING': 0,
        'ASPN23_MEASUREMENT_HEADING_REFERENCE_MAGNETIC_HEADING': 1,
        'ASPN23_MEASUREMENT_HEADING_ERROR_MODEL_NONE': 0,
    }
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__measurement_heading
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__measurement_heading
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__measurement_heading
            cls._TYPE_SUPPORT = module.type_support_msg__msg__measurement_heading
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__measurement_heading
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'ASPN23_MEASUREMENT_HEADING_REFERENCE_TRUE_HEADING': cls.__constants['ASPN23_MEASUREMENT_HEADING_REFERENCE_TRUE_HEADING'],
            'ASPN23_MEASUREMENT_HEADING_REFERENCE_MAGNETIC_HEADING': cls.__constants['ASPN23_MEASUREMENT_HEADING_REFERENCE_MAGNETIC_HEADING'],
            'ASPN23_MEASUREMENT_HEADING_ERROR_MODEL_NONE': cls.__constants['ASPN23_MEASUREMENT_HEADING_ERROR_MODEL_NONE'],
        }

    @property
    def ASPN23_MEASUREMENT_HEADING_REFERENCE_TRUE_HEADING(self):
        """Message constant 'ASPN23_MEASUREMENT_HEADING_REFERENCE_TRUE_HEADING'."""
        return Metaclass_MeasurementHeading.__constants['ASPN23_MEASUREMENT_HEADING_REFERENCE_TRUE_HEADING']

    @property
    def ASPN23_MEASUREMENT_HEADING_REFERENCE_MAGNETIC_HEADING(self):
        """Message constant 'ASPN23_MEASUREMENT_HEADING_REFERENCE_MAGNETIC_HEADING'."""
        return Metaclass_MeasurementHeading.__constants['ASPN23_MEASUREMENT_HEADING_REFERENCE_MAGNETIC_HEADING']

    @property
    def ASPN23_MEASUREMENT_HEADING_ERROR_MODEL_NONE(self):
        """Message constant 'ASPN23_MEASUREMENT_HEADING_ERROR_MODEL_NONE'."""
        return Metaclass_MeasurementHeading.__constants['ASPN23_MEASUREMENT_HEADING_ERROR_MODEL_NONE']


class MeasurementHeading(metaclass=Metaclass_MeasurementHeading):
    """
    Message class 'MeasurementHeading'.
