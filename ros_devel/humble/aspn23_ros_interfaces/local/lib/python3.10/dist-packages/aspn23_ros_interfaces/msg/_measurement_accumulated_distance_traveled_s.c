...
bool aspn23_ros_interfaces__msg__measurement_accumulated_distance_traveled__convert_from_py(
  ...
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aspn23_ros_interfaces.msg._measurement_accumulated_"
                   "distance_traveled.MeasurementAccumulatedDistanceTraveled",
                   full_classname_dest, 107) == 0);
  }
  aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled
      *ros_message = _ros_message;
  { // header
...
aspn23_ros_interfaces__msg__measurement_accumulated_distance_traveled__convert_to_py(
    void *raw_ros_message) {
  /* NOTE(esteve): Call constructor of MeasurementAccumulatedDistanceTraveled */
  PyObject *_pymessage = NULL;
  {
    PyObject *pymessage_module = PyImport_ImportModule(
        "aspn23_ros_interfaces.msg._measurement_accumulated_distance_traveled");
    assert(pymessage_module);
    PyObject *pymessage_class = PyObject_GetAttrString(
        pymessage_module, "MeasurementAccumulatedDistanceTraveled");
