...
bool aspn23_ros_interfaces__msg__measurement_velocity__convert_from_py(
  ...
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aspn23_ros_interfaces.msg._measurement_velocity."
                   "MeasurementVelocity",
                   full_classname_dest, 67) == 0);
  }
  aspn23_ros_interfaces__msg__MeasurementVelocity *ros_message = _ros_message;
  { // header
...
PyObject *aspn23_ros_interfaces__msg__measurement_velocity__convert_to_py(
    void *raw_ros_message) {
  /* NOTE(esteve): Call constructor of MeasurementVelocity */
  PyObject *_pymessage = NULL;
  {
    PyObject *pymessage_module = PyImport_ImportModule(
        "aspn23_ros_interfaces.msg._measurement_velocity");
    assert(pymessage_module);
    PyObject *pymessage_class =
        PyObject_GetAttrString(pymessage_module, "MeasurementVelocity");
