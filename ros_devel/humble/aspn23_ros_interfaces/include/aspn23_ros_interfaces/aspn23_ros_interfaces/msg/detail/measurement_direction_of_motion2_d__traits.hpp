...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DIRECTION_OF_MOTION2_D__TRAITS_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DIRECTION_OF_MOTION2_D__TRAITS_HPP_
...
inline void to_flow_style_yaml(const MeasurementDirectionOfMotion2D &msg,
                               std::ostream &out) {
  out << "{";
  // member: header
  {
...
inline void to_block_style_yaml(const MeasurementDirectionOfMotion2D &msg,
...
inline std::string to_yaml(const MeasurementDirectionOfMotion2D &msg,
...
[[deprecated("use aspn23_ros_interfaces::msg::to_block_style_yaml() "
             "instead")]] inline void
to_yaml(const aspn23_ros_interfaces::msg::MeasurementDirectionOfMotion2D &msg,
        std::ostream &out, size_t indentation = 0) {
...
template <>
inline const char *
data_type<aspn23_ros_interfaces::msg::MeasurementDirectionOfMotion2D>() {
  return "aspn23_ros_interfaces::msg::MeasurementDirectionOfMotion2D";
}

template <>
inline const char *
name<aspn23_ros_interfaces::msg::MeasurementDirectionOfMotion2D>() {
  return "aspn23_ros_interfaces/msg/MeasurementDirectionOfMotion2D";
}
...
template <>
struct is_message<aspn23_ros_interfaces::msg::MeasurementDirectionOfMotion2D>
    : std::true_type {};

} // namespace rosidl_generator_traits

#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DIRECTION_OF_MOTION2_D__TRAITS_HPP_
