...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_TEMPERATURE__STRUCT_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_TEMPERATURE__STRUCT_HPP_
...
#ifndef _WIN32
#define DEPRECATED__aspn23_ros_interfaces__msg__MeasurementTemperature         \
...
// message struct
template <class ContainerAllocator> struct MeasurementTemperature_ {
  using Type = MeasurementTemperature_<ContainerAllocator>;

  explicit MeasurementTemperature_(
  ...
  static constexpr uint8_t ASPN23_MEASUREMENT_TEMPERATURE_ERROR_MODEL_NONE = 0u;

  // pointer types
  using RawPtr =
      aspn23_ros_interfaces::msg::MeasurementTemperature_<ContainerAllocator> *;
  using ConstRawPtr = const aspn23_ros_interfaces::msg::MeasurementTemperature_<
      ContainerAllocator> *;
  using SharedPtr = std::shared_ptr<
      aspn23_ros_interfaces::msg::MeasurementTemperature_<ContainerAllocator>>;
  using ConstSharedPtr =
      std::shared_ptr<aspn23_ros_interfaces::msg::MeasurementTemperature_<
          ContainerAllocator> const>;

  template <typename Deleter = std::default_delete<
                aspn23_ros_interfaces::msg::MeasurementTemperature_<
                    ContainerAllocator>>>
  ...
  using ConstUniquePtrWithDeleter =
      std::unique_ptr<aspn23_ros_interfaces::msg::MeasurementTemperature_<
                          ContainerAllocator> const,
                      Deleter>;
  ...
  using WeakPtr = std::weak_ptr<
      aspn23_ros_interfaces::msg::MeasurementTemperature_<ContainerAllocator>>;
  using ConstWeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::MeasurementTemperature_<
          ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes
  // properly
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementTemperature
      std::shared_ptr<aspn23_ros_interfaces::msg::MeasurementTemperature_<
          ContainerAllocator>>
          Ptr;
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementTemperature
  ...
  bool operator==(const MeasurementTemperature_ &other) const {
...
}; // struct MeasurementTemperature_

// alias to use template instance with default allocator
using MeasurementTemperature =
    aspn23_ros_interfaces::msg::MeasurementTemperature_<std::allocator<void>>;
...
constexpr uint8_t MeasurementTemperature_<
    ContainerAllocator>::ASPN23_MEASUREMENT_TEMPERATURE_ERROR_MODEL_NONE;
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_TEMPERATURE__STRUCT_HPP_
