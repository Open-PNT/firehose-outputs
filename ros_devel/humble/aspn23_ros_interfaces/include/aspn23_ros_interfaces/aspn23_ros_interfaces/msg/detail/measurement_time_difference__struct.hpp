...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_TIME_DIFFERENCE__STRUCT_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_TIME_DIFFERENCE__STRUCT_HPP_
...
#ifndef _WIN32
#define DEPRECATED__aspn23_ros_interfaces__msg__MeasurementTimeDifference      \
...
// message struct
template <class ContainerAllocator> struct MeasurementTimeDifference_ {
  using Type = MeasurementTimeDifference_<ContainerAllocator>;

  explicit MeasurementTimeDifference_(
  ...
  static constexpr uint8_t ASPN23_MEASUREMENT_TIME_DIFFERENCE_ERROR_MODEL_NONE =
      0u;

  // pointer types
  using RawPtr =
      aspn23_ros_interfaces::msg::MeasurementTimeDifference_<ContainerAllocator>
          *;
  using ConstRawPtr =
      const aspn23_ros_interfaces::msg::MeasurementTimeDifference_<
          ContainerAllocator> *;
  using SharedPtr =
      std::shared_ptr<aspn23_ros_interfaces::msg::MeasurementTimeDifference_<
          ContainerAllocator>>;
  ...
  template <typename Deleter = std::default_delete<
                aspn23_ros_interfaces::msg::MeasurementTimeDifference_<
                    ContainerAllocator>>>
  using UniquePtrWithDeleter =
      std::unique_ptr<aspn23_ros_interfaces::msg::MeasurementTimeDifference_<
                          ContainerAllocator>,
                      Deleter>;
  ...
  using WeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::MeasurementTimeDifference_<
          ContainerAllocator>>;
  using ConstWeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::MeasurementTimeDifference_<
          ContainerAllocator> const>;
  ...
  // properly
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementTimeDifference
      std::shared_ptr<aspn23_ros_interfaces::msg::MeasurementTimeDifference_<
          ContainerAllocator>>
          Ptr;
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementTimeDifference
  ...
  bool operator==(const MeasurementTimeDifference_ &other) const {
...
}; // struct MeasurementTimeDifference_

// alias to use template instance with default allocator
using MeasurementTimeDifference =
    aspn23_ros_interfaces::msg::MeasurementTimeDifference_<
        std::allocator<void>>;
...
constexpr uint8_t MeasurementTimeDifference_<
    ContainerAllocator>::ASPN23_MEASUREMENT_TIME_DIFFERENCE_ERROR_MODEL_NONE;
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_TIME_DIFFERENCE__STRUCT_HPP_
