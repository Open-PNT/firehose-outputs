...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_ATTITUDE3_D__TRAITS_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_ATTITUDE3_D__TRAITS_HPP_
...
inline void to_flow_style_yaml(const MeasurementAttitude3D &msg,
                               std::ostream &out) {
  out << "{";
  // member: header
  {
  ...
  {
    if (msg.tilt_error_covariance.size() == 0) {
      out << "tilt_error_covariance: []";
    } else {
      out << "tilt_error_covariance: [";
      size_t pending_items = msg.tilt_error_covariance.size();
      for (auto item : msg.tilt_error_covariance) {
        rosidl_generator_traits::value_to_yaml(item, out);
        if (--pending_items > 0) {
          out << ", ";
        }
...
inline void to_block_style_yaml(const MeasurementAttitude3D &msg,
...
inline std::string to_yaml(const MeasurementAttitude3D &msg,
...
[[deprecated("use aspn23_ros_interfaces::msg::to_block_style_yaml() "
             "instead")]] inline void
to_yaml(const aspn23_ros_interfaces::msg::MeasurementAttitude3D &msg,
        std::ostream &out, size_t indentation = 0) {
...
template <>
inline const char *
data_type<aspn23_ros_interfaces::msg::MeasurementAttitude3D>() {
  return "aspn23_ros_interfaces::msg::MeasurementAttitude3D";
}

template <>
inline const char *name<aspn23_ros_interfaces::msg::MeasurementAttitude3D>() {
  return "aspn23_ros_interfaces/msg/MeasurementAttitude3D";
}

template <>
struct has_fixed_size<aspn23_ros_interfaces::msg::MeasurementAttitude3D>
    : std::integral_constant<bool, false> {};

template <>
struct has_bounded_size<aspn23_ros_interfaces::msg::MeasurementAttitude3D>
    : std::integral_constant<bool, false> {};

template <>
struct is_message<aspn23_ros_interfaces::msg::MeasurementAttitude3D>
    : std::true_type {};

} // namespace rosidl_generator_traits

#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_ATTITUDE3_D__TRAITS_HPP_
