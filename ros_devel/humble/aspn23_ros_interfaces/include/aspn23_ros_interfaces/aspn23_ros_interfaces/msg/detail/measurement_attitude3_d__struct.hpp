...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_ATTITUDE3_D__STRUCT_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_ATTITUDE3_D__STRUCT_HPP_
...
#ifndef _WIN32
#define DEPRECATED__aspn23_ros_interfaces__msg__MeasurementAttitude3D          \
...
// message struct
template <class ContainerAllocator> struct MeasurementAttitude3D_ {
  using Type = MeasurementAttitude3D_<ContainerAllocator>;

  explicit MeasurementAttitude3D_(
    ...
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      ...
      std::fill<typename std::array<double, 9>::iterator, double>(
          this->tilt_error_covariance.begin(),
          this->tilt_error_covariance.end(), 0.0);
      this->error_model = 0;
  ...
  explicit MeasurementAttitude3D_(
      ...
      : header(_alloc, _init), time_of_validity(_alloc, _init),
        quaternion(_alloc), tilt_error_covariance(_alloc) {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
        rosidl_runtime_cpp::MessageInitialization::ZERO == _init) {
      this->reference_frame = 0;
      std::fill<typename std::array<double, 4>::iterator, double>(
  ...
  using _tilt_error_covariance_type = std::array<double, 9>;
  _tilt_error_covariance_type tilt_error_covariance;
  ...
  Type &set__tilt_error_covariance(const std::array<double, 9> &_arg) {
    this->tilt_error_covariance = _arg;
    return *this;
  }
  ...
  static constexpr uint8_t ASPN23_MEASUREMENT_ATTITUDE_3D_REFERENCE_FRAME_ECI =
      0u;
  static constexpr uint8_t ASPN23_MEASUREMENT_ATTITUDE_3D_REFERENCE_FRAME_ECEF =
      1u;
  static constexpr uint8_t ASPN23_MEASUREMENT_ATTITUDE_3D_REFERENCE_FRAME_NED =
      2u;
  static constexpr uint8_t ASPN23_MEASUREMENT_ATTITUDE_3D_ERROR_MODEL_NONE = 0u;

  // pointer types
  using RawPtr =
      aspn23_ros_interfaces::msg::MeasurementAttitude3D_<ContainerAllocator> *;
  using ConstRawPtr = const aspn23_ros_interfaces::msg::MeasurementAttitude3D_<
      ContainerAllocator> *;
  using SharedPtr = std::shared_ptr<
      aspn23_ros_interfaces::msg::MeasurementAttitude3D_<ContainerAllocator>>;
  using ConstSharedPtr =
      std::shared_ptr<aspn23_ros_interfaces::msg::MeasurementAttitude3D_<
          ContainerAllocator> const>;

  template <typename Deleter = std::default_delete<
                aspn23_ros_interfaces::msg::MeasurementAttitude3D_<
                    ContainerAllocator>>>
  ...
  using ConstUniquePtrWithDeleter =
      std::unique_ptr<aspn23_ros_interfaces::msg::MeasurementAttitude3D_<
                          ContainerAllocator> const,
                      Deleter>;
  ...
  using WeakPtr = std::weak_ptr<
      aspn23_ros_interfaces::msg::MeasurementAttitude3D_<ContainerAllocator>>;
  using ConstWeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::MeasurementAttitude3D_<
          ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes
  // properly
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementAttitude3D
      std::shared_ptr<aspn23_ros_interfaces::msg::MeasurementAttitude3D_<
          ContainerAllocator>>
          Ptr;
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementAttitude3D
  ...
  bool operator==(const MeasurementAttitude3D_ &other) const {
    ...
    if (this->tilt_error_covariance != other.tilt_error_covariance) {
      return false;
    }
...
}; // struct MeasurementAttitude3D_

// alias to use template instance with default allocator
using MeasurementAttitude3D =
    aspn23_ros_interfaces::msg::MeasurementAttitude3D_<std::allocator<void>>;
...
constexpr uint8_t MeasurementAttitude3D_<
    ContainerAllocator>::ASPN23_MEASUREMENT_ATTITUDE_3D_REFERENCE_FRAME_ECI;
...
template <typename ContainerAllocator>
constexpr uint8_t MeasurementAttitude3D_<
    ContainerAllocator>::ASPN23_MEASUREMENT_ATTITUDE_3D_REFERENCE_FRAME_ECEF;
#endif // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and
// below, deprecated in C++17
template <typename ContainerAllocator>
constexpr uint8_t MeasurementAttitude3D_<
    ContainerAllocator>::ASPN23_MEASUREMENT_ATTITUDE_3D_REFERENCE_FRAME_NED;
#endif // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and
// below, deprecated in C++17
template <typename ContainerAllocator>
constexpr uint8_t MeasurementAttitude3D_<
    ContainerAllocator>::ASPN23_MEASUREMENT_ATTITUDE_3D_ERROR_MODEL_NONE;
#endif // __cplusplus < 201703L
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_ATTITUDE3_D__STRUCT_HPP_
