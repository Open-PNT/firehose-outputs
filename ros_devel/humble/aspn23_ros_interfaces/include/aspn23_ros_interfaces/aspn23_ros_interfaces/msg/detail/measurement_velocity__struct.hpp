...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_VELOCITY__STRUCT_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_VELOCITY__STRUCT_HPP_
...
#ifndef _WIN32
#define DEPRECATED__aspn23_ros_interfaces__msg__MeasurementVelocity            \
...
// message struct
template <class ContainerAllocator> struct MeasurementVelocity_ {
  using Type = MeasurementVelocity_<ContainerAllocator>;

  explicit MeasurementVelocity_(
  ...
  static constexpr uint8_t ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_ECI = 0u;
  static constexpr uint8_t ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_ECEF =
      1u;
  static constexpr uint8_t ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_NED = 2u;
  static constexpr uint8_t ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_SENSOR =
      3u;
  static constexpr uint8_t ASPN23_MEASUREMENT_VELOCITY_ERROR_MODEL_NONE = 0u;

  // pointer types
  using RawPtr =
      aspn23_ros_interfaces::msg::MeasurementVelocity_<ContainerAllocator> *;
  using ConstRawPtr =
      const aspn23_ros_interfaces::msg::MeasurementVelocity_<ContainerAllocator>
          *;
  using SharedPtr = std::shared_ptr<
      aspn23_ros_interfaces::msg::MeasurementVelocity_<ContainerAllocator>>;
  using ConstSharedPtr =
      std::shared_ptr<aspn23_ros_interfaces::msg::MeasurementVelocity_<
  ...
  using ConstUniquePtrWithDeleter =
      std::unique_ptr<aspn23_ros_interfaces::msg::MeasurementVelocity_<
                          ContainerAllocator> const,
                      Deleter>;
  ...
  using WeakPtr = std::weak_ptr<
      aspn23_ros_interfaces::msg::MeasurementVelocity_<ContainerAllocator>>;
  using ConstWeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::MeasurementVelocity_<
          ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes
  // properly
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementVelocity
      std::shared_ptr<
          aspn23_ros_interfaces::msg::MeasurementVelocity_<ContainerAllocator>>
          Ptr;
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementVelocity
  ...
  bool operator==(const MeasurementVelocity_ &other) const {
...
}; // struct MeasurementVelocity_

// alias to use template instance with default allocator
using MeasurementVelocity =
    aspn23_ros_interfaces::msg::MeasurementVelocity_<std::allocator<void>>;
...
constexpr uint8_t MeasurementVelocity_<
    ContainerAllocator>::ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_ECI;
...
template <typename ContainerAllocator>
constexpr uint8_t MeasurementVelocity_<
    ContainerAllocator>::ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_ECEF;
#endif // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and
// below, deprecated in C++17
template <typename ContainerAllocator>
constexpr uint8_t MeasurementVelocity_<
    ContainerAllocator>::ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_NED;
#endif // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and
// below, deprecated in C++17
template <typename ContainerAllocator>
constexpr uint8_t MeasurementVelocity_<
    ContainerAllocator>::ASPN23_MEASUREMENT_VELOCITY_REFERENCE_FRAME_SENSOR;
#endif // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and
// below, deprecated in C++17
template <typename ContainerAllocator>
constexpr uint8_t MeasurementVelocity_<
    ContainerAllocator>::ASPN23_MEASUREMENT_VELOCITY_ERROR_MODEL_NONE;
#endif // __cplusplus < 201703L
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_VELOCITY__STRUCT_HPP_
