...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DIRECTION_OF_MOTION2_D__STRUCT_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DIRECTION_OF_MOTION2_D__STRUCT_HPP_
...
#ifndef _WIN32
#define DEPRECATED__aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion2D \
...
// message struct
template <class ContainerAllocator> struct MeasurementDirectionOfMotion2D_ {
  using Type = MeasurementDirectionOfMotion2D_<ContainerAllocator>;

  explicit MeasurementDirectionOfMotion2D_(
  ...
  static constexpr uint8_t
      ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_NE = 0u;
  static constexpr uint8_t
      ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_ND = 1u;
  static constexpr uint8_t
      ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_ED = 2u;
  static constexpr uint8_t
      ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_SENSOR = 3u;
  static constexpr uint8_t
      ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_ERROR_MODEL_NONE = 0u;

  // pointer types
  using RawPtr = aspn23_ros_interfaces::msg::MeasurementDirectionOfMotion2D_<
      ContainerAllocator> *;
  using ConstRawPtr =
      const aspn23_ros_interfaces::msg::MeasurementDirectionOfMotion2D_<
          ContainerAllocator> *;
  using SharedPtr =
      std::shared_ptr<aspn23_ros_interfaces::msg::
                          MeasurementDirectionOfMotion2D_<ContainerAllocator>>;
  using ConstSharedPtr = std::shared_ptr<
      aspn23_ros_interfaces::msg::MeasurementDirectionOfMotion2D_<
  ...
  using WeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::MeasurementDirectionOfMotion2D_<
          ContainerAllocator>>;
  using ConstWeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::MeasurementDirectionOfMotion2D_<
          ContainerAllocator> const>;
  ...
  // properly
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion2D
      std::shared_ptr<aspn23_ros_interfaces::msg::
                          MeasurementDirectionOfMotion2D_<ContainerAllocator>>
          Ptr;
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion2D
  ...
  bool operator==(const MeasurementDirectionOfMotion2D_ &other) const {
...
}; // struct MeasurementDirectionOfMotion2D_

// alias to use template instance with default allocator
using MeasurementDirectionOfMotion2D =
    aspn23_ros_interfaces::msg::MeasurementDirectionOfMotion2D_<
        std::allocator<void>>;
...
constexpr uint8_t MeasurementDirectionOfMotion2D_<
    ContainerAllocator>::ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_NE;
...
template <typename ContainerAllocator>
constexpr uint8_t MeasurementDirectionOfMotion2D_<
    ContainerAllocator>::ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_ND;
#endif // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and
// below, deprecated in C++17
template <typename ContainerAllocator>
constexpr uint8_t MeasurementDirectionOfMotion2D_<
    ContainerAllocator>::ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_ED;
#endif // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and
// below, deprecated in C++17
template <typename ContainerAllocator>
constexpr uint8_t MeasurementDirectionOfMotion2D_<ContainerAllocator>::
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DIRECTION_OF_MOTION2_D__STRUCT_HPP_
