...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_POSITION_ATTITUDE__STRUCT_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_POSITION_ATTITUDE__STRUCT_HPP_
...
#ifndef _WIN32
#define DEPRECATED__aspn23_ros_interfaces__msg__MeasurementPositionAttitude    \
...
// message struct
template <class ContainerAllocator> struct MeasurementPositionAttitude_ {
  using Type = MeasurementPositionAttitude_<ContainerAllocator>;

  explicit MeasurementPositionAttitude_(
    ...
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      ...
      std::fill<typename std::array<double, 36>::iterator, double>(
  ...
  explicit MeasurementPositionAttitude_(
      ...
      : header(_alloc, _init), time_of_validity(_alloc, _init),
        quaternion(_alloc), covariance(_alloc) {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
        rosidl_runtime_cpp::MessageInitialization::ZERO == _init) {
      this->reference_frame = 0;
      this->p1 = 0.0;
  ...
  static constexpr uint8_t
      ASPN23_MEASUREMENT_POSITION_ATTITUDE_REFERENCE_FRAME_ECI = 0u;
  static constexpr uint8_t
      ASPN23_MEASUREMENT_POSITION_ATTITUDE_REFERENCE_FRAME_GEODETIC = 1u;
  static constexpr uint8_t
      ASPN23_MEASUREMENT_POSITION_ATTITUDE_ERROR_MODEL_NONE = 0u;

  // pointer types
  using RawPtr = aspn23_ros_interfaces::msg::MeasurementPositionAttitude_<
      ContainerAllocator> *;
  using ConstRawPtr =
      const aspn23_ros_interfaces::msg::MeasurementPositionAttitude_<
          ContainerAllocator> *;
  using SharedPtr =
      std::shared_ptr<aspn23_ros_interfaces::msg::MeasurementPositionAttitude_<
          ContainerAllocator>>;
  ...
  template <typename Deleter = std::default_delete<
                aspn23_ros_interfaces::msg::MeasurementPositionAttitude_<
                    ContainerAllocator>>>
  using UniquePtrWithDeleter =
      std::unique_ptr<aspn23_ros_interfaces::msg::MeasurementPositionAttitude_<
                          ContainerAllocator>,
                      Deleter>;
  ...
  using WeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::MeasurementPositionAttitude_<
          ContainerAllocator>>;
  using ConstWeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::MeasurementPositionAttitude_<
          ContainerAllocator> const>;
  ...
  // properly
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementPositionAttitude
      std::shared_ptr<aspn23_ros_interfaces::msg::MeasurementPositionAttitude_<
          ContainerAllocator>>
          Ptr;
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementPositionAttitude
  ...
  bool operator==(const MeasurementPositionAttitude_ &other) const {
...
}; // struct MeasurementPositionAttitude_

// alias to use template instance with default allocator
using MeasurementPositionAttitude =
    aspn23_ros_interfaces::msg::MeasurementPositionAttitude_<
        std::allocator<void>>;
...
constexpr uint8_t MeasurementPositionAttitude_<ContainerAllocator>::
...
// below, deprecated in C++17
template <typename ContainerAllocator>
constexpr uint8_t MeasurementPositionAttitude_<
    ContainerAllocator>::ASPN23_MEASUREMENT_POSITION_ATTITUDE_ERROR_MODEL_NONE;
#endif // __cplusplus < 201703L
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_POSITION_ATTITUDE__STRUCT_HPP_
