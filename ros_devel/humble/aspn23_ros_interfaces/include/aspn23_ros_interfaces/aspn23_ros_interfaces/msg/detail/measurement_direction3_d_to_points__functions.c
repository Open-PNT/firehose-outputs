...
bool aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints__init(
  ...
  if (!aspn23_ros_interfaces__msg__TypeHeader__init(&msg->header)) {
    aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints__fini(msg);
    return false;
  }
  // time_of_validity
...
void aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints__fini(
    aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints *msg) {
  if (!msg) {
    return;
  }
  ...
  // num_obs
  // obs
  aspn23_ros_interfaces__msg__TypeDirection3DToPoint__Sequence__fini(&msg->obs);
}

bool aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints__are_equal(
  ...
  // obs
  if (!aspn23_ros_interfaces__msg__TypeDirection3DToPoint__Sequence__are_equal(
          &(lhs->obs), &(rhs->obs))) {
    return false;
  }
  return true;
...
bool aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints__copy(
  ...
  // obs
  if (!aspn23_ros_interfaces__msg__TypeDirection3DToPoint__Sequence__copy(
...
aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints__create() {
  ...
  bool success =
      aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints__init(msg);
  if (!success) {
...
void aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints__destroy(
    aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints *msg) {
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints__fini(msg);
...
bool aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints__Sequence__init(
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints *data = NULL;
...
void aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints__Sequence__fini(
...
void aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints__Sequence__destroy(
    aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints__Sequence
        *array) {
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
...
bool aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints__Sequence__are_equal(
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints__are_equal(
...
bool aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints__Sequence__copy(
    const aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints__Sequence
        *input,
    aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints__Sequence
        *output) {
  ...
  if (output->capacity < input->size) {
    ...
    aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints *data =
        (aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints *)allocator
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints__init(
              &output->data[i])) {
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints__copy(
