...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DELTA_POSITION__TRAITS_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DELTA_POSITION__TRAITS_HPP_
...
inline void to_flow_style_yaml(const MeasurementDeltaPosition &msg,
                               std::ostream &out) {
  out << "{";
  // member: header
  {
...
inline void to_block_style_yaml(const MeasurementDeltaPosition &msg,
...
inline std::string to_yaml(const MeasurementDeltaPosition &msg,
...
[[deprecated("use aspn23_ros_interfaces::msg::to_block_style_yaml() "
             "instead")]] inline void
to_yaml(const aspn23_ros_interfaces::msg::MeasurementDeltaPosition &msg,
        std::ostream &out, size_t indentation = 0) {
...
template <>
inline const char *
data_type<aspn23_ros_interfaces::msg::MeasurementDeltaPosition>() {
  return "aspn23_ros_interfaces::msg::MeasurementDeltaPosition";
}

template <>
inline const char *
name<aspn23_ros_interfaces::msg::MeasurementDeltaPosition>() {
  return "aspn23_ros_interfaces/msg/MeasurementDeltaPosition";
}

template <>
struct has_fixed_size<aspn23_ros_interfaces::msg::MeasurementDeltaPosition>
    : std::integral_constant<bool, false> {};

template <>
struct has_bounded_size<aspn23_ros_interfaces::msg::MeasurementDeltaPosition>
    : std::integral_constant<bool, false> {};

template <>
struct is_message<aspn23_ros_interfaces::msg::MeasurementDeltaPosition>
    : std::true_type {};

} // namespace rosidl_generator_traits

#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DELTA_POSITION__TRAITS_HPP_
