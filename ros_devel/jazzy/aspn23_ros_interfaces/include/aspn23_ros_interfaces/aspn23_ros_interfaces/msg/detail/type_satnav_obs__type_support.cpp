...
// input from aspn23_ros_interfaces:msg/TypeSatnavObs.idl generated code does
...
void TypeSatnavObs_init_function(
    void *message_memory, rosidl_runtime_cpp::MessageInitialization _init) {
  new (message_memory) aspn23_ros_interfaces::msg::TypeSatnavObs(_init);
}

void TypeSatnavObs_fini_function(void *message_memory) {
  auto typed_message =
      static_cast<aspn23_ros_interfaces::msg::TypeSatnavObs *>(message_memory);
  typed_message->~TypeSatnavObs();
}

size_t size_function__TypeSatnavObs__integrity(const void *untyped_member) {
...
const void *
get_const_function__TypeSatnavObs__integrity(const void *untyped_member,
                                             size_t index) {
  const auto &member = *reinterpret_cast<
      const std::vector<aspn23_ros_interfaces::msg::TypeIntegrity> *>(
      untyped_member);
...
void *get_function__TypeSatnavObs__integrity(void *untyped_member,
                                             size_t index) {
...
void fetch_function__TypeSatnavObs__integrity(const void *untyped_member,
                                              size_t index,
                                              void *untyped_value) {
  const auto &item =
      *reinterpret_cast<const aspn23_ros_interfaces::msg::TypeIntegrity *>(
          get_const_function__TypeSatnavObs__integrity(untyped_member, index));
  auto &value = *reinterpret_cast<aspn23_ros_interfaces::msg::TypeIntegrity *>(
      untyped_value);
  value = item;
}

void assign_function__TypeSatnavObs__integrity(void *untyped_member,
                                               size_t index,
                                               const void *untyped_value) {
  auto &item = *reinterpret_cast<aspn23_ros_interfaces::msg::TypeIntegrity *>(
      get_function__TypeSatnavObs__integrity(untyped_member, index));
  const auto &value =
      *reinterpret_cast<const aspn23_ros_interfaces::msg::TypeIntegrity *>(
          untyped_value);
  item = value;
...
void resize_function__TypeSatnavObs__integrity(void *untyped_member,
                                               size_t size) {
  auto *member = reinterpret_cast<
      std::vector<aspn23_ros_interfaces::msg::TypeIntegrity> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember
    TypeSatnavObs_message_member_array[19] = {
        {
            ...
            offsetof(aspn23_ros_interfaces::msg::TypeSatnavObs,
        ...
        },
        {
            ...
            ::rosidl_typesupport_introspection_cpp::
                get_message_type_support_handle<
                    aspn23_ros_interfaces::msg::
                        TypeSatnavSignalDescriptor>(), // members of sub message
            false,                                     // is key
            false,                                     // is array
            0,                                         // array size
            false,                                     // is upper bound
        ...
        },
        {
            ...
            nullptr,                                 // default value
            size_function__TypeSatnavObs__integrity, // size() function pointer
            get_const_function__TypeSatnavObs__integrity, // get_const(index)
                                                          // function pointer
            get_function__TypeSatnavObs__integrity,       // get(index) function
                                                          // pointer
            fetch_function__TypeSatnavObs__integrity,  // fetch(index, &value)
                                                       // function pointer
            assign_function__TypeSatnavObs__integrity, // assign(index, value)
                                                       // function pointer
            resize_function__TypeSatnavObs__integrity  // resize(index) function
                                                       // pointer
        }};

static const ::rosidl_typesupport_introspection_cpp::MessageMembers
    TypeSatnavObs_message_members = {
        "aspn23_ros_interfaces::msg", // message namespace
        "TypeSatnavObs",              // message name
        19,                           // number of fields
        sizeof(aspn23_ros_interfaces::msg::TypeSatnavObs),
        false,                              // has_any_key_member_
        TypeSatnavObs_message_member_array, // message members
        TypeSatnavObs_init_function, // function to initialize message memory
                                     // (memory has to be allocated)
        TypeSatnavObs_fini_function  // function to terminate message instance
                                     // (will not free memory)
};

static const rosidl_message_type_support_t
    TypeSatnavObs_message_type_support_handle = {
...
get_message_type_support_handle<aspn23_ros_interfaces::msg::TypeSatnavObs>() {
