...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_ANGULAR_VELOCITY1_D__TRAITS_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_ANGULAR_VELOCITY1_D__TRAITS_HPP_
...
inline void to_flow_style_yaml(const MeasurementAngularVelocity1D &msg,
                               std::ostream &out) {
  out << "{";
  // member: header
  {
...
inline void to_block_style_yaml(const MeasurementAngularVelocity1D &msg,
...
inline std::string to_yaml(const MeasurementAngularVelocity1D &msg,
...
inline void
to_yaml(const aspn23_ros_interfaces::msg::MeasurementAngularVelocity1D &msg,
        std::ostream &out, size_t indentation = 0) {
...
template <>
inline const char *
data_type<aspn23_ros_interfaces::msg::MeasurementAngularVelocity1D>() {
  return "aspn23_ros_interfaces::msg::MeasurementAngularVelocity1D";
}

template <>
inline const char *
name<aspn23_ros_interfaces::msg::MeasurementAngularVelocity1D>() {
  return "aspn23_ros_interfaces/msg/MeasurementAngularVelocity1D";
}

template <>
struct has_fixed_size<aspn23_ros_interfaces::msg::MeasurementAngularVelocity1D>
...
template <>
struct is_message<aspn23_ros_interfaces::msg::MeasurementAngularVelocity1D>
    : std::true_type {};

} // namespace rosidl_generator_traits

#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_ANGULAR_VELOCITY1_D__TRAITS_HPP_
