...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_RANGE_TO_POINT__STRUCT_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_RANGE_TO_POINT__STRUCT_HPP_
...
#ifndef _WIN32
#define DEPRECATED__aspn23_ros_interfaces__msg__MeasurementRangeToPoint        \
...
// message struct
template <class ContainerAllocator> struct MeasurementRangeToPoint_ {
  using Type = MeasurementRangeToPoint_<ContainerAllocator>;

  explicit MeasurementRangeToPoint_(
  ...
  static constexpr uint8_t ASPN23_MEASUREMENT_RANGE_TO_POINT_ERROR_MODEL_NONE =
      0u;

  // pointer types
  using RawPtr =
      aspn23_ros_interfaces::msg::MeasurementRangeToPoint_<ContainerAllocator>
          *;
  using ConstRawPtr =
      const aspn23_ros_interfaces::msg::MeasurementRangeToPoint_<
          ContainerAllocator> *;
  using SharedPtr = std::shared_ptr<
      aspn23_ros_interfaces::msg::MeasurementRangeToPoint_<ContainerAllocator>>;
  using ConstSharedPtr =
      std::shared_ptr<aspn23_ros_interfaces::msg::MeasurementRangeToPoint_<
          ContainerAllocator> const>;

  template <typename Deleter = std::default_delete<
                aspn23_ros_interfaces::msg::MeasurementRangeToPoint_<
                    ContainerAllocator>>>
  ...
  using ConstUniquePtrWithDeleter =
      std::unique_ptr<aspn23_ros_interfaces::msg::MeasurementRangeToPoint_<
                          ContainerAllocator> const,
                      Deleter>;
  ...
  using WeakPtr = std::weak_ptr<
      aspn23_ros_interfaces::msg::MeasurementRangeToPoint_<ContainerAllocator>>;
  using ConstWeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::MeasurementRangeToPoint_<
          ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes
  // properly
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementRangeToPoint
      std::shared_ptr<aspn23_ros_interfaces::msg::MeasurementRangeToPoint_<
          ContainerAllocator>>
          Ptr;
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementRangeToPoint
  ...
  bool operator==(const MeasurementRangeToPoint_ &other) const {
...
}; // struct MeasurementRangeToPoint_

// alias to use template instance with default allocator
using MeasurementRangeToPoint =
    aspn23_ros_interfaces::msg::MeasurementRangeToPoint_<std::allocator<void>>;
...
constexpr uint8_t MeasurementRangeToPoint_<
    ContainerAllocator>::ASPN23_MEASUREMENT_RANGE_TO_POINT_ERROR_MODEL_NONE;
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_RANGE_TO_POINT__STRUCT_HPP_
