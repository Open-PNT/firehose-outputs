...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_POSITION__TRAITS_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_POSITION__TRAITS_HPP_
...
inline void to_flow_style_yaml(const MeasurementPosition &msg,
                               std::ostream &out) {
  out << "{";
  // member: header
  {
  ...
  {
    out << "term1: ";
    rosidl_generator_traits::value_to_yaml(msg.term1, out);
    out << ", ";
  }
  ...
  {
    out << "term2: ";
    rosidl_generator_traits::value_to_yaml(msg.term2, out);
    out << ", ";
  }
  ...
  {
    out << "term3: ";
    rosidl_generator_traits::value_to_yaml(msg.term3, out);
    out << ", ";
  }
...
inline void to_block_style_yaml(const MeasurementPosition &msg,
...
inline std::string to_yaml(const MeasurementPosition &msg,
...
inline void to_yaml(const aspn23_ros_interfaces::msg::MeasurementPosition &msg,
                    std::ostream &out, size_t indentation = 0) {
...
inline std::string
to_yaml(const aspn23_ros_interfaces::msg::MeasurementPosition &msg) {
  return aspn23_ros_interfaces::msg::to_yaml(msg);
}

template <>
inline const char *
data_type<aspn23_ros_interfaces::msg::MeasurementPosition>() {
  return "aspn23_ros_interfaces::msg::MeasurementPosition";
}

template <>
inline const char *name<aspn23_ros_interfaces::msg::MeasurementPosition>() {
  return "aspn23_ros_interfaces/msg/MeasurementPosition";
}

template <>
struct has_fixed_size<aspn23_ros_interfaces::msg::MeasurementPosition>
    : std::integral_constant<bool, false> {};

template <>
struct has_bounded_size<aspn23_ros_interfaces::msg::MeasurementPosition>
    : std::integral_constant<bool, false> {};

template <>
struct is_message<aspn23_ros_interfaces::msg::MeasurementPosition>
    : std::true_type {};

} // namespace rosidl_generator_traits

#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_POSITION__TRAITS_HPP_
