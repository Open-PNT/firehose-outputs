...
bool aspn23_ros_interfaces__msg__MeasurementTemperature__init(
  ...
  if (!aspn23_ros_interfaces__msg__TypeHeader__init(&msg->header)) {
    aspn23_ros_interfaces__msg__MeasurementTemperature__fini(msg);
    return false;
  }
  // time_of_validity
...
void aspn23_ros_interfaces__msg__MeasurementTemperature__fini(
    aspn23_ros_interfaces__msg__MeasurementTemperature *msg) {
  if (!msg) {
    return;
  }
...
bool aspn23_ros_interfaces__msg__MeasurementTemperature__are_equal(
...
bool aspn23_ros_interfaces__msg__MeasurementTemperature__copy(
...
aspn23_ros_interfaces__msg__MeasurementTemperature__create(void) {
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aspn23_ros_interfaces__msg__MeasurementTemperature *msg =
      (aspn23_ros_interfaces__msg__MeasurementTemperature *)allocator.allocate(
          sizeof(aspn23_ros_interfaces__msg__MeasurementTemperature),
          allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(aspn23_ros_interfaces__msg__MeasurementTemperature));
  bool success = aspn23_ros_interfaces__msg__MeasurementTemperature__init(msg);
  if (!success) {
...
void aspn23_ros_interfaces__msg__MeasurementTemperature__destroy(
    aspn23_ros_interfaces__msg__MeasurementTemperature *msg) {
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    aspn23_ros_interfaces__msg__MeasurementTemperature__fini(msg);
...
bool aspn23_ros_interfaces__msg__MeasurementTemperature__Sequence__init(
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aspn23_ros_interfaces__msg__MeasurementTemperature *data = NULL;

  if (size) {
    data = (aspn23_ros_interfaces__msg__MeasurementTemperature *)
    ...
    for (i = 0; i < size; ++i) {
      bool success =
          aspn23_ros_interfaces__msg__MeasurementTemperature__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      // elements
      for (; i > 0; --i) {
        aspn23_ros_interfaces__msg__MeasurementTemperature__fini(&data[i - 1]);
      }
...
void aspn23_ros_interfaces__msg__MeasurementTemperature__Sequence__fini(
    aspn23_ros_interfaces__msg__MeasurementTemperature__Sequence *array) {
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      aspn23_ros_interfaces__msg__MeasurementTemperature__fini(&array->data[i]);
    }
...
aspn23_ros_interfaces__msg__MeasurementTemperature__Sequence__create(
  ...
  bool success =
      aspn23_ros_interfaces__msg__MeasurementTemperature__Sequence__init(array,
                                                                         size);
  if (!success) {
...
void aspn23_ros_interfaces__msg__MeasurementTemperature__Sequence__destroy(
    aspn23_ros_interfaces__msg__MeasurementTemperature__Sequence *array) {
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    aspn23_ros_interfaces__msg__MeasurementTemperature__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool aspn23_ros_interfaces__msg__MeasurementTemperature__Sequence__are_equal(
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!aspn23_ros_interfaces__msg__MeasurementTemperature__are_equal(
...
bool aspn23_ros_interfaces__msg__MeasurementTemperature__Sequence__copy(
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
        ...
        sizeof(aspn23_ros_interfaces__msg__MeasurementTemperature);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    aspn23_ros_interfaces__msg__MeasurementTemperature *data =
        (aspn23_ros_interfaces__msg__MeasurementTemperature *)allocator
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!aspn23_ros_interfaces__msg__MeasurementTemperature__init(
              &output->data[i])) {
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!aspn23_ros_interfaces__msg__MeasurementTemperature__copy(
