...
// IWYU pragma: private, include "aspn23_ros_interfaces/msg/measurement_direction_of_motion3_d.hpp"

#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DIRECTION_OF_MOTION3_D__STRUCT_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DIRECTION_OF_MOTION3_D__STRUCT_HPP_
...
#ifndef _WIN32
#define DEPRECATED__aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D \
...
// message struct
template <class ContainerAllocator> struct MeasurementDirectionOfMotion3D_ {
  using Type = MeasurementDirectionOfMotion3D_<ContainerAllocator>;

  explicit MeasurementDirectionOfMotion3D_(
    ...
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      ...
      std::fill<typename std::array<double, 3>::iterator, double>(
          this->error_vector.begin(), this->error_vector.end(), 0.0);
  ...
  explicit MeasurementDirectionOfMotion3D_(
      ...
      rosidl_runtime_cpp::MessageInitialization _init =
          rosidl_runtime_cpp::MessageInitialization::ALL)
      : header(_alloc, _init), time_of_validity(_alloc, _init), obs(_alloc),
        error_vector(_alloc), covariance(_alloc) {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
        rosidl_runtime_cpp::MessageInitialization::ZERO == _init) {
      this->reference_frame = 0;
      std::fill<typename std::array<double, 3>::iterator, double>(
  ...
  using _obs_type = std::array<double, 3>;
  _obs_type obs;
  using _error_vector_type = std::array<double, 3>;
  ...
  Type &set__obs(const std::array<double, 3> &_arg) {
    this->obs = _arg;
    return *this;
  }
  Type &set__error_vector(const std::array<double, 3> &_arg) {
    this->error_vector = _arg;
    return *this;
  }
  ...
  static constexpr uint8_t
      ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_ECI = 0u;
  static constexpr uint8_t
      ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_ECEF = 1u;
  static constexpr uint8_t
      ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_NED = 2u;
  static constexpr uint8_t
      ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_SENSOR = 3u;
  static constexpr uint8_t
      ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_ERROR_MODEL_NONE = 0u;

  // pointer types
  using RawPtr = aspn23_ros_interfaces::msg::MeasurementDirectionOfMotion3D_<
      ContainerAllocator> *;
  using ConstRawPtr =
      const aspn23_ros_interfaces::msg::MeasurementDirectionOfMotion3D_<
          ContainerAllocator> *;
  using SharedPtr =
      std::shared_ptr<aspn23_ros_interfaces::msg::
                          MeasurementDirectionOfMotion3D_<ContainerAllocator>>;
  using ConstSharedPtr = std::shared_ptr<
      aspn23_ros_interfaces::msg::MeasurementDirectionOfMotion3D_<
  ...
  using WeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::MeasurementDirectionOfMotion3D_<
          ContainerAllocator>>;
  using ConstWeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::MeasurementDirectionOfMotion3D_<
          ContainerAllocator> const>;
  ...
  // properly
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D
      std::shared_ptr<aspn23_ros_interfaces::msg::
                          MeasurementDirectionOfMotion3D_<ContainerAllocator>>
          Ptr;
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D
  ...
  bool operator==(const MeasurementDirectionOfMotion3D_ &other) const {
    ...
    if (this->error_vector != other.error_vector) {
      return false;
    }
...
}; // struct MeasurementDirectionOfMotion3D_

// alias to use template instance with default allocator
using MeasurementDirectionOfMotion3D =
    aspn23_ros_interfaces::msg::MeasurementDirectionOfMotion3D_<
        std::allocator<void>>;
...
constexpr uint8_t MeasurementDirectionOfMotion3D_<ContainerAllocator>::
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DIRECTION_OF_MOTION3_D__STRUCT_HPP_
