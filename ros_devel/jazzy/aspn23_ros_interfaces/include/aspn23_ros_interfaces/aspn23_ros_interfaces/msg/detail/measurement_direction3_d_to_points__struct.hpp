...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DIRECTION3_D_TO_POINTS__STRUCT_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DIRECTION3_D_TO_POINTS__STRUCT_HPP_
...
#ifndef _WIN32
#define DEPRECATED__aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints \
...
// message struct
template <class ContainerAllocator> struct MeasurementDirection3DToPoints_ {
  using Type = MeasurementDirection3DToPoints_<ContainerAllocator>;

  explicit MeasurementDirection3DToPoints_(
  ...
  // pointer types
  using RawPtr = aspn23_ros_interfaces::msg::MeasurementDirection3DToPoints_<
      ContainerAllocator> *;
  using ConstRawPtr =
      const aspn23_ros_interfaces::msg::MeasurementDirection3DToPoints_<
          ContainerAllocator> *;
  using SharedPtr =
      std::shared_ptr<aspn23_ros_interfaces::msg::
                          MeasurementDirection3DToPoints_<ContainerAllocator>>;
  using ConstSharedPtr = std::shared_ptr<
      aspn23_ros_interfaces::msg::MeasurementDirection3DToPoints_<
  ...
  using WeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::MeasurementDirection3DToPoints_<
          ContainerAllocator>>;
  using ConstWeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::MeasurementDirection3DToPoints_<
          ContainerAllocator> const>;
  ...
  // properly
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints
      std::shared_ptr<aspn23_ros_interfaces::msg::
                          MeasurementDirection3DToPoints_<ContainerAllocator>>
          Ptr;
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementDirection3DToPoints
  ...
  bool operator==(const MeasurementDirection3DToPoints_ &other) const {
...
}; // struct MeasurementDirection3DToPoints_

// alias to use template instance with default allocator
using MeasurementDirection3DToPoints =
    aspn23_ros_interfaces::msg::MeasurementDirection3DToPoints_<
        std::allocator<void>>;
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DIRECTION3_D_TO_POINTS__STRUCT_HPP_
