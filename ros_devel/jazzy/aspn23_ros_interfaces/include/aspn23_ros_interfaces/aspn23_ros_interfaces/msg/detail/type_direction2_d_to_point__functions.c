...
bool aspn23_ros_interfaces__msg__TypeDirection2DToPoint__init(
  ...
  if (!aspn23_ros_interfaces__msg__TypeRemotePoint__init(&msg->remote_point)) {
    aspn23_ros_interfaces__msg__TypeDirection2DToPoint__fini(msg);
    return false;
  }
  // reference
  // obs
...
void aspn23_ros_interfaces__msg__TypeDirection2DToPoint__fini(
    aspn23_ros_interfaces__msg__TypeDirection2DToPoint *msg) {
  if (!msg) {
    return;
  }
...
bool aspn23_ros_interfaces__msg__TypeDirection2DToPoint__are_equal(
...
bool aspn23_ros_interfaces__msg__TypeDirection2DToPoint__copy(
...
aspn23_ros_interfaces__msg__TypeDirection2DToPoint__create(void) {
  ...
  aspn23_ros_interfaces__msg__TypeDirection2DToPoint *msg =
      (aspn23_ros_interfaces__msg__TypeDirection2DToPoint *)allocator.allocate(
          sizeof(aspn23_ros_interfaces__msg__TypeDirection2DToPoint),
          allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(aspn23_ros_interfaces__msg__TypeDirection2DToPoint));
  bool success = aspn23_ros_interfaces__msg__TypeDirection2DToPoint__init(msg);
  if (!success) {
...
void aspn23_ros_interfaces__msg__TypeDirection2DToPoint__destroy(
    aspn23_ros_interfaces__msg__TypeDirection2DToPoint *msg) {
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    aspn23_ros_interfaces__msg__TypeDirection2DToPoint__fini(msg);
...
bool aspn23_ros_interfaces__msg__TypeDirection2DToPoint__Sequence__init(
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aspn23_ros_interfaces__msg__TypeDirection2DToPoint *data = NULL;

  if (size) {
    data = (aspn23_ros_interfaces__msg__TypeDirection2DToPoint *)
    ...
    for (i = 0; i < size; ++i) {
      bool success =
          aspn23_ros_interfaces__msg__TypeDirection2DToPoint__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      // elements
      for (; i > 0; --i) {
        aspn23_ros_interfaces__msg__TypeDirection2DToPoint__fini(&data[i - 1]);
      }
...
void aspn23_ros_interfaces__msg__TypeDirection2DToPoint__Sequence__fini(
    aspn23_ros_interfaces__msg__TypeDirection2DToPoint__Sequence *array) {
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      aspn23_ros_interfaces__msg__TypeDirection2DToPoint__fini(&array->data[i]);
    }
...
aspn23_ros_interfaces__msg__TypeDirection2DToPoint__Sequence__create(
  ...
  bool success =
      aspn23_ros_interfaces__msg__TypeDirection2DToPoint__Sequence__init(array,
                                                                         size);
  if (!success) {
...
void aspn23_ros_interfaces__msg__TypeDirection2DToPoint__Sequence__destroy(
    aspn23_ros_interfaces__msg__TypeDirection2DToPoint__Sequence *array) {
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    aspn23_ros_interfaces__msg__TypeDirection2DToPoint__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool aspn23_ros_interfaces__msg__TypeDirection2DToPoint__Sequence__are_equal(
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!aspn23_ros_interfaces__msg__TypeDirection2DToPoint__are_equal(
...
bool aspn23_ros_interfaces__msg__TypeDirection2DToPoint__Sequence__copy(
  ...
  if (output->capacity < input->size) {
    ...
    aspn23_ros_interfaces__msg__TypeDirection2DToPoint *data =
        (aspn23_ros_interfaces__msg__TypeDirection2DToPoint *)allocator
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!aspn23_ros_interfaces__msg__TypeDirection2DToPoint__init(
              &output->data[i])) {
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!aspn23_ros_interfaces__msg__TypeDirection2DToPoint__copy(
