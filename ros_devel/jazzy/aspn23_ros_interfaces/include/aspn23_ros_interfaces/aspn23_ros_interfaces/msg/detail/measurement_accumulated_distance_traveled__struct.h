...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_ACCUMULATED_DISTANCE_TRAVELED__STRUCT_H_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_ACCUMULATED_DISTANCE_TRAVELED__STRUCT_H_
 ...
 */
enum {
  aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__ASPN23_MEASUREMENT_ACCUMULATED_DISTANCE_TRAVELED_ERROR_MODEL_NONE =
      0
};
...
/// Struct defined in msg/MeasurementAccumulatedDistanceTraveled in the package
...
typedef struct
  ...
  /// instead Accumulated distance traveled over the time period from
  /// (time_of_validity - delta_t) to time_of_validity. For example, a sensor
  /// that travels (over the observation time period) in one direction 1m and
  /// reverses course to travel 1m back (and ends at its starting position)
  /// would have an accumulated distance traveled of 2m. Sensor examples may
  /// include an odometer or a wheel encoder. Description: Standard ASPN
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_ACCUMULATED_DISTANCE_TRAVELED__STRUCT_H_
