...
aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion2D__get_type_hash(
  ...
  static rosidl_type_hash_t hash = {
      1,
      {
          0x18, 0xd9, 0x77, 0x30, 0x22, 0xea, 0xff, 0x40, 0xa3, 0xe4, 0x7b,
          0x94, 0x54, 0x08, 0xc9, 0x31, 0x8a, 0xc6, 0xb9, 0x5b, 0x79, 0x1f,
          0x89, 0x65, 0x82, 0x10, 0xc8, 0x97, 0x94, 0xeb, 0xb5, 0x01,
      }};
  return &hash;
}
...
static char
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion2D__TYPE_NAME[] =
...
static char
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion2D__FIELD_NAME__header
        [] = "header";
static char
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion2D__FIELD_NAME__time_of_validity
        [] = "time_of_validity";
static char
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion2D__FIELD_NAME__reference
        [] = "reference";
static char
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion2D__FIELD_NAME__obs
        [] = "obs";
static char
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion2D__FIELD_NAME__variance
        [] = "variance";
static char
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion2D__FIELD_NAME__error_model
        [] = "error_model";
static char
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion2D__FIELD_NAME__num_error_model_params
        [] = "num_error_model_params";
static char
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion2D__FIELD_NAME__error_model_params
        [] = "error_model_params";
static char
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion2D__FIELD_NAME__num_integrity
        [] = "num_integrity";
static char
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion2D__FIELD_NAME__integrity
        [] = "integrity";

static rosidl_runtime_c__type_description__Field
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion2D__FIELDS[] = {
        {
            {aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion2D__FIELD_NAME__header,
             6, 6},
            {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion2D__REFERENCED_TYPE_DESCRIPTIONS
        [] = {
            {
                {aspn23_ros_interfaces__msg__TypeHeader__TYPE_NAME, 36, 36},
                {NULL, 0, 0},
...
static char toplevel_type_raw_source[] =
    ...
    "repo instead\n"
    "\n"
    "# Direction of motion represented in a two-dimensional reference frame as "
    "defined by the enum.\n"
    "\n"
    ...
    "uint8 reference\n"
    "\n"
    "# Direction of motion expressed in the two-dimensional North-East plane "
    "of the locally level NED frame\n"
    "# as the angle between the N-axis and the direction of motion. Positive "
    "angle is defined as a rotation\n"
    "# towards the E-axis. See also NED coordinate frame definition for N, E, "
    "and D definitions.\n"
    "uint8 ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_NE=0\n"
    "\n"
    "# Direction of motion expressed in the two-dimensional North-Down plane "
    "of the locally level NED frame\n"
    "# as the angle between the N-axis and the direction of motion. Positive "
    "angle is defined as a rotation\n"
    "# towards the D-axis. See also NED coordinate frame definition for N, E, "
    "and D definitions.\n"
    "uint8 ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_ND=1\n"
    "\n"
    "# Direction of motion expressed in the two-dimensional East-Down plane of "
    "the locally level NED frame\n"
    "# as the angle between the E-axis and the direction of motion. Positive "
    "angle is defined as a rotation\n"
    "# towards the D-axis. See also NED coordinate frame definition for N, E, "
    "and D definitions.\n"
    "uint8 ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_ED=2\n"
    "\n"
    "# Direction of motion expressed in the sensor frame as the angle between "
    "the sensor frame x-axis and\n"
    "# the direction of motion. Positive angle is defined as a rotation "
    "towards the sensor frame y-axis.\n"
    "# (Sensor frame is two dimensional, x and y, as defined in mounting.)\n"
    "uint8 ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_REFERENCE_SENSOR=3\n"
    "\n"
    ...
    "uint8 ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_2D_ERROR_MODEL_NONE=0\n"
    "\n"
...
aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion2D__get_individual_type_description_source(
  ...
  static const rosidl_runtime_c__type_description__TypeSource source = {
      {aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion2D__TYPE_NAME,
       56, 56},
      {msg_encoding, 3, 3},
      {toplevel_type_raw_source, 3045, 3045},
  };
  return &source;
}
