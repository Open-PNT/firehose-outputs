...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_RANGE_RATE_TO_POINT__TRAITS_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_RANGE_RATE_TO_POINT__TRAITS_HPP_
...
inline void to_flow_style_yaml(const MeasurementRangeRateToPoint &msg,
                               std::ostream &out) {
  out << "{";
  // member: header
  {
...
inline void to_block_style_yaml(const MeasurementRangeRateToPoint &msg,
...
inline std::string to_yaml(const MeasurementRangeRateToPoint &msg,
...
inline void
to_yaml(const aspn23_ros_interfaces::msg::MeasurementRangeRateToPoint &msg,
        std::ostream &out, size_t indentation = 0) {
...
template <>
inline const char *
data_type<aspn23_ros_interfaces::msg::MeasurementRangeRateToPoint>() {
  return "aspn23_ros_interfaces::msg::MeasurementRangeRateToPoint";
}

template <>
inline const char *
name<aspn23_ros_interfaces::msg::MeasurementRangeRateToPoint>() {
  return "aspn23_ros_interfaces/msg/MeasurementRangeRateToPoint";
}

template <>
struct has_fixed_size<aspn23_ros_interfaces::msg::MeasurementRangeRateToPoint>
    : std::integral_constant<bool, false> {};

template <>
struct has_bounded_size<aspn23_ros_interfaces::msg::MeasurementRangeRateToPoint>
    : std::integral_constant<bool, false> {};

template <>
struct is_message<aspn23_ros_interfaces::msg::MeasurementRangeRateToPoint>
    : std::true_type {};

} // namespace rosidl_generator_traits

#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_RANGE_RATE_TO_POINT__TRAITS_HPP_
