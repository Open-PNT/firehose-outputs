...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_FREQUENCY_DIFFERENCE__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_FREQUENCY_DIFFERENCE__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_HPP_
...
cdr_serialize(const aspn23_ros_interfaces::msg::MeasurementFrequencyDifference
                  &ros_message,
...
cdr_deserialize(
    eprosima::fastcdr::Cdr &cdr,
    aspn23_ros_interfaces::msg::MeasurementFrequencyDifference &ros_message);

size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_aspn23_ros_interfaces
get_serialized_size(
    const aspn23_ros_interfaces::msg::MeasurementFrequencyDifference
        &ros_message,
    size_t current_alignment);

size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_aspn23_ros_interfaces
max_serialized_size_MeasurementFrequencyDifference(bool &full_bounded,
                                                   bool &is_plain,
                                                   size_t current_alignment);
...
size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_aspn23_ros_interfaces
max_serialized_size_key_MeasurementFrequencyDifference(
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_FREQUENCY_DIFFERENCE__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_HPP_
