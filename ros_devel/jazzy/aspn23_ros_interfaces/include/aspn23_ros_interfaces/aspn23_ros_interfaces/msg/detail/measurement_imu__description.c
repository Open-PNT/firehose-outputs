...
aspn23_ros_interfaces__msg__MeasurementImu__get_type_hash(
  ...
  static rosidl_type_hash_t hash = {
      1,
      {
          0xac, 0x9e, 0x35, 0xd9, 0xf3, 0xc7, 0x18, 0x83, 0xb7, 0x8e, 0x6b,
          0xc6, 0x21, 0x84, 0xce, 0x62, 0x5b, 0x72, 0x71, 0x6b, 0x19, 0xa5,
          0xb8, 0xb3, 0x37, 0x65, 0x7b, 0xdd, 0x66, 0x9a, 0x3f, 0xdf,
      }};
  return &hash;
}
...
static char aspn23_ros_interfaces__msg__MeasurementImu__TYPE_NAME[] =
...
static char aspn23_ros_interfaces__msg__MeasurementImu__FIELD_NAME__header[] =
    "header";
static char
    aspn23_ros_interfaces__msg__MeasurementImu__FIELD_NAME__time_of_validity[] =
        "time_of_validity";
static char aspn23_ros_interfaces__msg__MeasurementImu__FIELD_NAME__imu_type[] =
    "imu_type";
static char
    aspn23_ros_interfaces__msg__MeasurementImu__FIELD_NAME__meas_accel[] =
        "meas_accel";
static char
    aspn23_ros_interfaces__msg__MeasurementImu__FIELD_NAME__meas_gyro[] =
        "meas_gyro";
static char
    aspn23_ros_interfaces__msg__MeasurementImu__FIELD_NAME__num_integrity[] =
        "num_integrity";
static char
    aspn23_ros_interfaces__msg__MeasurementImu__FIELD_NAME__integrity[] =
        "integrity";

static rosidl_runtime_c__type_description__Field
    aspn23_ros_interfaces__msg__MeasurementImu__FIELDS[] = {
        {
            {aspn23_ros_interfaces__msg__MeasurementImu__FIELD_NAME__header, 6,
             6},
            {
        ...
        {
            {aspn23_ros_interfaces__msg__MeasurementImu__FIELD_NAME__imu_type,
             8, 8},
            {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription
    aspn23_ros_interfaces__msg__MeasurementImu__REFERENCED_TYPE_DESCRIPTIONS[] =
        {
            {
                {aspn23_ros_interfaces__msg__TypeHeader__TYPE_NAME, 36, 36},
                {NULL, 0, 0},
...
aspn23_ros_interfaces__msg__MeasurementImu__get_type_description(
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
      {
          {aspn23_ros_interfaces__msg__MeasurementImu__TYPE_NAME, 40, 40},
          {aspn23_ros_interfaces__msg__MeasurementImu__FIELDS, 7, 7},
      },
      {aspn23_ros_interfaces__msg__MeasurementImu__REFERENCED_TYPE_DESCRIPTIONS,
       3, 3},
  };
...
static char toplevel_type_raw_source[] =
    ...
    "repo instead\n"
    "\n"
    "# Inertial Measurement Unit (IMU) measurements from the device's three "
    "axis accelerometers and three\n"
    "# axis gyroscopes.\n"
    "\n"
    ...
    "uint8 imu_type\n"
    "\n"
    "# delta velocity and delta rotation measurements from the device's three "
    "axis accelerometers and three\n"
    "# axis gyroscopes. Specific force integrated over last measurement period "
    "expressed as delta_v array\n"
    "# in m/s. Angular rate integrated over last measurement period expressed "
    "as delta_theta array in\n"
    "# radians. Time of validity is the end of integration period. Integration "
    "period is from previous\n"
    "# measurement to the current measurement.\n"
    "uint8 ASPN23_MEASUREMENT_IMU_IMU_TYPE_INTEGRATED=0\n"
    "\n"
    "# sampled specific force and rotation rates from the device's three axis "
    "accelerometers and three axis\n"
    "# gyroscopes. Specific force is sampled expressed as an array in m/s/s. "
    "Angular rate is sampled and\n"
    "# expressed as an array in rad/s.\n"
    "uint8 ASPN23_MEASUREMENT_IMU_IMU_TYPE_SAMPLED=1\n"
    "\n"
    ...
    "\n"
    "# Description: Gyroscope measurements in 3 axes per enumerated "
    "definition.\n"
    "# Units: various\n"
    "float64[3] meas_gyro\n"
    "\n"
...
aspn23_ros_interfaces__msg__MeasurementImu__get_individual_type_description_source(
  ...
  static const rosidl_runtime_c__type_description__TypeSource source = {
      {aspn23_ros_interfaces__msg__MeasurementImu__TYPE_NAME, 40, 40},
      {msg_encoding, 3, 3},
      {toplevel_type_raw_source, 1937, 1937},
  };
  return &source;
}
