...
// IWYU pragma: private, include "aspn23_ros_interfaces/msg/measurement_barometer.hpp"

#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_BAROMETER__STRUCT_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_BAROMETER__STRUCT_HPP_
...
#ifndef _WIN32
#define DEPRECATED__aspn23_ros_interfaces__msg__MeasurementBarometer           \
...
// message struct
template <class ContainerAllocator> struct MeasurementBarometer_ {
  using Type = MeasurementBarometer_<ContainerAllocator>;

  explicit MeasurementBarometer_(
  ...
  Type &set__pressure(const double &_arg) {
    this->pressure = _arg;
    return *this;
  }
  ...
  static constexpr uint8_t ASPN23_MEASUREMENT_BAROMETER_ERROR_MODEL_NONE = 0u;

  // pointer types
  using RawPtr =
      aspn23_ros_interfaces::msg::MeasurementBarometer_<ContainerAllocator> *;
  using ConstRawPtr = const aspn23_ros_interfaces::msg::MeasurementBarometer_<
      ContainerAllocator> *;
  using SharedPtr = std::shared_ptr<
      aspn23_ros_interfaces::msg::MeasurementBarometer_<ContainerAllocator>>;
  using ConstSharedPtr =
      std::shared_ptr<aspn23_ros_interfaces::msg::MeasurementBarometer_<
          ContainerAllocator> const>;

  template <typename Deleter = std::default_delete<
                aspn23_ros_interfaces::msg::MeasurementBarometer_<
                    ContainerAllocator>>>
  ...
  using ConstUniquePtrWithDeleter =
      std::unique_ptr<aspn23_ros_interfaces::msg::MeasurementBarometer_<
                          ContainerAllocator> const,
                      Deleter>;
  ...
  using WeakPtr = std::weak_ptr<
      aspn23_ros_interfaces::msg::MeasurementBarometer_<ContainerAllocator>>;
  using ConstWeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::MeasurementBarometer_<
          ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes
  // properly
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementBarometer
      std::shared_ptr<
          aspn23_ros_interfaces::msg::MeasurementBarometer_<ContainerAllocator>>
          Ptr;
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementBarometer
  ...
  bool operator==(const MeasurementBarometer_ &other) const {
...
}; // struct MeasurementBarometer_

// alias to use template instance with default allocator
using MeasurementBarometer =
    aspn23_ros_interfaces::msg::MeasurementBarometer_<std::allocator<void>>;
...
constexpr uint8_t MeasurementBarometer_<
    ContainerAllocator>::ASPN23_MEASUREMENT_BAROMETER_ERROR_MODEL_NONE;
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_BAROMETER__STRUCT_HPP_
