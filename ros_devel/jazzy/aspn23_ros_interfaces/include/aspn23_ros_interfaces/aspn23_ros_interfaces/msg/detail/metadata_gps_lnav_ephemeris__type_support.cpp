...
// input from aspn23_ros_interfaces:msg/MetadataGpsLnavEphemeris.idl generated
...
void MetadataGpsLnavEphemeris_init_function(
    void *message_memory, rosidl_runtime_cpp::MessageInitialization _init) {
  new (message_memory)
      aspn23_ros_interfaces::msg::MetadataGpsLnavEphemeris(_init);
}

void MetadataGpsLnavEphemeris_fini_function(void *message_memory) {
  auto typed_message =
      static_cast<aspn23_ros_interfaces::msg::MetadataGpsLnavEphemeris *>(
          message_memory);
  typed_message->~MetadataGpsLnavEphemeris();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember
    MetadataGpsLnavEphemeris_message_member_array[9] = {
        {
            "info",                                                   // name
            ...
            offsetof(aspn23_ros_interfaces::msg::MetadataGpsLnavEphemeris,
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers
    MetadataGpsLnavEphemeris_message_members = {
        "aspn23_ros_interfaces::msg", // message namespace
        "MetadataGpsLnavEphemeris",   // message name
        9,                            // number of fields
        sizeof(aspn23_ros_interfaces::msg::MetadataGpsLnavEphemeris),
        false,                                         // has_any_key_member_
        MetadataGpsLnavEphemeris_message_member_array, // message members
        MetadataGpsLnavEphemeris_init_function,        // function to initialize
                                                // message memory (memory has to
                                                // be allocated)
        MetadataGpsLnavEphemeris_fini_function // function to terminate message
                                               // instance (will not free
                                               // memory)
};

static const rosidl_message_type_support_t
    MetadataGpsLnavEphemeris_message_type_support_handle = {
