...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_SATNAV_WITH_SV_DATA__STRUCT_H_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_SATNAV_WITH_SV_DATA__STRUCT_H_
...
/// Struct defined in msg/MeasurementSatnavWithSvData in the package
/// aspn23_ros_interfaces.
typedef struct aspn23_ros_interfaces__msg__MeasurementSatnavWithSvData {
  ...
  /// Description: Array of satellite position, velocity, and clock information.
  /// These line up precisely with the obs, such that sv_data[N] is the
  /// satellite information for observations obs[N] for any valid N. Units: none
  /// Note: array length is num_signals_tracked
  aspn23_ros_interfaces__msg__TypeSatnavSvData__Sequence sv_data;
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_SATNAV_WITH_SV_DATA__STRUCT_H_
