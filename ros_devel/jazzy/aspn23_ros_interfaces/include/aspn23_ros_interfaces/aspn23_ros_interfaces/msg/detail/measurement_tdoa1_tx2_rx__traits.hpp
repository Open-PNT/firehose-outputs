...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_TDOA1_TX2_RX__TRAITS_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_TDOA1_TX2_RX__TRAITS_HPP_
...
inline void to_flow_style_yaml(const MeasurementTdoa1Tx2Rx &msg,
                               std::ostream &out) {
  out << "{";
  // member: header
  {
  ...
  // member: tx_position_and_covariance
  {
    out << "tx_position_and_covariance: ";
    to_flow_style_yaml(msg.tx_position_and_covariance, out);
    out << ", ";
  }

  // member: rx1_position_and_covariance
  {
    out << "rx1_position_and_covariance: ";
    to_flow_style_yaml(msg.rx1_position_and_covariance, out);
    out << ", ";
  }
...
inline void to_block_style_yaml(const MeasurementTdoa1Tx2Rx &msg,
  ...
  // member: tx_position_and_covariance
  {
    ...
    out << "tx_position_and_covariance:\n";
    to_block_style_yaml(msg.tx_position_and_covariance, out, indentation + 2);
  }
  ...
  // member: rx1_position_and_covariance
  {
    ...
    out << "rx1_position_and_covariance:\n";
    to_block_style_yaml(msg.rx1_position_and_covariance, out, indentation + 2);
  }
...
inline std::string to_yaml(const MeasurementTdoa1Tx2Rx &msg,
...
inline void
to_yaml(const aspn23_ros_interfaces::msg::MeasurementTdoa1Tx2Rx &msg,
        std::ostream &out, size_t indentation = 0) {
...
template <>
inline const char *
data_type<aspn23_ros_interfaces::msg::MeasurementTdoa1Tx2Rx>() {
  return "aspn23_ros_interfaces::msg::MeasurementTdoa1Tx2Rx";
}

template <>
inline const char *name<aspn23_ros_interfaces::msg::MeasurementTdoa1Tx2Rx>() {
  return "aspn23_ros_interfaces/msg/MeasurementTdoa1Tx2Rx";
}

template <>
struct has_fixed_size<aspn23_ros_interfaces::msg::MeasurementTdoa1Tx2Rx>
    : std::integral_constant<bool, false> {};

template <>
struct has_bounded_size<aspn23_ros_interfaces::msg::MeasurementTdoa1Tx2Rx>
    : std::integral_constant<bool, false> {};

template <>
struct is_message<aspn23_ros_interfaces::msg::MeasurementTdoa1Tx2Rx>
    : std::true_type {};

} // namespace rosidl_generator_traits

#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_TDOA1_TX2_RX__TRAITS_HPP_
