...
// IWYU pragma: private, include "aspn23_ros_interfaces/msg/type_direction3_d_to_point.hpp"

#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__TYPE_DIRECTION3_D_TO_POINT__TRAITS_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__TYPE_DIRECTION3_D_TO_POINT__TRAITS_HPP_
...
#include "aspn23_ros_interfaces/msg/detail/type_image_feature__traits.hpp"
// Member 'integrity'
...
inline void to_flow_style_yaml(const TypeDirection3DToPoint &msg,
                               std::ostream &out) {
  out << "{";
  // member: remote_point
  {
  ...
  // member: has_observation_characteristics
  {
    out << "has_observation_characteristics: ";
    rosidl_generator_traits::value_to_yaml(msg.has_observation_characteristics,
                                           out);
    out << ", ";
  }
  ...
  // member: observation_characteristics
  {
    out << "observation_characteristics: ";
    to_flow_style_yaml(msg.observation_characteristics, out);
    out << ", ";
  }
...
inline void to_block_style_yaml(const TypeDirection3DToPoint &msg,
  ...
  // member: observation_characteristics
  {
    ...
    out << "observation_characteristics:\n";
    to_block_style_yaml(msg.observation_characteristics, out, indentation + 2);
  }
...
inline std::string to_yaml(const TypeDirection3DToPoint &msg,
...
inline void
to_yaml(const aspn23_ros_interfaces::msg::TypeDirection3DToPoint &msg,
        std::ostream &out, size_t indentation = 0) {
...
template <>
inline const char *
data_type<aspn23_ros_interfaces::msg::TypeDirection3DToPoint>() {
  return "aspn23_ros_interfaces::msg::TypeDirection3DToPoint";
}

template <>
inline const char *name<aspn23_ros_interfaces::msg::TypeDirection3DToPoint>() {
  return "aspn23_ros_interfaces/msg/TypeDirection3DToPoint";
}

template <>
struct has_fixed_size<aspn23_ros_interfaces::msg::TypeDirection3DToPoint>
    : std::integral_constant<bool, false> {};

template <>
struct has_bounded_size<aspn23_ros_interfaces::msg::TypeDirection3DToPoint>
    : std::integral_constant<bool, false> {};

template <>
struct is_message<aspn23_ros_interfaces::msg::TypeDirection3DToPoint>
    : std::true_type {};

} // namespace rosidl_generator_traits

#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__TYPE_DIRECTION3_D_TO_POINT__TRAITS_HPP_
