...
// IWYU pragma: private, include "aspn23_ros_interfaces/msg/measurement_attitude2_d.hpp"

#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_ATTITUDE2_D__TRAITS_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_ATTITUDE2_D__TRAITS_HPP_
...
inline void to_flow_style_yaml(const MeasurementAttitude2D &msg,
                               std::ostream &out) {
  out << "{";
  // member: header
  {
  ...
  // member: attitude2d
  {
    if (msg.attitude2d.size() == 0) {
      out << "attitude2d: []";
    } else {
      out << "attitude2d: [";
      size_t pending_items = msg.attitude2d.size();
      for (auto item : msg.attitude2d) {
...
inline void to_block_style_yaml(const MeasurementAttitude2D &msg,
...
inline std::string to_yaml(const MeasurementAttitude2D &msg,
...
inline void
to_yaml(const aspn23_ros_interfaces::msg::MeasurementAttitude2D &msg,
        std::ostream &out, size_t indentation = 0) {
...
template <>
inline const char *
data_type<aspn23_ros_interfaces::msg::MeasurementAttitude2D>() {
  return "aspn23_ros_interfaces::msg::MeasurementAttitude2D";
}

template <>
inline const char *name<aspn23_ros_interfaces::msg::MeasurementAttitude2D>() {
  return "aspn23_ros_interfaces/msg/MeasurementAttitude2D";
}

template <>
struct has_fixed_size<aspn23_ros_interfaces::msg::MeasurementAttitude2D>
    : std::integral_constant<bool, false> {};

template <>
struct has_bounded_size<aspn23_ros_interfaces::msg::MeasurementAttitude2D>
    : std::integral_constant<bool, false> {};

template <>
struct is_message<aspn23_ros_interfaces::msg::MeasurementAttitude2D>
    : std::true_type {};

} // namespace rosidl_generator_traits

#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_ATTITUDE2_D__TRAITS_HPP_
