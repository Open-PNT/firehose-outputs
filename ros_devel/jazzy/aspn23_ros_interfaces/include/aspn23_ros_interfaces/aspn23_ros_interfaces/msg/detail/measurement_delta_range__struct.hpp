...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DELTA_RANGE__STRUCT_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DELTA_RANGE__STRUCT_HPP_
...
#ifndef _WIN32
#define DEPRECATED__aspn23_ros_interfaces__msg__MeasurementDeltaRange          \
...
// message struct
template <class ContainerAllocator> struct MeasurementDeltaRange_ {
  using Type = MeasurementDeltaRange_<ContainerAllocator>;

  explicit MeasurementDeltaRange_(
  ...
  static constexpr uint8_t ASPN23_MEASUREMENT_DELTA_RANGE_ERROR_MODEL_NONE = 0u;

  // pointer types
  using RawPtr =
      aspn23_ros_interfaces::msg::MeasurementDeltaRange_<ContainerAllocator> *;
  using ConstRawPtr = const aspn23_ros_interfaces::msg::MeasurementDeltaRange_<
      ContainerAllocator> *;
  using SharedPtr = std::shared_ptr<
      aspn23_ros_interfaces::msg::MeasurementDeltaRange_<ContainerAllocator>>;
  using ConstSharedPtr =
      std::shared_ptr<aspn23_ros_interfaces::msg::MeasurementDeltaRange_<
          ContainerAllocator> const>;

  template <typename Deleter = std::default_delete<
                aspn23_ros_interfaces::msg::MeasurementDeltaRange_<
                    ContainerAllocator>>>
  ...
  using ConstUniquePtrWithDeleter =
      std::unique_ptr<aspn23_ros_interfaces::msg::MeasurementDeltaRange_<
                          ContainerAllocator> const,
                      Deleter>;
  ...
  using WeakPtr = std::weak_ptr<
      aspn23_ros_interfaces::msg::MeasurementDeltaRange_<ContainerAllocator>>;
  using ConstWeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::MeasurementDeltaRange_<
          ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes
  // properly
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementDeltaRange
      std::shared_ptr<aspn23_ros_interfaces::msg::MeasurementDeltaRange_<
          ContainerAllocator>>
          Ptr;
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementDeltaRange
  ...
  bool operator==(const MeasurementDeltaRange_ &other) const {
...
}; // struct MeasurementDeltaRange_

// alias to use template instance with default allocator
using MeasurementDeltaRange =
    aspn23_ros_interfaces::msg::MeasurementDeltaRange_<std::allocator<void>>;
...
constexpr uint8_t MeasurementDeltaRange_<
    ContainerAllocator>::ASPN23_MEASUREMENT_DELTA_RANGE_ERROR_MODEL_NONE;
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DELTA_RANGE__STRUCT_HPP_
