...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DELTA_RANGE__STRUCT_H_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DELTA_RANGE__STRUCT_H_
...
/// Constant 'ASPN23_MEASUREMENT_DELTA_RANGE_ERROR_MODEL_NONE'.
/**
 * No additional error model provided (num_error_model_params = 0).
 */
enum {
  aspn23_ros_interfaces__msg__MeasurementDeltaRange__ASPN23_MEASUREMENT_DELTA_RANGE_ERROR_MODEL_NONE =
      0
};
...
/// Struct defined in msg/MeasurementDeltaRange in the package
/// aspn23_ros_interfaces.
typedef struct aspn23_ros_interfaces__msg__MeasurementDeltaRange {
  /// This code is generated via firehose.
  /// DO NOT hand edit code.  Make any changes required using the firehose repo
  /// instead Delta range is the distance between the sensor position at
  /// time_of_validity and the sensor position at time_of_validity - delta_t.
...
// Struct for a sequence of aspn23_ros_interfaces__msg__MeasurementDeltaRange.
typedef struct aspn23_ros_interfaces__msg__MeasurementDeltaRange__Sequence {
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DELTA_RANGE__STRUCT_H_
