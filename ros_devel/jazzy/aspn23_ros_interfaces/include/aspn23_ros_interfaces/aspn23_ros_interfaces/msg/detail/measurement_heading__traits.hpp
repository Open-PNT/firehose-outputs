...
// IWYU pragma: private, include "aspn23_ros_interfaces/msg/measurement_heading.hpp"

#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_HEADING__TRAITS_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_HEADING__TRAITS_HPP_
...
inline void to_flow_style_yaml(const MeasurementHeading &msg,
                               std::ostream &out) {
  out << "{";
  // member: header
  {
...
inline void to_block_style_yaml(const MeasurementHeading &msg,
...
inline std::string to_yaml(const MeasurementHeading &msg,
...
inline void to_yaml(const aspn23_ros_interfaces::msg::MeasurementHeading &msg,
                    std::ostream &out, size_t indentation = 0) {
...
inline std::string
to_yaml(const aspn23_ros_interfaces::msg::MeasurementHeading &msg) {
  return aspn23_ros_interfaces::msg::to_yaml(msg);
}

template <>
inline const char *data_type<aspn23_ros_interfaces::msg::MeasurementHeading>() {
  return "aspn23_ros_interfaces::msg::MeasurementHeading";
}

template <>
inline const char *name<aspn23_ros_interfaces::msg::MeasurementHeading>() {
  return "aspn23_ros_interfaces/msg/MeasurementHeading";
}

template <>
struct has_fixed_size<aspn23_ros_interfaces::msg::MeasurementHeading>
    : std::integral_constant<bool, false> {};

template <>
struct has_bounded_size<aspn23_ros_interfaces::msg::MeasurementHeading>
    : std::integral_constant<bool, false> {};

template <>
struct is_message<aspn23_ros_interfaces::msg::MeasurementHeading>
    : std::true_type {};

} // namespace rosidl_generator_traits

#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_HEADING__TRAITS_HPP_
