...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_ACCUMULATED_DISTANCE_TRAVELED__TRAITS_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_ACCUMULATED_DISTANCE_TRAVELED__TRAITS_HPP_
...
inline void
to_flow_style_yaml(const MeasurementAccumulatedDistanceTraveled &msg,
                   std::ostream &out) {
  out << "{";
  // member: header
  {
...
inline void
to_block_style_yaml(const MeasurementAccumulatedDistanceTraveled &msg,
...
inline std::string to_yaml(const MeasurementAccumulatedDistanceTraveled &msg,
...
inline void
to_yaml(const aspn23_ros_interfaces::msg::MeasurementAccumulatedDistanceTraveled
            &msg,
        std::ostream &out, size_t indentation = 0) {
...
inline const char *data_type<
  ...
  return "aspn23_ros_interfaces::msg::MeasurementAccumulatedDistanceTraveled";
}

template <>
inline const char *
name<aspn23_ros_interfaces::msg::MeasurementAccumulatedDistanceTraveled>() {
  return "aspn23_ros_interfaces/msg/MeasurementAccumulatedDistanceTraveled";
}
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_ACCUMULATED_DISTANCE_TRAVELED__TRAITS_HPP_
