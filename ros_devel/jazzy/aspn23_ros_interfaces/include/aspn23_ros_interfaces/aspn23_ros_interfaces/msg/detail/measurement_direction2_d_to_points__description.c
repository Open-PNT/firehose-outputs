...
aspn23_ros_interfaces__msg__MeasurementDirection2DToPoints__get_type_hash(
  ...
  static rosidl_type_hash_t hash = {
      1,
      {
          0xe8, 0xa9, 0x2e, 0xee, 0x88, 0x9d, 0x22, 0x94, 0xbc, 0x9d, 0x6b,
          0x07, 0xd8, 0x07, 0x34, 0x71, 0xb0, 0x55, 0xf5, 0xfb, 0x60, 0x55,
          0xf8, 0xde, 0x97, 0x36, 0x7f, 0x58, 0xbd, 0xfb, 0x4a, 0x47,
      }};
  return &hash;
}
...
static const rosidl_type_hash_t
    aspn23_ros_interfaces__msg__TypeDirection2DToPoint__EXPECTED_HASH = {
        1,
        {
...
static char
    aspn23_ros_interfaces__msg__MeasurementDirection2DToPoints__TYPE_NAME[] =
...
static char
    aspn23_ros_interfaces__msg__MeasurementDirection2DToPoints__FIELD_NAME__header
        [] = "header";
static char
    aspn23_ros_interfaces__msg__MeasurementDirection2DToPoints__FIELD_NAME__time_of_validity
        [] = "time_of_validity";
static char
    aspn23_ros_interfaces__msg__MeasurementDirection2DToPoints__FIELD_NAME__num_obs
        [] = "num_obs";
static char
    aspn23_ros_interfaces__msg__MeasurementDirection2DToPoints__FIELD_NAME__obs
        [] = "obs";

static rosidl_runtime_c__type_description__Field
    aspn23_ros_interfaces__msg__MeasurementDirection2DToPoints__FIELDS[] = {
        {
            {aspn23_ros_interfaces__msg__MeasurementDirection2DToPoints__FIELD_NAME__header,
             6, 6},
            {
        ...
        },
        {
             ...
             3, 3},
            {
                ...
                0,
                0,
                {aspn23_ros_interfaces__msg__TypeDirection2DToPoint__TYPE_NAME,
                 48, 48},
            },
            {NULL, 0, 0},
        },
...
static rosidl_runtime_c__type_description__IndividualTypeDescription
    aspn23_ros_interfaces__msg__MeasurementDirection2DToPoints__REFERENCED_TYPE_DESCRIPTIONS
        [] = {
            {
                {aspn23_ros_interfaces__msg__TypeDirection2DToPoint__TYPE_NAME,
                 48, 48},
...
aspn23_ros_interfaces__msg__MeasurementDirection2DToPoints__get_individual_type_description_source(
    const rosidl_message_type_support_t *type_support) {
  (void)type_support;
