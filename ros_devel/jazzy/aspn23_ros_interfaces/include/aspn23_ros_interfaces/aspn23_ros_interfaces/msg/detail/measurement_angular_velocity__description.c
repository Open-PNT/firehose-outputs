...
aspn23_ros_interfaces__msg__MeasurementAngularVelocity__get_type_hash(
  ...
  static rosidl_type_hash_t hash = {
      1,
      {
          0xde, 0x46, 0x2b, 0x80, 0x9f, 0x89, 0x31, 0xab, 0x25, 0x3a, 0x67,
          0x69, 0x1a, 0xca, 0xa1, 0x4d, 0xea, 0x58, 0xe8, 0xd2, 0xe9, 0x91,
          0x99, 0x4c, 0x76, 0xb6, 0x2a, 0xab, 0x2e, 0x1e, 0xa9, 0xd5,
      }};
  return &hash;
}
...
static char
    aspn23_ros_interfaces__msg__MeasurementAngularVelocity__TYPE_NAME[] =
...
static char
    aspn23_ros_interfaces__msg__MeasurementAngularVelocity__FIELD_NAME__header
        [] = "header";
static char
    aspn23_ros_interfaces__msg__MeasurementAngularVelocity__FIELD_NAME__time_of_validity
        [] = "time_of_validity";
static char
    aspn23_ros_interfaces__msg__MeasurementAngularVelocity__FIELD_NAME__reference_frame
        [] = "reference_frame";
static char
    aspn23_ros_interfaces__msg__MeasurementAngularVelocity__FIELD_NAME__imu_type
        [] = "imu_type";
static char
    aspn23_ros_interfaces__msg__MeasurementAngularVelocity__FIELD_NAME__meas[] =
        "meas";
static char
    aspn23_ros_interfaces__msg__MeasurementAngularVelocity__FIELD_NAME__covariance
        [] = "covariance";
static char
    aspn23_ros_interfaces__msg__MeasurementAngularVelocity__FIELD_NAME__error_model
        [] = "error_model";
static char
    aspn23_ros_interfaces__msg__MeasurementAngularVelocity__FIELD_NAME__num_error_model_params
        [] = "num_error_model_params";
static char
    aspn23_ros_interfaces__msg__MeasurementAngularVelocity__FIELD_NAME__error_model_params
        [] = "error_model_params";
static char
    aspn23_ros_interfaces__msg__MeasurementAngularVelocity__FIELD_NAME__num_integrity
        [] = "num_integrity";
static char
    aspn23_ros_interfaces__msg__MeasurementAngularVelocity__FIELD_NAME__integrity
        [] = "integrity";

static rosidl_runtime_c__type_description__Field
    aspn23_ros_interfaces__msg__MeasurementAngularVelocity__FIELDS[] = {
        {
            {aspn23_ros_interfaces__msg__MeasurementAngularVelocity__FIELD_NAME__header,
             6, 6},
            {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription
    aspn23_ros_interfaces__msg__MeasurementAngularVelocity__REFERENCED_TYPE_DESCRIPTIONS
        [] = {
            {
                {aspn23_ros_interfaces__msg__TypeHeader__TYPE_NAME, 36, 36},
                {NULL, 0, 0},
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
      {
          {aspn23_ros_interfaces__msg__MeasurementAngularVelocity__TYPE_NAME,
           52, 52},
          {aspn23_ros_interfaces__msg__MeasurementAngularVelocity__FIELDS, 11,
           11},
      },
      {aspn23_ros_interfaces__msg__MeasurementAngularVelocity__REFERENCED_TYPE_DESCRIPTIONS,
       3, 3},
...
static char toplevel_type_raw_source[] =
    ...
    "repo instead\n"
    "\n"
    "# Three dimensional angular velocity relative to and expressed in a "
    ...
    "\n"
    "# Angular velocity with respect to earth-centered inertial frame, "
    "expressed in an earth-centered\n"
    "# inertial frame. See also ECi coordinate frame definition for x, y, and "
    "z definitions.\n"
    "uint8 ASPN23_MEASUREMENT_ANGULAR_VELOCITY_REFERENCE_FRAME_ECI=0\n"
    "\n"
    "# Angular velocity with respect to earth-fixed frame expressed in "
    "earth-centered, earth-fixed\n"
    "# (ECEF) frame. See also ECEF coordinate frame definition for x, y, and z "
    "definitions.\n"
    "uint8 ASPN23_MEASUREMENT_ANGULAR_VELOCITY_REFERENCE_FRAME_ECEF=1\n"
    "\n"
    "# Angular velocity with respect to earth-fixed frame expressed in the "
    "North-East-Down (NED),\n"
    "# local level frame. See also NED coordinate frame definition for N, E, "
    "and D definitions.\n"
    "uint8 ASPN23_MEASUREMENT_ANGULAR_VELOCITY_REFERENCE_FRAME_NED=2\n"
    "\n"
    "# Angular velocity with respect to an inertial frame expressed in sensor "
    "coordinate frame.\n"
    "# Sensor coordinate frame is defined in sensor metadataHeader.\n"
    "uint8 ASPN23_MEASUREMENT_ANGULAR_VELOCITY_REFERENCE_FRAME_SENSOR=3\n"
    "\n"
    "# IMU type\n"
    "uint8 imu_type\n"
    "\n"
    "# delta rotation measurements. Angular rate integrated over last "
    "measurement period expressed in\n"
    "# radians. Time of validity is the end of the integration period. "
    "Integration period is from the\n"
    "# previous measurement to the current measurement.\n"
    "uint8 ASPN23_MEASUREMENT_ANGULAR_VELOCITY_IMU_TYPE_INTEGRATED=0\n"
    "\n"
    "# sampled rotation rates. Angular rate is sampled and expressed in "
    "rad/s.\n"
    "uint8 ASPN23_MEASUREMENT_ANGULAR_VELOCITY_IMU_TYPE_SAMPLED=1\n"
    "\n"
    ...
    "uint8 ASPN23_MEASUREMENT_ANGULAR_VELOCITY_ERROR_MODEL_NONE=0\n"
    "\n"
...
aspn23_ros_interfaces__msg__MeasurementAngularVelocity__get_individual_type_description_source(
    const rosidl_message_type_support_t *type_support) {
  (void)type_support;
  static const rosidl_runtime_c__type_description__TypeSource source = {
      {aspn23_ros_interfaces__msg__MeasurementAngularVelocity__TYPE_NAME, 52,
       52},
      {msg_encoding, 3, 3},
      {toplevel_type_raw_source, 3125, 3125},
  };
  return &source;
}
