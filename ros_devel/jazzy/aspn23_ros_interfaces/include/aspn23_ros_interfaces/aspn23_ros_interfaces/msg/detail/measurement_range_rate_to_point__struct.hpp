...
// IWYU pragma: private, include "aspn23_ros_interfaces/msg/measurement_range_rate_to_point.hpp"

#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_RANGE_RATE_TO_POINT__STRUCT_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_RANGE_RATE_TO_POINT__STRUCT_HPP_
...
#ifndef _WIN32
#define DEPRECATED__aspn23_ros_interfaces__msg__MeasurementRangeRateToPoint    \
...
// message struct
template <class ContainerAllocator> struct MeasurementRangeRateToPoint_ {
  using Type = MeasurementRangeRateToPoint_<ContainerAllocator>;

  explicit MeasurementRangeRateToPoint_(
  ...
  static constexpr uint8_t
      ASPN23_MEASUREMENT_RANGE_RATE_TO_POINT_ERROR_MODEL_NONE = 0u;

  // pointer types
  using RawPtr = aspn23_ros_interfaces::msg::MeasurementRangeRateToPoint_<
      ContainerAllocator> *;
  using ConstRawPtr =
      const aspn23_ros_interfaces::msg::MeasurementRangeRateToPoint_<
          ContainerAllocator> *;
  using SharedPtr =
      std::shared_ptr<aspn23_ros_interfaces::msg::MeasurementRangeRateToPoint_<
          ContainerAllocator>>;
  ...
  template <typename Deleter = std::default_delete<
                aspn23_ros_interfaces::msg::MeasurementRangeRateToPoint_<
                    ContainerAllocator>>>
  using UniquePtrWithDeleter =
      std::unique_ptr<aspn23_ros_interfaces::msg::MeasurementRangeRateToPoint_<
                          ContainerAllocator>,
                      Deleter>;
  ...
  using WeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::MeasurementRangeRateToPoint_<
          ContainerAllocator>>;
  using ConstWeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::MeasurementRangeRateToPoint_<
          ContainerAllocator> const>;
  ...
  // properly
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementRangeRateToPoint
      std::shared_ptr<aspn23_ros_interfaces::msg::MeasurementRangeRateToPoint_<
          ContainerAllocator>>
          Ptr;
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementRangeRateToPoint
  ...
  bool operator==(const MeasurementRangeRateToPoint_ &other) const {
...
}; // struct MeasurementRangeRateToPoint_

// alias to use template instance with default allocator
using MeasurementRangeRateToPoint =
    aspn23_ros_interfaces::msg::MeasurementRangeRateToPoint_<
        std::allocator<void>>;
...
constexpr uint8_t MeasurementRangeRateToPoint_<ContainerAllocator>::
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_RANGE_RATE_TO_POINT__STRUCT_HPP_
