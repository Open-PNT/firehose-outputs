...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_MAGNETIC_FIELD_MAGNITUDE__STRUCT_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_MAGNETIC_FIELD_MAGNITUDE__STRUCT_HPP_
...
#ifndef _WIN32
#define DEPRECATED__aspn23_ros_interfaces__msg__MeasurementMagneticFieldMagnitude \
...
// message struct
template <class ContainerAllocator> struct MeasurementMagneticFieldMagnitude_ {
  using Type = MeasurementMagneticFieldMagnitude_<ContainerAllocator>;

  explicit MeasurementMagneticFieldMagnitude_(
      rosidl_runtime_cpp::MessageInitialization _init =
          rosidl_runtime_cpp::MessageInitialization::ALL)
      : header(_init), time_of_validity(_init) {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
        rosidl_runtime_cpp::MessageInitialization::ZERO == _init) {
      this->field_strength = 0.0;
      this->variance = 0.0;
      this->error_model = 0;
  ...
  using _field_strength_type = double;
  _field_strength_type field_strength;
  ...
  Type &set__field_strength(const double &_arg) {
    this->field_strength = _arg;
    return *this;
  }
  ...
  static constexpr uint8_t
      ASPN23_MEASUREMENT_MAGNETIC_FIELD_MAGNITUDE_ERROR_MODEL_NONE = 0u;

  // pointer types
  using RawPtr = aspn23_ros_interfaces::msg::MeasurementMagneticFieldMagnitude_<
      ContainerAllocator> *;
  using ConstRawPtr =
      const aspn23_ros_interfaces::msg::MeasurementMagneticFieldMagnitude_<
          ContainerAllocator> *;
  using SharedPtr = std::shared_ptr<
      aspn23_ros_interfaces::msg::MeasurementMagneticFieldMagnitude_<
          ContainerAllocator>>;
  ...
  using WeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::
                        MeasurementMagneticFieldMagnitude_<ContainerAllocator>>;
  ...
  // properly
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementMagneticFieldMagnitude
      std::shared_ptr<
          aspn23_ros_interfaces::msg::MeasurementMagneticFieldMagnitude_<
              ContainerAllocator>>
          Ptr;
  ...
  bool operator==(const MeasurementMagneticFieldMagnitude_ &other) const {
    ...
    if (this->field_strength != other.field_strength) {
      return false;
    }
...
}; // struct MeasurementMagneticFieldMagnitude_

// alias to use template instance with default allocator
using MeasurementMagneticFieldMagnitude =
    aspn23_ros_interfaces::msg::MeasurementMagneticFieldMagnitude_<
        std::allocator<void>>;
...
constexpr uint8_t MeasurementMagneticFieldMagnitude_<ContainerAllocator>::
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_MAGNETIC_FIELD_MAGNITUDE__STRUCT_HPP_
