...
aspn23_ros_interfaces__msg__MeasurementPositionAttitude__get_type_hash(
  ...
  static rosidl_type_hash_t hash = {
      1,
      {
          0x56, 0xa0, 0xb6, 0x8a, 0x00, 0xd7, 0x55, 0xd4, 0xe7, 0x99, 0x86,
          0xd2, 0xa3, 0xce, 0xec, 0xfa, 0x15, 0x61, 0xd4, 0x77, 0xe4, 0xdf,
          0x0e, 0xda, 0xdc, 0x1e, 0xe8, 0xe4, 0x7c, 0x3f, 0xda, 0xce,
      }};
  return &hash;
}
...
static char
    aspn23_ros_interfaces__msg__MeasurementPositionAttitude__TYPE_NAME[] =
...
static char
    aspn23_ros_interfaces__msg__MeasurementPositionAttitude__FIELD_NAME__header
        [] = "header";
static char
    aspn23_ros_interfaces__msg__MeasurementPositionAttitude__FIELD_NAME__time_of_validity
        [] = "time_of_validity";
static char
    aspn23_ros_interfaces__msg__MeasurementPositionAttitude__FIELD_NAME__reference_frame
        [] = "reference_frame";
static char
    aspn23_ros_interfaces__msg__MeasurementPositionAttitude__FIELD_NAME__p1[] =
        "p1";
static char
    aspn23_ros_interfaces__msg__MeasurementPositionAttitude__FIELD_NAME__p2[] =
        "p2";
static char
    aspn23_ros_interfaces__msg__MeasurementPositionAttitude__FIELD_NAME__p3[] =
        "p3";
static char
    aspn23_ros_interfaces__msg__MeasurementPositionAttitude__FIELD_NAME__quaternion
        [] = "quaternion";
static char
    aspn23_ros_interfaces__msg__MeasurementPositionAttitude__FIELD_NAME__covariance
        [] = "covariance";
static char
    aspn23_ros_interfaces__msg__MeasurementPositionAttitude__FIELD_NAME__error_model
        [] = "error_model";
static char
    aspn23_ros_interfaces__msg__MeasurementPositionAttitude__FIELD_NAME__num_error_model_params
        [] = "num_error_model_params";
static char
    aspn23_ros_interfaces__msg__MeasurementPositionAttitude__FIELD_NAME__error_model_params
        [] = "error_model_params";
static char
    aspn23_ros_interfaces__msg__MeasurementPositionAttitude__FIELD_NAME__num_integrity
        [] = "num_integrity";
static char
    aspn23_ros_interfaces__msg__MeasurementPositionAttitude__FIELD_NAME__integrity
        [] = "integrity";

static rosidl_runtime_c__type_description__Field
    aspn23_ros_interfaces__msg__MeasurementPositionAttitude__FIELDS[] = {
        {
            {aspn23_ros_interfaces__msg__MeasurementPositionAttitude__FIELD_NAME__header,
             6, 6},
            {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription
    aspn23_ros_interfaces__msg__MeasurementPositionAttitude__REFERENCED_TYPE_DESCRIPTIONS
        [] = {
            {
                {aspn23_ros_interfaces__msg__TypeHeader__TYPE_NAME, 36, 36},
                {NULL, 0, 0},
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
      {
          {aspn23_ros_interfaces__msg__MeasurementPositionAttitude__TYPE_NAME,
           53, 53},
          {aspn23_ros_interfaces__msg__MeasurementPositionAttitude__FIELDS, 13,
           13},
      },
      {aspn23_ros_interfaces__msg__MeasurementPositionAttitude__REFERENCED_TYPE_DESCRIPTIONS,
       3, 3},
...
static char toplevel_type_raw_source[] =
    ...
    "# Attitude expressed as a quaternion, a four element vector "
    "representation, the elements of which are\n"
    "# functions of the orientation of the vector and the magnitude of the "
    "rotation.\n"
    "\n"
    ...
    "\n"
    "# Sensor position and attitude relative to the earth-centered, inertial "
    "(ECi) frame. Position is\n"
    "# expressed where p1, p2, and p3 are the x, y, and z components of ECI "
    "position in meters,\n"
    "# respectively. Attitude is expressed as a four-element quaternion. Error "
    "covariance is given using\n"
    "# x-axis position error component (meters), y-axis position error "
    "component (meters), z-axis position\n"
    "# error component (meters), tilt error about the x-axis (rad), tilt error "
    "about the y-axis (rad), and\n"
    "# tilt error about the z-axis (rad). See also ECi coordinate frame "
    "definition for x, y, and z\n"
    "# definitions.\n"
    "uint8 ASPN23_MEASUREMENT_POSITION_ATTITUDE_REFERENCE_FRAME_ECI=0\n"
    "\n"
    "# Sensor position, and attitude relative to the WGS-84 reference. "
    "Position is expressed where p1 is\n"
    "# the geodetic latitude in radians, p2 is the longitude in radians, and "
    "p3 is the geodetic altitude\n"
    "# (or height above the WGS-84 ellipsoid) in meters. Attitude is the "
    "sensor frame rotation relative to\n"
    "# the local level frame expressed as a four-element quaternion. Error "
    "covariance is given using\n"
    "# north-south position error (meters), east-west position error (meters), "
    "geodetic altitude error\n"
    "# (meters), tilt error about the north axis (rad), tilt error about the "
    "east axis (rad), and tilt\n"
    "# error about the down axis (rad).\n"
    "uint8 ASPN23_MEASUREMENT_POSITION_ATTITUDE_REFERENCE_FRAME_GEODETIC=1\n"
    "\n"
    ...
    "uint8 ASPN23_MEASUREMENT_POSITION_ATTITUDE_ERROR_MODEL_NONE=0\n"
    "\n"
...
aspn23_ros_interfaces__msg__MeasurementPositionAttitude__get_individual_type_description_source(
    const rosidl_message_type_support_t *type_support) {
  (void)type_support;
  static const rosidl_runtime_c__type_description__TypeSource source = {
      {aspn23_ros_interfaces__msg__MeasurementPositionAttitude__TYPE_NAME, 53,
       53},
      {msg_encoding, 3, 3},
      {toplevel_type_raw_source, 4014, 4014},
  };
  return &source;
}
