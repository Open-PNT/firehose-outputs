...
// input from aspn23_ros_interfaces:msg/TypeTimestamp.idl generated code does
...
void TypeTimestamp_init_function(
    void *message_memory, rosidl_runtime_cpp::MessageInitialization _init) {
  new (message_memory) aspn23_ros_interfaces::msg::TypeTimestamp(_init);
}

void TypeTimestamp_fini_function(void *message_memory) {
  auto typed_message =
      static_cast<aspn23_ros_interfaces::msg::TypeTimestamp *>(message_memory);
  typed_message->~TypeTimestamp();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember
    TypeTimestamp_message_member_array[1] = {{
        "elapsed_nsec",                                         // name
        ...
        offsetof(aspn23_ros_interfaces::msg::TypeTimestamp,
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers
    TypeTimestamp_message_members = {
        "aspn23_ros_interfaces::msg", // message namespace
        "TypeTimestamp",              // message name
        1,                            // number of fields
        sizeof(aspn23_ros_interfaces::msg::TypeTimestamp),
        false,                              // has_any_key_member_
        TypeTimestamp_message_member_array, // message members
        TypeTimestamp_init_function, // function to initialize message memory
                                     // (memory has to be allocated)
        TypeTimestamp_fini_function  // function to terminate message instance
                                     // (will not free memory)
};

static const rosidl_message_type_support_t
    TypeTimestamp_message_type_support_handle = {
...
get_message_type_support_handle<aspn23_ros_interfaces::msg::TypeTimestamp>() {
