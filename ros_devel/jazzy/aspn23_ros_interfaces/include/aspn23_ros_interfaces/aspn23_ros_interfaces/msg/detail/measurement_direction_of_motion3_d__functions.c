...
bool aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__init(
  ...
  if (!aspn23_ros_interfaces__msg__TypeHeader__init(&msg->header)) {
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__fini(msg);
    return false;
  }
  // time_of_validity
...
void aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__fini(
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D *msg) {
  if (!msg) {
    return;
  }
...
bool aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__are_equal(
  ...
  // error_vector
  for (size_t i = 0; i < 3; ++i) {
    if (lhs->error_vector[i] != rhs->error_vector[i]) {
      return false;
    }
  }
  // covariance
...
bool aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__copy(
  ...
  // error_vector
  for (size_t i = 0; i < 3; ++i) {
    output->error_vector[i] = input->error_vector[i];
  }
  // covariance
  for (size_t i = 0; i < 4; ++i) {
...
aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__create(void) {
  ...
  bool success =
      aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__init(msg);
  if (!success) {
...
void aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__destroy(
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D *msg) {
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__fini(msg);
...
bool aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__Sequence__init(
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D *data = NULL;
...
void aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__Sequence__fini(
...
void aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__Sequence__destroy(
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__Sequence
        *array) {
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
...
bool aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__Sequence__are_equal(
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__are_equal(
...
bool aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__Sequence__copy(
    const aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__Sequence
        *input,
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__Sequence
        *output) {
  ...
  if (output->capacity < input->size) {
    ...
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D *data =
        (aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D *)allocator
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__init(
              &output->data[i])) {
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__copy(
