...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_TIME_DIFFERENCE__STRUCT_H_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_TIME_DIFFERENCE__STRUCT_H_
...
/// Constant 'ASPN23_MEASUREMENT_TIME_DIFFERENCE_ERROR_MODEL_NONE'.
/**
 * No additional error model provided (num_error_model_params = 0).
 */
enum {
  aspn23_ros_interfaces__msg__MeasurementTimeDifference__ASPN23_MEASUREMENT_TIME_DIFFERENCE_ERROR_MODEL_NONE =
      0
};
...
/// Struct defined in msg/MeasurementTimeDifference in the package
/// aspn23_ros_interfaces.
typedef struct aspn23_ros_interfaces__msg__MeasurementTimeDifference {
  /// This code is generated via firehose.
  /// DO NOT hand edit code.  Make any changes required using the firehose repo
  /// instead Time difference between two clocks or timing sources. Description:
...
// aspn23_ros_interfaces__msg__MeasurementTimeDifference.
typedef struct aspn23_ros_interfaces__msg__MeasurementTimeDifference__Sequence {
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_TIME_DIFFERENCE__STRUCT_H_
