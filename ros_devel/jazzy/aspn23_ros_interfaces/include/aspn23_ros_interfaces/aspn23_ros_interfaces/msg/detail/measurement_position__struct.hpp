...
// IWYU pragma: private, include "aspn23_ros_interfaces/msg/measurement_position.hpp"

#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_POSITION__STRUCT_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_POSITION__STRUCT_HPP_
...
#ifndef _WIN32
#define DEPRECATED__aspn23_ros_interfaces__msg__MeasurementPosition            \
...
// message struct
template <class ContainerAllocator> struct MeasurementPosition_ {
  using Type = MeasurementPosition_<ContainerAllocator>;

  explicit MeasurementPosition_(
  ...
  static constexpr uint8_t ASPN23_MEASUREMENT_POSITION_REFERENCE_FRAME_ECI = 0u;
  static constexpr uint8_t
      ASPN23_MEASUREMENT_POSITION_REFERENCE_FRAME_GEODETIC = 1u;
  static constexpr uint8_t ASPN23_MEASUREMENT_POSITION_ERROR_MODEL_NONE = 0u;

  // pointer types
  using RawPtr =
      aspn23_ros_interfaces::msg::MeasurementPosition_<ContainerAllocator> *;
  using ConstRawPtr =
      const aspn23_ros_interfaces::msg::MeasurementPosition_<ContainerAllocator>
          *;
  using SharedPtr = std::shared_ptr<
      aspn23_ros_interfaces::msg::MeasurementPosition_<ContainerAllocator>>;
  using ConstSharedPtr =
      std::shared_ptr<aspn23_ros_interfaces::msg::MeasurementPosition_<
  ...
  using ConstUniquePtrWithDeleter =
      std::unique_ptr<aspn23_ros_interfaces::msg::MeasurementPosition_<
                          ContainerAllocator> const,
                      Deleter>;
  ...
  using WeakPtr = std::weak_ptr<
      aspn23_ros_interfaces::msg::MeasurementPosition_<ContainerAllocator>>;
  using ConstWeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::MeasurementPosition_<
          ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes
  // properly
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementPosition
      std::shared_ptr<
          aspn23_ros_interfaces::msg::MeasurementPosition_<ContainerAllocator>>
          Ptr;
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementPosition
  ...
  bool operator==(const MeasurementPosition_ &other) const {
...
using MeasurementPosition =
    aspn23_ros_interfaces::msg::MeasurementPosition_<std::allocator<void>>;
...
constexpr uint8_t MeasurementPosition_<
    ContainerAllocator>::ASPN23_MEASUREMENT_POSITION_REFERENCE_FRAME_ECI;
...
template <typename ContainerAllocator>
constexpr uint8_t MeasurementPosition_<
    ContainerAllocator>::ASPN23_MEASUREMENT_POSITION_REFERENCE_FRAME_GEODETIC;
#endif // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and
// below, deprecated in C++17
template <typename ContainerAllocator>
constexpr uint8_t MeasurementPosition_<
    ContainerAllocator>::ASPN23_MEASUREMENT_POSITION_ERROR_MODEL_NONE;
#endif // __cplusplus < 201703L
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_POSITION__STRUCT_HPP_
