...
// IWYU pragma: private, include "aspn23_ros_interfaces/msg/measurement_speed.hpp"

#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_SPEED__STRUCT_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_SPEED__STRUCT_HPP_
...
#ifndef _WIN32
#define DEPRECATED__aspn23_ros_interfaces__msg__MeasurementSpeed               \
...
// message struct
template <class ContainerAllocator> struct MeasurementSpeed_ {
  using Type = MeasurementSpeed_<ContainerAllocator>;

  explicit MeasurementSpeed_(rosidl_runtime_cpp::MessageInitialization _init =
  ...
  explicit MeasurementSpeed_(const ContainerAllocator &_alloc,
  ...
  Type &set__speed(const double &_arg) {
    this->speed = _arg;
    return *this;
  }
  ...
  static constexpr uint8_t ASPN23_MEASUREMENT_SPEED_REFERENCE_TAS = 0u;
  static constexpr uint8_t ASPN23_MEASUREMENT_SPEED_REFERENCE_IAS = 1u;
  static constexpr uint8_t ASPN23_MEASUREMENT_SPEED_REFERENCE_WATER = 2u;
  static constexpr uint8_t ASPN23_MEASUREMENT_SPEED_REFERENCE_GROUND = 3u;
  static constexpr uint8_t ASPN23_MEASUREMENT_SPEED_ERROR_MODEL_NONE = 0u;

  // pointer types
  using RawPtr =
      aspn23_ros_interfaces::msg::MeasurementSpeed_<ContainerAllocator> *;
  using ConstRawPtr =
      const aspn23_ros_interfaces::msg::MeasurementSpeed_<ContainerAllocator> *;
  using SharedPtr = std::shared_ptr<
      aspn23_ros_interfaces::msg::MeasurementSpeed_<ContainerAllocator>>;
  using ConstSharedPtr = std::shared_ptr<
      aspn23_ros_interfaces::msg::MeasurementSpeed_<ContainerAllocator> const>;
  ...
  // properly
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementSpeed
      std::shared_ptr<
          aspn23_ros_interfaces::msg::MeasurementSpeed_<ContainerAllocator>>
          Ptr;
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementSpeed
      std::shared_ptr<aspn23_ros_interfaces::msg::MeasurementSpeed_<
          ContainerAllocator> const>
          ConstPtr;

  // comparison operators
  bool operator==(const MeasurementSpeed_ &other) const {
...
}; // struct MeasurementSpeed_

// alias to use template instance with default allocator
using MeasurementSpeed =
    aspn23_ros_interfaces::msg::MeasurementSpeed_<std::allocator<void>>;
...
constexpr uint8_t MeasurementSpeed_<
    ContainerAllocator>::ASPN23_MEASUREMENT_SPEED_REFERENCE_TAS;
...
template <typename ContainerAllocator>
constexpr uint8_t MeasurementSpeed_<
    ContainerAllocator>::ASPN23_MEASUREMENT_SPEED_REFERENCE_IAS;
#endif // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and
// below, deprecated in C++17
template <typename ContainerAllocator>
constexpr uint8_t MeasurementSpeed_<
    ContainerAllocator>::ASPN23_MEASUREMENT_SPEED_REFERENCE_WATER;
#endif // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and
// below, deprecated in C++17
template <typename ContainerAllocator>
constexpr uint8_t MeasurementSpeed_<
    ContainerAllocator>::ASPN23_MEASUREMENT_SPEED_REFERENCE_GROUND;
#endif // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and
// below, deprecated in C++17
template <typename ContainerAllocator>
constexpr uint8_t MeasurementSpeed_<
    ContainerAllocator>::ASPN23_MEASUREMENT_SPEED_ERROR_MODEL_NONE;
#endif // __cplusplus < 201703L
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_SPEED__STRUCT_HPP_
