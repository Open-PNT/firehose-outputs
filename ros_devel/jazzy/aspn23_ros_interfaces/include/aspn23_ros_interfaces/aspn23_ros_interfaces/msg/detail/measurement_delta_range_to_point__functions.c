...
bool aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint__init(
  ...
  if (!aspn23_ros_interfaces__msg__TypeHeader__init(&msg->header)) {
    aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint__fini(msg);
    return false;
  }
  // time_of_validity
...
void aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint__fini(
    aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint *msg) {
  if (!msg) {
    return;
  }
...
bool aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint__are_equal(
...
bool aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint__copy(
...
aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint__create(void) {
  ...
  memset(msg, 0,
         sizeof(aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint));
  bool success =
      aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint__init(msg);
  if (!success) {
...
void aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint__destroy(
    aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint *msg) {
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint__fini(msg);
...
bool aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint__Sequence__init(
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint *data = NULL;
...
void aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint__Sequence__fini(
    aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint__Sequence *array) {
  if (!array) {
    return;
  }
...
void aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint__Sequence__destroy(
    aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint__Sequence *array) {
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
...
bool aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint__Sequence__are_equal(
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint__are_equal(
...
bool aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint__Sequence__copy(
    const aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint__Sequence
        *input,
    aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint__Sequence
        *output) {
  ...
  if (output->capacity < input->size) {
    ...
    aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint *data =
        (aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint *)allocator
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint__init(
              &output->data[i])) {
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint__copy(
