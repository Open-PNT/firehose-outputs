...
aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__get_type_hash(
  ...
  static rosidl_type_hash_t hash = {
      1,
      {
          0x19, 0x0b, 0x9c, 0x4e, 0x14, 0xfc, 0x07, 0xaa, 0x1c, 0x76, 0x2e,
          0x73, 0x04, 0x41, 0xb9, 0xd3, 0xaa, 0xf4, 0xc7, 0x83, 0x0e, 0xe2,
          0x48, 0xc9, 0x3b, 0xde, 0x25, 0x60, 0x68, 0x0d, 0x21, 0x73,
      }};
  return &hash;
}
...
static char
    aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__TYPE_NAME
...
static char
    aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__FIELD_NAME__header
        [] = "header";
static char
    aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__FIELD_NAME__time_of_validity
        [] = "time_of_validity";
static char
    aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__FIELD_NAME__delta_t
        [] = "delta_t";
static char
    aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__FIELD_NAME__obs
        [] = "obs";
static char
    aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__FIELD_NAME__variance
        [] = "variance";
static char
    aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__FIELD_NAME__error_model
        [] = "error_model";
static char
    aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__FIELD_NAME__num_error_model_params
        [] = "num_error_model_params";
static char
    aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__FIELD_NAME__error_model_params
        [] = "error_model_params";
static char
    aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__FIELD_NAME__num_integrity
        [] = "num_integrity";
static char
    aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__FIELD_NAME__integrity
        [] = "integrity";

static rosidl_runtime_c__type_description__Field
    aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__FIELDS[] = {
        {
            {aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__FIELD_NAME__header,
             6, 6},
            {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription
    aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__REFERENCED_TYPE_DESCRIPTIONS
        [] = {
            {
                {aspn23_ros_interfaces__msg__TypeHeader__TYPE_NAME, 36, 36},
                {NULL, 0, 0},
...
static char toplevel_type_raw_source[] =
    ...
    "repo instead\n"
    "\n"
    "# Accumulated distance traveled over the time period from "
    "(time_of_validity - delta_t) to\n"
    "# time_of_validity. For example, a sensor that travels (over the "
    "observation time period) in one\n"
    "# direction 1m and reverses course to travel 1m back (and ends at its "
    "starting position) would have an\n"
    "# accumulated distance traveled of 2m. Sensor examples may include an "
    "odometer or a wheel encoder.\n"
    "\n"
    ...
    "uint8 "
    "ASPN23_MEASUREMENT_ACCUMULATED_DISTANCE_TRAVELED_ERROR_MODEL_NONE=0\n"
    "\n"
...
aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__get_individual_type_description_source(
  ...
  static const rosidl_runtime_c__type_description__TypeSource source = {
      {aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__TYPE_NAME,
       64, 64},
      {msg_encoding, 3, 3},
      {toplevel_type_raw_source, 2088, 2088},
  };
  return &source;
}
