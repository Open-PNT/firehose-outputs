...
// IWYU pragma: private, include "aspn23_ros_interfaces/msg/measurement_imu.hpp"

#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_IMU__STRUCT_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_IMU__STRUCT_HPP_
...
#ifndef _WIN32
#define DEPRECATED__aspn23_ros_interfaces__msg__MeasurementImu                 \
...
// message struct
template <class ContainerAllocator> struct MeasurementImu_ {
  using Type = MeasurementImu_<ContainerAllocator>;

  explicit MeasurementImu_(rosidl_runtime_cpp::MessageInitialization _init =
    ...
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      ...
      std::fill<typename std::array<double, 3>::iterator, double>(
          this->meas_accel.begin(), this->meas_accel.end(), 0.0);
      std::fill<typename std::array<double, 3>::iterator, double>(
          this->meas_gyro.begin(), this->meas_gyro.end(), 0.0);
      this->num_integrity = 0;
    }
  }

  explicit MeasurementImu_(const ContainerAllocator &_alloc,
                           rosidl_runtime_cpp::MessageInitialization _init =
                               rosidl_runtime_cpp::MessageInitialization::ALL)
      : header(_alloc, _init), time_of_validity(_alloc, _init),
        meas_accel(_alloc), meas_gyro(_alloc) {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
        rosidl_runtime_cpp::MessageInitialization::ZERO == _init) {
      this->imu_type = 0;
      std::fill<typename std::array<double, 3>::iterator, double>(
  ...
  using _meas_accel_type = std::array<double, 3>;
  _meas_accel_type meas_accel;
  using _meas_gyro_type = std::array<double, 3>;
  ...
  Type &set__meas_accel(const std::array<double, 3> &_arg) {
    this->meas_accel = _arg;
    return *this;
  }
  Type &set__meas_gyro(const std::array<double, 3> &_arg) {
    this->meas_gyro = _arg;
    return *this;
  }
  ...
  static constexpr uint8_t ASPN23_MEASUREMENT_IMU_IMU_TYPE_INTEGRATED = 0u;
  static constexpr uint8_t ASPN23_MEASUREMENT_IMU_IMU_TYPE_SAMPLED = 1u;

  // pointer types
  using RawPtr =
      aspn23_ros_interfaces::msg::MeasurementImu_<ContainerAllocator> *;
  using ConstRawPtr =
      const aspn23_ros_interfaces::msg::MeasurementImu_<ContainerAllocator> *;
  using SharedPtr = std::shared_ptr<
      aspn23_ros_interfaces::msg::MeasurementImu_<ContainerAllocator>>;
  using ConstSharedPtr = std::shared_ptr<
      aspn23_ros_interfaces::msg::MeasurementImu_<ContainerAllocator> const>;

  template <
      typename Deleter = std::default_delete<
          aspn23_ros_interfaces::msg::MeasurementImu_<ContainerAllocator>>>
  using UniquePtrWithDeleter = std::unique_ptr<
      aspn23_ros_interfaces::msg::MeasurementImu_<ContainerAllocator>, Deleter>;
  ...
  // properly
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementImu
      std::shared_ptr<
          aspn23_ros_interfaces::msg::MeasurementImu_<ContainerAllocator>>
          Ptr;
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementImu
  ...
  bool operator==(const MeasurementImu_ &other) const {
    ...
    if (this->meas_accel != other.meas_accel) {
      return false;
    }
...
}; // struct MeasurementImu_

// alias to use template instance with default allocator
using MeasurementImu =
    aspn23_ros_interfaces::msg::MeasurementImu_<std::allocator<void>>;
...
constexpr uint8_t MeasurementImu_<
    ContainerAllocator>::ASPN23_MEASUREMENT_IMU_IMU_TYPE_INTEGRATED;
...
template <typename ContainerAllocator>
constexpr uint8_t MeasurementImu_<
    ContainerAllocator>::ASPN23_MEASUREMENT_IMU_IMU_TYPE_SAMPLED;
#endif // __cplusplus < 201703L
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_IMU__STRUCT_HPP_
