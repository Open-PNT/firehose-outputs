...
aspn23_ros_interfaces__msg__MeasurementTemperature__get_type_hash(
  ...
  static rosidl_type_hash_t hash = {
      1,
      {
          0x3b, 0x81, 0x12, 0xa4, 0x34, 0x30, 0xc6, 0x70, 0xb6, 0xdf, 0x39,
          0xae, 0xbe, 0xda, 0x61, 0x48, 0x53, 0xf8, 0x27, 0x26, 0x5b, 0xed,
          0x36, 0x89, 0x75, 0xc7, 0xf5, 0x95, 0xc0, 0xd0, 0xd2, 0xdf,
      }};
  return &hash;
}
...
static char aspn23_ros_interfaces__msg__MeasurementTemperature__TYPE_NAME[] =
...
static char
    aspn23_ros_interfaces__msg__MeasurementTemperature__FIELD_NAME__header[] =
        "header";
static char
    aspn23_ros_interfaces__msg__MeasurementTemperature__FIELD_NAME__time_of_validity
        [] = "time_of_validity";
static char
    aspn23_ros_interfaces__msg__MeasurementTemperature__FIELD_NAME__temperature
        [] = "temperature";
static char
    aspn23_ros_interfaces__msg__MeasurementTemperature__FIELD_NAME__variance[] =
        "variance";
static char
    aspn23_ros_interfaces__msg__MeasurementTemperature__FIELD_NAME__error_model
        [] = "error_model";
static char
    aspn23_ros_interfaces__msg__MeasurementTemperature__FIELD_NAME__num_error_model_params
        [] = "num_error_model_params";
static char
    aspn23_ros_interfaces__msg__MeasurementTemperature__FIELD_NAME__error_model_params
        [] = "error_model_params";
static char
    aspn23_ros_interfaces__msg__MeasurementTemperature__FIELD_NAME__num_integrity
        [] = "num_integrity";
static char
    aspn23_ros_interfaces__msg__MeasurementTemperature__FIELD_NAME__integrity
        [] = "integrity";

static rosidl_runtime_c__type_description__Field
    aspn23_ros_interfaces__msg__MeasurementTemperature__FIELDS[] = {
        {
            {aspn23_ros_interfaces__msg__MeasurementTemperature__FIELD_NAME__header,
             6, 6},
            {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription
    aspn23_ros_interfaces__msg__MeasurementTemperature__REFERENCED_TYPE_DESCRIPTIONS
        [] = {
            {
                {aspn23_ros_interfaces__msg__TypeHeader__TYPE_NAME, 36, 36},
                {NULL, 0, 0},
...
aspn23_ros_interfaces__msg__MeasurementTemperature__get_type_description(
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
      {
          {aspn23_ros_interfaces__msg__MeasurementTemperature__TYPE_NAME, 48,
           48},
          {aspn23_ros_interfaces__msg__MeasurementTemperature__FIELDS, 9, 9},
      },
      {aspn23_ros_interfaces__msg__MeasurementTemperature__REFERENCED_TYPE_DESCRIPTIONS,
       3, 3},
  };
...
static char toplevel_type_raw_source[] =
    ...
    "uint8 ASPN23_MEASUREMENT_TEMPERATURE_ERROR_MODEL_NONE=0\n"
    "\n"
...
aspn23_ros_interfaces__msg__MeasurementTemperature__get_individual_type_description_source(
    const rosidl_message_type_support_t *type_support) {
  (void)type_support;
  static const rosidl_runtime_c__type_description__TypeSource source = {
      {aspn23_ros_interfaces__msg__MeasurementTemperature__TYPE_NAME, 48, 48},
      {msg_encoding, 3, 3},
      {toplevel_type_raw_source, 1521, 1521},
  };
  return &source;
}
