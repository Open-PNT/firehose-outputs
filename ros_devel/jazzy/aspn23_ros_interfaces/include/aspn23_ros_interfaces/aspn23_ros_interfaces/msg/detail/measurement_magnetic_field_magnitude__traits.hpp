...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_MAGNETIC_FIELD_MAGNITUDE__TRAITS_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_MAGNETIC_FIELD_MAGNITUDE__TRAITS_HPP_
...
inline void to_flow_style_yaml(const MeasurementMagneticFieldMagnitude &msg,
                               std::ostream &out) {
  out << "{";
  // member: header
  {
  ...
  // member: field_strength
  {
    out << "field_strength: ";
    rosidl_generator_traits::value_to_yaml(msg.field_strength, out);
    out << ", ";
  }
...
inline void to_block_style_yaml(const MeasurementMagneticFieldMagnitude &msg,
...
inline std::string to_yaml(const MeasurementMagneticFieldMagnitude &msg,
...
inline void to_yaml(
    const aspn23_ros_interfaces::msg::MeasurementMagneticFieldMagnitude &msg,
    std::ostream &out, size_t indentation = 0) {
...
template <>
inline const char *
data_type<aspn23_ros_interfaces::msg::MeasurementMagneticFieldMagnitude>() {
  return "aspn23_ros_interfaces::msg::MeasurementMagneticFieldMagnitude";
}

template <>
inline const char *
name<aspn23_ros_interfaces::msg::MeasurementMagneticFieldMagnitude>() {
  return "aspn23_ros_interfaces/msg/MeasurementMagneticFieldMagnitude";
}
...
template <>
struct is_message<aspn23_ros_interfaces::msg::MeasurementMagneticFieldMagnitude>
    : std::true_type {};

} // namespace rosidl_generator_traits

#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_MAGNETIC_FIELD_MAGNITUDE__TRAITS_HPP_
