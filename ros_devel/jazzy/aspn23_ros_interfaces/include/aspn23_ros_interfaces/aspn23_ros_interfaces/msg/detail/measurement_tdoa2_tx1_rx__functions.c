...
bool aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__init(
  ...
  if (!aspn23_ros_interfaces__msg__TypeHeader__init(&msg->header)) {
    aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__fini(msg);
    return false;
  }
  // time_of_validity
  ...
  if (!aspn23_ros_interfaces__msg__TypeRemotePoint__init(
          &msg->tx1_position_and_covariance)) {
    aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__fini(msg);
    return false;
  }
  // tx2_position_and_covariance
  if (!aspn23_ros_interfaces__msg__TypeRemotePoint__init(
          &msg->tx2_position_and_covariance)) {
    aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__fini(msg);
    return false;
  }
  // obs
...
void aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__fini(
    aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx *msg) {
  if (!msg) {
    return;
  }
...
bool aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__are_equal(
  ...
  if (!aspn23_ros_interfaces__msg__TypeRemotePoint__are_equal(
          &(lhs->tx1_position_and_covariance),
          &(rhs->tx1_position_and_covariance))) {
    return false;
  }
  // tx2_position_and_covariance
  if (!aspn23_ros_interfaces__msg__TypeRemotePoint__are_equal(
          &(lhs->tx2_position_and_covariance),
          &(rhs->tx2_position_and_covariance))) {
    return false;
  }
  // obs
  if (lhs->obs != rhs->obs) {
...
bool aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__copy(
  ...
  if (!aspn23_ros_interfaces__msg__TypeRemotePoint__copy(
          &(input->tx1_position_and_covariance),
          &(output->tx1_position_and_covariance))) {
    return false;
  }
  // tx2_position_and_covariance
  if (!aspn23_ros_interfaces__msg__TypeRemotePoint__copy(
          &(input->tx2_position_and_covariance),
          &(output->tx2_position_and_covariance))) {
    return false;
  }
  // obs
...
aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__create(void) {
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx *msg =
      (aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx *)allocator.allocate(
          sizeof(aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx),
          allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx));
  bool success = aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__init(msg);
  if (!success) {
...
void aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__destroy(
    aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx *msg) {
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__fini(msg);
...
bool aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__Sequence__init(
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx *data = NULL;

  if (size) {
    data =
        (aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx *)
            allocator.zero_allocate(
                size, sizeof(aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx),
                allocator.state);
    if (!data) {
      return false;
    }
    ...
    for (i = 0; i < size; ++i) {
      bool success =
          aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      // elements
      for (; i > 0; --i) {
        aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__fini(&data[i - 1]);
      }
...
void aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__Sequence__fini(
    aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__Sequence *array) {
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__fini(&array->data[i]);
    }
...
aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__Sequence__create(
  ...
  bool success =
      aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__Sequence__init(array,
                                                                        size);
  if (!success) {
...
void aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__Sequence__destroy(
    aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__Sequence *array) {
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__Sequence__are_equal(
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__are_equal(
...
bool aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__Sequence__copy(
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
        input->size * sizeof(aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx *data =
        (aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx *)allocator
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__init(
              &output->data[i])) {
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx__copy(
