...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_ALTITUDE__STRUCT_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_ALTITUDE__STRUCT_HPP_
...
#ifndef _WIN32
#define DEPRECATED__aspn23_ros_interfaces__msg__MeasurementAltitude            \
...
// message struct
template <class ContainerAllocator> struct MeasurementAltitude_ {
  using Type = MeasurementAltitude_<ContainerAllocator>;

  explicit MeasurementAltitude_(
  ...
  static constexpr uint8_t ASPN23_MEASUREMENT_ALTITUDE_REFERENCE_AGL = 0u;
  static constexpr uint8_t ASPN23_MEASUREMENT_ALTITUDE_REFERENCE_MSL = 1u;
  static constexpr uint8_t ASPN23_MEASUREMENT_ALTITUDE_REFERENCE_HAE = 2u;
  static constexpr uint8_t ASPN23_MEASUREMENT_ALTITUDE_ERROR_MODEL_NONE = 0u;
  static constexpr uint8_t ASPN23_MEASUREMENT_ALTITUDE_ERROR_MODEL_FOGM = 1u;

  // pointer types
  using RawPtr =
      aspn23_ros_interfaces::msg::MeasurementAltitude_<ContainerAllocator> *;
  using ConstRawPtr =
      const aspn23_ros_interfaces::msg::MeasurementAltitude_<ContainerAllocator>
          *;
  using SharedPtr = std::shared_ptr<
      aspn23_ros_interfaces::msg::MeasurementAltitude_<ContainerAllocator>>;
  using ConstSharedPtr =
      std::shared_ptr<aspn23_ros_interfaces::msg::MeasurementAltitude_<
  ...
  using ConstUniquePtrWithDeleter =
      std::unique_ptr<aspn23_ros_interfaces::msg::MeasurementAltitude_<
                          ContainerAllocator> const,
                      Deleter>;
  ...
  using WeakPtr = std::weak_ptr<
      aspn23_ros_interfaces::msg::MeasurementAltitude_<ContainerAllocator>>;
  using ConstWeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::MeasurementAltitude_<
          ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes
  // properly
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementAltitude
      std::shared_ptr<
          aspn23_ros_interfaces::msg::MeasurementAltitude_<ContainerAllocator>>
          Ptr;
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementAltitude
  ...
  bool operator==(const MeasurementAltitude_ &other) const {
...
}; // struct MeasurementAltitude_

// alias to use template instance with default allocator
using MeasurementAltitude =
    aspn23_ros_interfaces::msg::MeasurementAltitude_<std::allocator<void>>;
...
constexpr uint8_t MeasurementAltitude_<
    ContainerAllocator>::ASPN23_MEASUREMENT_ALTITUDE_REFERENCE_AGL;
...
template <typename ContainerAllocator>
constexpr uint8_t MeasurementAltitude_<
    ContainerAllocator>::ASPN23_MEASUREMENT_ALTITUDE_REFERENCE_MSL;
#endif // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and
// below, deprecated in C++17
template <typename ContainerAllocator>
constexpr uint8_t MeasurementAltitude_<
    ContainerAllocator>::ASPN23_MEASUREMENT_ALTITUDE_REFERENCE_HAE;
#endif // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and
// below, deprecated in C++17
template <typename ContainerAllocator>
constexpr uint8_t MeasurementAltitude_<
    ContainerAllocator>::ASPN23_MEASUREMENT_ALTITUDE_ERROR_MODEL_NONE;
#endif // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and
// below, deprecated in C++17
template <typename ContainerAllocator>
constexpr uint8_t MeasurementAltitude_<
    ContainerAllocator>::ASPN23_MEASUREMENT_ALTITUDE_ERROR_MODEL_FOGM;
#endif // __cplusplus < 201703L
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_ALTITUDE__STRUCT_HPP_
