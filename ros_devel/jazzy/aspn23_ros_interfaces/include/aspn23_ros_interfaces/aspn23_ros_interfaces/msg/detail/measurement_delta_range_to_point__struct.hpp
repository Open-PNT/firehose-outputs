...
// IWYU pragma: private, include "aspn23_ros_interfaces/msg/measurement_delta_range_to_point.hpp"

#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DELTA_RANGE_TO_POINT__STRUCT_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DELTA_RANGE_TO_POINT__STRUCT_HPP_
...
#ifndef _WIN32
#define DEPRECATED__aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint   \
...
// message struct
template <class ContainerAllocator> struct MeasurementDeltaRangeToPoint_ {
  using Type = MeasurementDeltaRangeToPoint_<ContainerAllocator>;

  explicit MeasurementDeltaRangeToPoint_(
      rosidl_runtime_cpp::MessageInitialization _init =
          rosidl_runtime_cpp::MessageInitialization::ALL)
      : header(_init), time_of_validity(_init), remote_point(_init) {
  ...
  static constexpr uint8_t
      ASPN23_MEASUREMENT_DELTA_RANGE_TO_POINT_ERROR_MODEL_NONE = 0u;

  // pointer types
  using RawPtr = aspn23_ros_interfaces::msg::MeasurementDeltaRangeToPoint_<
      ContainerAllocator> *;
  using ConstRawPtr =
      const aspn23_ros_interfaces::msg::MeasurementDeltaRangeToPoint_<
          ContainerAllocator> *;
  using SharedPtr =
      std::shared_ptr<aspn23_ros_interfaces::msg::MeasurementDeltaRangeToPoint_<
          ContainerAllocator>>;
  ...
  template <typename Deleter = std::default_delete<
                aspn23_ros_interfaces::msg::MeasurementDeltaRangeToPoint_<
                    ContainerAllocator>>>
  using UniquePtrWithDeleter =
      std::unique_ptr<aspn23_ros_interfaces::msg::MeasurementDeltaRangeToPoint_<
                          ContainerAllocator>,
                      Deleter>;
  ...
  using WeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::MeasurementDeltaRangeToPoint_<
          ContainerAllocator>>;
  using ConstWeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::MeasurementDeltaRangeToPoint_<
          ContainerAllocator> const>;
  ...
  // properly
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint
      std::shared_ptr<aspn23_ros_interfaces::msg::MeasurementDeltaRangeToPoint_<
          ContainerAllocator>>
          Ptr;
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementDeltaRangeToPoint
  ...
  bool operator==(const MeasurementDeltaRangeToPoint_ &other) const {
...
}; // struct MeasurementDeltaRangeToPoint_

// alias to use template instance with default allocator
using MeasurementDeltaRangeToPoint =
    aspn23_ros_interfaces::msg::MeasurementDeltaRangeToPoint_<
        std::allocator<void>>;
...
constexpr uint8_t MeasurementDeltaRangeToPoint_<ContainerAllocator>::
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DELTA_RANGE_TO_POINT__STRUCT_HPP_
