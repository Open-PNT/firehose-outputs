...
// IWYU pragma: private, include "aspn23_ros_interfaces/msg/measurement_accumulated_distance_traveled.hpp"

#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_ACCUMULATED_DISTANCE_TRAVELED__STRUCT_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_ACCUMULATED_DISTANCE_TRAVELED__STRUCT_HPP_
...
#ifndef _WIN32
#define DEPRECATED__aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled \
...
struct MeasurementAccumulatedDistanceTraveled_ {
  using Type = MeasurementAccumulatedDistanceTraveled_<ContainerAllocator>;

  explicit MeasurementAccumulatedDistanceTraveled_(
  ...
  static constexpr uint8_t
      ASPN23_MEASUREMENT_ACCUMULATED_DISTANCE_TRAVELED_ERROR_MODEL_NONE = 0u;

  // pointer types
  using RawPtr =
      aspn23_ros_interfaces::msg::MeasurementAccumulatedDistanceTraveled_<
          ContainerAllocator> *;
  using ConstRawPtr =
      const aspn23_ros_interfaces::msg::MeasurementAccumulatedDistanceTraveled_<
          ContainerAllocator> *;
  ...
  // properly
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled
      std::shared_ptr<
          aspn23_ros_interfaces::msg::MeasurementAccumulatedDistanceTraveled_<
              ContainerAllocator>>
          Ptr;
  ...
  bool operator==(const MeasurementAccumulatedDistanceTraveled_ &other) const {
...
using MeasurementAccumulatedDistanceTraveled =
    aspn23_ros_interfaces::msg::MeasurementAccumulatedDistanceTraveled_<
        std::allocator<void>>;
...
constexpr uint8_t MeasurementAccumulatedDistanceTraveled_<ContainerAllocator>::
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_ACCUMULATED_DISTANCE_TRAVELED__STRUCT_HPP_
