...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__TYPE_DIRECTION2_D_TO_POINT__TRAITS_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__TYPE_DIRECTION2_D_TO_POINT__TRAITS_HPP_
...
inline void to_flow_style_yaml(const TypeDirection2DToPoint &msg,
                               std::ostream &out) {
  out << "{";
  // member: remote_point
  {
...
inline void to_block_style_yaml(const TypeDirection2DToPoint &msg,
...
inline std::string to_yaml(const TypeDirection2DToPoint &msg,
...
inline void
to_yaml(const aspn23_ros_interfaces::msg::TypeDirection2DToPoint &msg,
        std::ostream &out, size_t indentation = 0) {
...
template <>
inline const char *
data_type<aspn23_ros_interfaces::msg::TypeDirection2DToPoint>() {
  return "aspn23_ros_interfaces::msg::TypeDirection2DToPoint";
}

template <>
inline const char *name<aspn23_ros_interfaces::msg::TypeDirection2DToPoint>() {
  return "aspn23_ros_interfaces/msg/TypeDirection2DToPoint";
}

template <>
struct has_fixed_size<aspn23_ros_interfaces::msg::TypeDirection2DToPoint>
    : std::integral_constant<bool, false> {};

template <>
struct has_bounded_size<aspn23_ros_interfaces::msg::TypeDirection2DToPoint>
    : std::integral_constant<bool, false> {};

template <>
struct is_message<aspn23_ros_interfaces::msg::TypeDirection2DToPoint>
    : std::true_type {};

} // namespace rosidl_generator_traits

#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__TYPE_DIRECTION2_D_TO_POINT__TRAITS_HPP_
