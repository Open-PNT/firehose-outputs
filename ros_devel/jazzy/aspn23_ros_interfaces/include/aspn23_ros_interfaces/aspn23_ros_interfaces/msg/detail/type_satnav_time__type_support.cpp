...
// input from aspn23_ros_interfaces:msg/TypeSatnavTime.idl generated code does
...
void TypeSatnavTime_init_function(
    void *message_memory, rosidl_runtime_cpp::MessageInitialization _init) {
  new (message_memory) aspn23_ros_interfaces::msg::TypeSatnavTime(_init);
}

void TypeSatnavTime_fini_function(void *message_memory) {
  auto typed_message =
      static_cast<aspn23_ros_interfaces::msg::TypeSatnavTime *>(message_memory);
  typed_message->~TypeSatnavTime();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember
    TypeSatnavTime_message_member_array[3] = {
        {
            "week_number",                                           // name
            ...
            offsetof(aspn23_ros_interfaces::msg::TypeSatnavTime,
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers
    TypeSatnavTime_message_members = {
        "aspn23_ros_interfaces::msg", // message namespace
        "TypeSatnavTime",             // message name
        3,                            // number of fields
        sizeof(aspn23_ros_interfaces::msg::TypeSatnavTime),
        false,                               // has_any_key_member_
        TypeSatnavTime_message_member_array, // message members
        TypeSatnavTime_init_function, // function to initialize message memory
                                      // (memory has to be allocated)
        TypeSatnavTime_fini_function  // function to terminate message instance
                                      // (will not free memory)
};

static const rosidl_message_type_support_t
    TypeSatnavTime_message_type_support_handle = {
...
get_message_type_support_handle<aspn23_ros_interfaces::msg::TypeSatnavTime>() {
