...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_TIME__STRUCT_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_TIME__STRUCT_HPP_
...
#ifndef _WIN32
#define DEPRECATED__aspn23_ros_interfaces__msg__MeasurementTime                \
...
// message struct
template <class ContainerAllocator> struct MeasurementTime_ {
  using Type = MeasurementTime_<ContainerAllocator>;

  explicit MeasurementTime_(rosidl_runtime_cpp::MessageInitialization _init =
  ...
  explicit MeasurementTime_(const ContainerAllocator &_alloc,
  ...
  using _num_obs_type = uint8_t;
  _num_obs_type num_obs;
  using _clock_id_type =
      std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::
                               template rebind_alloc<uint8_t>>;
  _clock_id_type clock_id;
  using _elapsed_nsec_type =
      std::vector<int64_t, typename std::allocator_traits<ContainerAllocator>::
                               template rebind_alloc<int64_t>>;
  _elapsed_nsec_type elapsed_nsec;
  using _elapsed_attosec_type =
      std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::
                               template rebind_alloc<int32_t>>;
  _elapsed_attosec_type elapsed_attosec;
  ...
  Type &set__num_obs(const uint8_t &_arg) {
    this->num_obs = _arg;
    return *this;
  }
  Type &set__clock_id(
  ...
  Type &set__elapsed_nsec(
      const std::vector<int64_t,
                        typename std::allocator_traits<ContainerAllocator>::
                            template rebind_alloc<int64_t>> &_arg) {
    this->elapsed_nsec = _arg;
    return *this;
  }
  Type &set__elapsed_attosec(
      const std::vector<int32_t,
                        typename std::allocator_traits<ContainerAllocator>::
                            template rebind_alloc<int32_t>> &_arg) {
    this->elapsed_attosec = _arg;
    return *this;
  }
  ...
  static constexpr uint8_t ASPN23_MEASUREMENT_TIME_ERROR_MODEL_NONE = 0u;

  // pointer types
  using RawPtr =
      aspn23_ros_interfaces::msg::MeasurementTime_<ContainerAllocator> *;
  using ConstRawPtr =
      const aspn23_ros_interfaces::msg::MeasurementTime_<ContainerAllocator> *;
  using SharedPtr = std::shared_ptr<
      aspn23_ros_interfaces::msg::MeasurementTime_<ContainerAllocator>>;
  using ConstSharedPtr = std::shared_ptr<
      aspn23_ros_interfaces::msg::MeasurementTime_<ContainerAllocator> const>;
  ...
  // properly
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementTime
      std::shared_ptr<
          aspn23_ros_interfaces::msg::MeasurementTime_<ContainerAllocator>>
          Ptr;
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementTime
      std::shared_ptr<aspn23_ros_interfaces::msg::MeasurementTime_<
          ContainerAllocator> const>
          ConstPtr;

  // comparison operators
  bool operator==(const MeasurementTime_ &other) const {
    ...
    if (this->clock_id != other.clock_id) {
      return false;
    }
    if (this->elapsed_nsec != other.elapsed_nsec) {
      return false;
    }
    if (this->elapsed_attosec != other.elapsed_attosec) {
      return false;
    }
...
}; // struct MeasurementTime_

// alias to use template instance with default allocator
using MeasurementTime =
    aspn23_ros_interfaces::msg::MeasurementTime_<std::allocator<void>>;
...
constexpr uint8_t MeasurementTime_<
    ContainerAllocator>::ASPN23_MEASUREMENT_TIME_ERROR_MODEL_NONE;
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_TIME__STRUCT_HPP_
