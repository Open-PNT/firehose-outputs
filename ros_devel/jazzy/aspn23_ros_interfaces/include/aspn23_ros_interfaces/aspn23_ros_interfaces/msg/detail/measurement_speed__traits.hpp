...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_SPEED__TRAITS_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_SPEED__TRAITS_HPP_
...
inline void to_flow_style_yaml(const MeasurementSpeed &msg, std::ostream &out) {
  out << "{";
  // member: header
  {
    out << "header: ";
...
inline void to_block_style_yaml(const MeasurementSpeed &msg, std::ostream &out,
...
inline std::string to_yaml(const MeasurementSpeed &msg,
...
inline void to_yaml(const aspn23_ros_interfaces::msg::MeasurementSpeed &msg,
...
inline std::string
to_yaml(const aspn23_ros_interfaces::msg::MeasurementSpeed &msg) {
  return aspn23_ros_interfaces::msg::to_yaml(msg);
}

template <>
inline const char *data_type<aspn23_ros_interfaces::msg::MeasurementSpeed>() {
  return "aspn23_ros_interfaces::msg::MeasurementSpeed";
}

template <>
inline const char *name<aspn23_ros_interfaces::msg::MeasurementSpeed>() {
  return "aspn23_ros_interfaces/msg/MeasurementSpeed";
}

template <>
struct has_fixed_size<aspn23_ros_interfaces::msg::MeasurementSpeed>
    : std::integral_constant<bool, false> {};

template <>
struct has_bounded_size<aspn23_ros_interfaces::msg::MeasurementSpeed>
    : std::integral_constant<bool, false> {};

template <>
struct is_message<aspn23_ros_interfaces::msg::MeasurementSpeed>
    : std::true_type {};

} // namespace rosidl_generator_traits

#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_SPEED__TRAITS_HPP_
