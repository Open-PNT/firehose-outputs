...
// IWYU pragma: private, include "aspn23_ros_interfaces/msg/measurement_frequency_difference.hpp"

#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_FREQUENCY_DIFFERENCE__STRUCT_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_FREQUENCY_DIFFERENCE__STRUCT_HPP_
...
#ifndef _WIN32
#define DEPRECATED__aspn23_ros_interfaces__msg__MeasurementFrequencyDifference \
...
// message struct
template <class ContainerAllocator> struct MeasurementFrequencyDifference_ {
  using Type = MeasurementFrequencyDifference_<ContainerAllocator>;

  explicit MeasurementFrequencyDifference_(
  ...
  static constexpr uint8_t
      ASPN23_MEASUREMENT_FREQUENCY_DIFFERENCE_ERROR_MODEL_NONE = 0u;

  // pointer types
  using RawPtr = aspn23_ros_interfaces::msg::MeasurementFrequencyDifference_<
      ContainerAllocator> *;
  using ConstRawPtr =
      const aspn23_ros_interfaces::msg::MeasurementFrequencyDifference_<
          ContainerAllocator> *;
  using SharedPtr =
      std::shared_ptr<aspn23_ros_interfaces::msg::
                          MeasurementFrequencyDifference_<ContainerAllocator>>;
  using ConstSharedPtr = std::shared_ptr<
      aspn23_ros_interfaces::msg::MeasurementFrequencyDifference_<
  ...
  using WeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::MeasurementFrequencyDifference_<
          ContainerAllocator>>;
  using ConstWeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::MeasurementFrequencyDifference_<
          ContainerAllocator> const>;
  ...
  // properly
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementFrequencyDifference
      std::shared_ptr<aspn23_ros_interfaces::msg::
                          MeasurementFrequencyDifference_<ContainerAllocator>>
          Ptr;
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementFrequencyDifference
  ...
  bool operator==(const MeasurementFrequencyDifference_ &other) const {
...
}; // struct MeasurementFrequencyDifference_

// alias to use template instance with default allocator
using MeasurementFrequencyDifference =
    aspn23_ros_interfaces::msg::MeasurementFrequencyDifference_<
        std::allocator<void>>;
...
constexpr uint8_t MeasurementFrequencyDifference_<ContainerAllocator>::
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_FREQUENCY_DIFFERENCE__STRUCT_HPP_
