...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DIRECTION_OF_MOTION3_D__TRAITS_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DIRECTION_OF_MOTION3_D__TRAITS_HPP_
...
inline void to_flow_style_yaml(const MeasurementDirectionOfMotion3D &msg,
                               std::ostream &out) {
  out << "{";
  // member: header
  {
  ...
  // member: error_vector
  {
    if (msg.error_vector.size() == 0) {
      out << "error_vector: []";
    } else {
      out << "error_vector: [";
      size_t pending_items = msg.error_vector.size();
      for (auto item : msg.error_vector) {
        rosidl_generator_traits::value_to_yaml(item, out);
        if (--pending_items > 0) {
          out << ", ";
        }
...
inline void to_block_style_yaml(const MeasurementDirectionOfMotion3D &msg,
...
inline std::string to_yaml(const MeasurementDirectionOfMotion3D &msg,
...
inline void
to_yaml(const aspn23_ros_interfaces::msg::MeasurementDirectionOfMotion3D &msg,
        std::ostream &out, size_t indentation = 0) {
...
template <>
inline const char *
data_type<aspn23_ros_interfaces::msg::MeasurementDirectionOfMotion3D>() {
  return "aspn23_ros_interfaces::msg::MeasurementDirectionOfMotion3D";
}

template <>
inline const char *
name<aspn23_ros_interfaces::msg::MeasurementDirectionOfMotion3D>() {
  return "aspn23_ros_interfaces/msg/MeasurementDirectionOfMotion3D";
}
...
template <>
struct is_message<aspn23_ros_interfaces::msg::MeasurementDirectionOfMotion3D>
    : std::true_type {};

} // namespace rosidl_generator_traits

#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DIRECTION_OF_MOTION3_D__TRAITS_HPP_
