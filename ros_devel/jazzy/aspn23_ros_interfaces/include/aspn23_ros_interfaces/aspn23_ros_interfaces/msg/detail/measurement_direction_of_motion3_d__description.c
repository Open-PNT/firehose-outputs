...
aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__get_type_hash(
  ...
  static rosidl_type_hash_t hash = {
      1,
      {
          0xd6, 0xf6, 0xf5, 0x43, 0xbd, 0x85, 0xa4, 0x11, 0xb2, 0x61, 0x84,
          0x0e, 0x5f, 0x84, 0xd0, 0x19, 0x0d, 0x5c, 0x1a, 0xa9, 0x1b, 0xf7,
          0x5e, 0xca, 0x8e, 0x44, 0x9c, 0xeb, 0xfa, 0x96, 0x42, 0x8f,
      }};
  return &hash;
}
...
static char
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__TYPE_NAME[] =
...
static char
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__FIELD_NAME__header
        [] = "header";
static char
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__FIELD_NAME__time_of_validity
        [] = "time_of_validity";
static char
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__FIELD_NAME__reference_frame
        [] = "reference_frame";
static char
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__FIELD_NAME__obs
        [] = "obs";
static char
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__FIELD_NAME__error_vector
        [] = "error_vector";
static char
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__FIELD_NAME__covariance
        [] = "covariance";
static char
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__FIELD_NAME__error_model
        [] = "error_model";
static char
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__FIELD_NAME__num_error_model_params
        [] = "num_error_model_params";
static char
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__FIELD_NAME__error_model_params
        [] = "error_model_params";
static char
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__FIELD_NAME__num_integrity
        [] = "num_integrity";
static char
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__FIELD_NAME__integrity
        [] = "integrity";

static rosidl_runtime_c__type_description__Field
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__FIELDS[] = {
        {
            {aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__FIELD_NAME__header,
             6, 6},
            {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription
    aspn23_ros_interfaces__msg__MeasurementDirectionOfMotion3D__REFERENCED_TYPE_DESCRIPTIONS
        [] = {
            {
                {aspn23_ros_interfaces__msg__TypeHeader__TYPE_NAME, 36, 36},
                {NULL, 0, 0},
...
static char toplevel_type_raw_source[] =
    ...
    "\n"
    "# Direction of motion with respect to earth-centered inertial (ECi) "
    "frame, expressed in an\n"
    "# earth-centered inertial frame. See also ECi coordinate frame definition "
    "for x, y, and z definitions.\n"
    "uint8 ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_ECI=0\n"
    "\n"
    ...
    "definitions.\n"
    "uint8 ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_ECEF=1\n"
    "\n"
    ...
    "# definitions.\n"
    "uint8 ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_NED=2\n"
    "\n"
    "# Direction of motion with respect to earth-fixed frame expressed in "
    "sensor coordinate frame. Sensor\n"
    "# coordinate frame is defined in sensor metadataHeader.\n"
    "uint8 ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_REFERENCE_FRAME_SENSOR=3\n"
    "\n"
    ...
    "error_vector and and a\n"
    "# second error vector that is orthogonal to both the obs vector and the "
    "error_vector.\n"
    "# Units: none\n"
    "float64[3] error_vector\n"
    "\n"
    "# Description: Error is expressed as rotation uncertainty about the "
    "following two axes: 1)\n"
    "# error_vector, and 2) a second error vector that is orthogonal to both "
    "the obs direction vector and\n"
    "# the error_vector.\n"
    "# Units: rad^2\n"
    ...
    "uint8 ASPN23_MEASUREMENT_DIRECTION_OF_MOTION_3D_ERROR_MODEL_NONE=0\n"
    "\n"
