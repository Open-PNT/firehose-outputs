...
bool aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__init(
...
void aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__fini(
    aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled *msg) {
  if (!msg) {
    return;
  }
...
bool aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__are_equal(
...
bool aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__copy(
    const aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled
        *input,
...
void aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__destroy(
    aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled *msg) {
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__fini(
...
bool aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__Sequence__init(
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled *data =
      NULL;
...
void aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__Sequence__fini(
    aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__Sequence
        *array) {
  if (!array) {
    return;
...
aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__Sequence__create(
    size_t size) {
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__Sequence *array =
      (aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__Sequence
           *)
          allocator.allocate(
              sizeof(
...
void aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__Sequence__destroy(
    aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__Sequence
        *array) {
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
...
bool aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__Sequence__are_equal(
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__are_equal(
...
bool aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__Sequence__copy(
    const aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__Sequence
        *input,
    aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__Sequence
        *output) {
  ...
  if (output->capacity < input->size) {
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__init(
              &output->data[i])) {
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!aspn23_ros_interfaces__msg__MeasurementAccumulatedDistanceTraveled__copy(
