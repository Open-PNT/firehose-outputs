...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_FREQUENCY_DIFFERENCE__TRAITS_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_FREQUENCY_DIFFERENCE__TRAITS_HPP_
...
inline void to_flow_style_yaml(const MeasurementFrequencyDifference &msg,
                               std::ostream &out) {
  out << "{";
  // member: header
  {
...
inline void to_block_style_yaml(const MeasurementFrequencyDifference &msg,
...
inline std::string to_yaml(const MeasurementFrequencyDifference &msg,
...
inline void
to_yaml(const aspn23_ros_interfaces::msg::MeasurementFrequencyDifference &msg,
        std::ostream &out, size_t indentation = 0) {
...
template <>
inline const char *
data_type<aspn23_ros_interfaces::msg::MeasurementFrequencyDifference>() {
  return "aspn23_ros_interfaces::msg::MeasurementFrequencyDifference";
}

template <>
inline const char *
name<aspn23_ros_interfaces::msg::MeasurementFrequencyDifference>() {
  return "aspn23_ros_interfaces/msg/MeasurementFrequencyDifference";
}
...
template <>
struct is_message<aspn23_ros_interfaces::msg::MeasurementFrequencyDifference>
    : std::true_type {};

} // namespace rosidl_generator_traits

#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_FREQUENCY_DIFFERENCE__TRAITS_HPP_
