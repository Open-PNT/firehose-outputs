...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_MAGNETIC_FIELD__TRAITS_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_MAGNETIC_FIELD__TRAITS_HPP_
...
inline void to_flow_style_yaml(const MeasurementMagneticField &msg,
                               std::ostream &out) {
  out << "{";
  // member: header
  {
  ...
  // member: x_field_strength
  {
    out << "x_field_strength: ";
    rosidl_generator_traits::value_to_yaml(msg.x_field_strength, out);
    out << ", ";
  }

  // member: y_field_strength
  {
    out << "y_field_strength: ";
    rosidl_generator_traits::value_to_yaml(msg.y_field_strength, out);
    out << ", ";
  }

  // member: z_field_strength
  {
    out << "z_field_strength: ";
    rosidl_generator_traits::value_to_yaml(msg.z_field_strength, out);
    out << ", ";
  }
...
inline void to_block_style_yaml(const MeasurementMagneticField &msg,
...
inline std::string to_yaml(const MeasurementMagneticField &msg,
...
inline void
to_yaml(const aspn23_ros_interfaces::msg::MeasurementMagneticField &msg,
        std::ostream &out, size_t indentation = 0) {
...
template <>
inline const char *
data_type<aspn23_ros_interfaces::msg::MeasurementMagneticField>() {
  return "aspn23_ros_interfaces::msg::MeasurementMagneticField";
}

template <>
inline const char *
name<aspn23_ros_interfaces::msg::MeasurementMagneticField>() {
  return "aspn23_ros_interfaces/msg/MeasurementMagneticField";
}

template <>
struct has_fixed_size<aspn23_ros_interfaces::msg::MeasurementMagneticField>
    : std::integral_constant<bool, false> {};

template <>
struct has_bounded_size<aspn23_ros_interfaces::msg::MeasurementMagneticField>
    : std::integral_constant<bool, false> {};

template <>
struct is_message<aspn23_ros_interfaces::msg::MeasurementMagneticField>
    : std::true_type {};

} // namespace rosidl_generator_traits

#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_MAGNETIC_FIELD__TRAITS_HPP_
