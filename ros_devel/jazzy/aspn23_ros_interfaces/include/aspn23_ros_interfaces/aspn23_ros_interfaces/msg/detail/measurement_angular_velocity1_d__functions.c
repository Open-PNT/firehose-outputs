...
bool aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D__init(
  ...
  if (!aspn23_ros_interfaces__msg__TypeHeader__init(&msg->header)) {
    aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D__fini(msg);
    return false;
  }
  // time_of_validity
...
void aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D__fini(
    aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D *msg) {
  if (!msg) {
    return;
  }
...
bool aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D__are_equal(
...
bool aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D__copy(
...
aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D__create(void) {
  ...
  memset(msg, 0,
         sizeof(aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D));
  bool success =
      aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D__init(msg);
  if (!success) {
...
void aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D__destroy(
    aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D *msg) {
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D__fini(msg);
...
bool aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D__Sequence__init(
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D *data = NULL;
...
void aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D__Sequence__fini(
    aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D__Sequence *array) {
  if (!array) {
    return;
  }
...
void aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D__Sequence__destroy(
    aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D__Sequence *array) {
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
...
bool aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D__Sequence__are_equal(
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D__are_equal(
...
bool aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D__Sequence__copy(
    const aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D__Sequence
        *input,
    aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D__Sequence
        *output) {
  ...
  if (output->capacity < input->size) {
    ...
    aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D *data =
        (aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D *)allocator
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D__init(
              &output->data[i])) {
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!aspn23_ros_interfaces__msg__MeasurementAngularVelocity1D__copy(
