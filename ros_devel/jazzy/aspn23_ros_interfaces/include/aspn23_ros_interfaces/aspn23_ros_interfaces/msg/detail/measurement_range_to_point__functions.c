...
bool aspn23_ros_interfaces__msg__MeasurementRangeToPoint__init(
  ...
  if (!aspn23_ros_interfaces__msg__TypeHeader__init(&msg->header)) {
    aspn23_ros_interfaces__msg__MeasurementRangeToPoint__fini(msg);
    return false;
  }
  // time_of_validity
...
void aspn23_ros_interfaces__msg__MeasurementRangeToPoint__fini(
    aspn23_ros_interfaces__msg__MeasurementRangeToPoint *msg) {
  if (!msg) {
    return;
  }
...
bool aspn23_ros_interfaces__msg__MeasurementRangeToPoint__are_equal(
...
bool aspn23_ros_interfaces__msg__MeasurementRangeToPoint__copy(
...
aspn23_ros_interfaces__msg__MeasurementRangeToPoint__create(void) {
  ...
  aspn23_ros_interfaces__msg__MeasurementRangeToPoint *msg =
      (aspn23_ros_interfaces__msg__MeasurementRangeToPoint *)allocator.allocate(
          sizeof(aspn23_ros_interfaces__msg__MeasurementRangeToPoint),
          allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(aspn23_ros_interfaces__msg__MeasurementRangeToPoint));
  bool success = aspn23_ros_interfaces__msg__MeasurementRangeToPoint__init(msg);
  if (!success) {
...
void aspn23_ros_interfaces__msg__MeasurementRangeToPoint__destroy(
    aspn23_ros_interfaces__msg__MeasurementRangeToPoint *msg) {
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    aspn23_ros_interfaces__msg__MeasurementRangeToPoint__fini(msg);
...
bool aspn23_ros_interfaces__msg__MeasurementRangeToPoint__Sequence__init(
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aspn23_ros_interfaces__msg__MeasurementRangeToPoint *data = NULL;

  if (size) {
    data = (aspn23_ros_interfaces__msg__MeasurementRangeToPoint *)
    ...
    for (i = 0; i < size; ++i) {
      bool success =
          aspn23_ros_interfaces__msg__MeasurementRangeToPoint__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      // elements
      for (; i > 0; --i) {
        aspn23_ros_interfaces__msg__MeasurementRangeToPoint__fini(&data[i - 1]);
      }
...
void aspn23_ros_interfaces__msg__MeasurementRangeToPoint__Sequence__fini(
    aspn23_ros_interfaces__msg__MeasurementRangeToPoint__Sequence *array) {
  if (!array) {
    return;
  }
...
aspn23_ros_interfaces__msg__MeasurementRangeToPoint__Sequence__create(
  ...
  bool success =
      aspn23_ros_interfaces__msg__MeasurementRangeToPoint__Sequence__init(array,
                                                                          size);
  if (!success) {
...
void aspn23_ros_interfaces__msg__MeasurementRangeToPoint__Sequence__destroy(
    aspn23_ros_interfaces__msg__MeasurementRangeToPoint__Sequence *array) {
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    aspn23_ros_interfaces__msg__MeasurementRangeToPoint__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool aspn23_ros_interfaces__msg__MeasurementRangeToPoint__Sequence__are_equal(
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!aspn23_ros_interfaces__msg__MeasurementRangeToPoint__are_equal(
...
bool aspn23_ros_interfaces__msg__MeasurementRangeToPoint__Sequence__copy(
  ...
  if (output->capacity < input->size) {
    ...
    aspn23_ros_interfaces__msg__MeasurementRangeToPoint *data =
        (aspn23_ros_interfaces__msg__MeasurementRangeToPoint *)allocator
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!aspn23_ros_interfaces__msg__MeasurementRangeToPoint__init(
              &output->data[i])) {
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!aspn23_ros_interfaces__msg__MeasurementRangeToPoint__copy(
