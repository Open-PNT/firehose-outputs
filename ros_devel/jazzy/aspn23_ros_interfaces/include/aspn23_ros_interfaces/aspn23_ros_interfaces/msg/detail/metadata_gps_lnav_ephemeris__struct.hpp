...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__METADATA_GPS_LNAV_EPHEMERIS__STRUCT_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__METADATA_GPS_LNAV_EPHEMERIS__STRUCT_HPP_
...
#ifndef _WIN32
#define DEPRECATED__aspn23_ros_interfaces__msg__MetadataGpsLnavEphemeris       \
...
// message struct
template <class ContainerAllocator> struct MetadataGpsLnavEphemeris_ {
  using Type = MetadataGpsLnavEphemeris_<ContainerAllocator>;

  explicit MetadataGpsLnavEphemeris_(
  ...
  // pointer types
  using RawPtr =
      aspn23_ros_interfaces::msg::MetadataGpsLnavEphemeris_<ContainerAllocator>
          *;
  using ConstRawPtr =
      const aspn23_ros_interfaces::msg::MetadataGpsLnavEphemeris_<
          ContainerAllocator> *;
  using SharedPtr =
      std::shared_ptr<aspn23_ros_interfaces::msg::MetadataGpsLnavEphemeris_<
          ContainerAllocator>>;
  ...
  template <typename Deleter = std::default_delete<
                aspn23_ros_interfaces::msg::MetadataGpsLnavEphemeris_<
                    ContainerAllocator>>>
  ...
  using ConstUniquePtrWithDeleter =
      std::unique_ptr<aspn23_ros_interfaces::msg::MetadataGpsLnavEphemeris_<
                          ContainerAllocator> const,
                      Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::MetadataGpsLnavEphemeris_<
          ContainerAllocator>>;
  using ConstWeakPtr =
      std::weak_ptr<aspn23_ros_interfaces::msg::MetadataGpsLnavEphemeris_<
          ContainerAllocator> const>;
  ...
  // properly
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MetadataGpsLnavEphemeris
      std::shared_ptr<aspn23_ros_interfaces::msg::MetadataGpsLnavEphemeris_<
          ContainerAllocator>>
          Ptr;
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MetadataGpsLnavEphemeris
  ...
  bool operator==(const MetadataGpsLnavEphemeris_ &other) const {
...
}; // struct MetadataGpsLnavEphemeris_

// alias to use template instance with default allocator
using MetadataGpsLnavEphemeris =
    aspn23_ros_interfaces::msg::MetadataGpsLnavEphemeris_<std::allocator<void>>;
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__METADATA_GPS_LNAV_EPHEMERIS__STRUCT_HPP_
