...
// IWYU pragma: private, include "aspn23_ros_interfaces/msg/measurement_range_rate_to_point.h"

#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_RANGE_RATE_TO_POINT__STRUCT_H_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_RANGE_RATE_TO_POINT__STRUCT_H_
...
/// Constant 'ASPN23_MEASUREMENT_RANGE_RATE_TO_POINT_ERROR_MODEL_NONE'.
/**
 * No additional error model provided (num_error_model_params = 0).
 */
enum {
  aspn23_ros_interfaces__msg__MeasurementRangeRateToPoint__ASPN23_MEASUREMENT_RANGE_RATE_TO_POINT_ERROR_MODEL_NONE =
      0
};
...
/// Struct defined in msg/MeasurementRangeRateToPoint in the package
/// aspn23_ros_interfaces.
typedef struct aspn23_ros_interfaces__msg__MeasurementRangeRateToPoint {
  /// This code is generated via firehose.
  /// DO NOT hand edit code.  Make any changes required using the firehose repo
  /// instead Range rate to a point is the instantaneous rate of change in the
  /// distance between the sensor and the point at time_of_validity. Information
  ...
  /// remote_point. Description: Standard ASPN measurement header. Units: none
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_RANGE_RATE_TO_POINT__STRUCT_H_
