...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DELTA_RANGE__TRAITS_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DELTA_RANGE__TRAITS_HPP_
...
inline void to_flow_style_yaml(const MeasurementDeltaRange &msg,
                               std::ostream &out) {
  out << "{";
  // member: header
  {
...
inline void to_block_style_yaml(const MeasurementDeltaRange &msg,
...
inline std::string to_yaml(const MeasurementDeltaRange &msg,
...
inline void
to_yaml(const aspn23_ros_interfaces::msg::MeasurementDeltaRange &msg,
        std::ostream &out, size_t indentation = 0) {
...
template <>
inline const char *
data_type<aspn23_ros_interfaces::msg::MeasurementDeltaRange>() {
  return "aspn23_ros_interfaces::msg::MeasurementDeltaRange";
}

template <>
inline const char *name<aspn23_ros_interfaces::msg::MeasurementDeltaRange>() {
  return "aspn23_ros_interfaces/msg/MeasurementDeltaRange";
}

template <>
struct has_fixed_size<aspn23_ros_interfaces::msg::MeasurementDeltaRange>
    : std::integral_constant<bool, false> {};

template <>
struct has_bounded_size<aspn23_ros_interfaces::msg::MeasurementDeltaRange>
    : std::integral_constant<bool, false> {};

template <>
struct is_message<aspn23_ros_interfaces::msg::MeasurementDeltaRange>
    : std::true_type {};

} // namespace rosidl_generator_traits

#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DELTA_RANGE__TRAITS_HPP_
