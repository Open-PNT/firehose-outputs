...
bool aspn23_ros_interfaces__msg__MeasurementDeltaPosition__init(
  ...
  if (!aspn23_ros_interfaces__msg__TypeHeader__init(&msg->header)) {
    aspn23_ros_interfaces__msg__MeasurementDeltaPosition__fini(msg);
    return false;
  }
  // time_of_validity
...
void aspn23_ros_interfaces__msg__MeasurementDeltaPosition__fini(
    aspn23_ros_interfaces__msg__MeasurementDeltaPosition *msg) {
  if (!msg) {
    return;
  }
...
bool aspn23_ros_interfaces__msg__MeasurementDeltaPosition__are_equal(
...
bool aspn23_ros_interfaces__msg__MeasurementDeltaPosition__copy(
...
aspn23_ros_interfaces__msg__MeasurementDeltaPosition__create(void) {
  ...
  memset(msg, 0, sizeof(aspn23_ros_interfaces__msg__MeasurementDeltaPosition));
  bool success =
      aspn23_ros_interfaces__msg__MeasurementDeltaPosition__init(msg);
  if (!success) {
...
void aspn23_ros_interfaces__msg__MeasurementDeltaPosition__destroy(
    aspn23_ros_interfaces__msg__MeasurementDeltaPosition *msg) {
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    aspn23_ros_interfaces__msg__MeasurementDeltaPosition__fini(msg);
...
bool aspn23_ros_interfaces__msg__MeasurementDeltaPosition__Sequence__init(
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aspn23_ros_interfaces__msg__MeasurementDeltaPosition *data = NULL;

  if (size) {
    data = (aspn23_ros_interfaces__msg__MeasurementDeltaPosition *)
    ...
    for (i = 0; i < size; ++i) {
      bool success =
          aspn23_ros_interfaces__msg__MeasurementDeltaPosition__init(&data[i]);
      if (!success) {
        break;
      }
    }
...
void aspn23_ros_interfaces__msg__MeasurementDeltaPosition__Sequence__fini(
    aspn23_ros_interfaces__msg__MeasurementDeltaPosition__Sequence *array) {
  if (!array) {
    return;
  }
...
void aspn23_ros_interfaces__msg__MeasurementDeltaPosition__Sequence__destroy(
    aspn23_ros_interfaces__msg__MeasurementDeltaPosition__Sequence *array) {
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    aspn23_ros_interfaces__msg__MeasurementDeltaPosition__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool aspn23_ros_interfaces__msg__MeasurementDeltaPosition__Sequence__are_equal(
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!aspn23_ros_interfaces__msg__MeasurementDeltaPosition__are_equal(
...
bool aspn23_ros_interfaces__msg__MeasurementDeltaPosition__Sequence__copy(
  ...
  if (output->capacity < input->size) {
    ...
    aspn23_ros_interfaces__msg__MeasurementDeltaPosition *data =
        (aspn23_ros_interfaces__msg__MeasurementDeltaPosition *)allocator
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!aspn23_ros_interfaces__msg__MeasurementDeltaPosition__init(
              &output->data[i])) {
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!aspn23_ros_interfaces__msg__MeasurementDeltaPosition__copy(
