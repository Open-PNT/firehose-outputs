...
bool aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference__init(
  ...
  if (!aspn23_ros_interfaces__msg__TypeHeader__init(&msg->header)) {
    aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference__fini(msg);
    return false;
  }
  // time_of_validity
...
void aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference__fini(
    aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference *msg) {
  if (!msg) {
    return;
  }
...
bool aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference__are_equal(
...
bool aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference__copy(
...
aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference__create(void) {
  ...
  memset(
      msg, 0,
      sizeof(aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference));
  bool success =
      aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference__init(msg);
  if (!success) {
...
void aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference__destroy(
    aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference *msg) {
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference__fini(msg);
...
bool aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference__Sequence__init(
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference *data = NULL;
...
void aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference__Sequence__fini(
    aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference__Sequence
        *array) {
  if (!array) {
    return;
...
aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference__Sequence__create(
    size_t size) {
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference__Sequence *array =
      (aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference__Sequence
           *)
          allocator.allocate(
              sizeof(
...
void aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference__Sequence__destroy(
    aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference__Sequence
        *array) {
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
...
bool aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference__Sequence__are_equal(
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference__are_equal(
...
bool aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference__Sequence__copy(
    const aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference__Sequence
        *input,
    aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference__Sequence
        *output) {
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
        ...
        sizeof(aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference *data =
        (aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference *)
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference__init(
              &output->data[i])) {
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!aspn23_ros_interfaces__msg__MeasurementTimeFrequencyDifference__copy(
