...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DIRECTION2_D_TO_POINTS__TRAITS_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DIRECTION2_D_TO_POINTS__TRAITS_HPP_
...
// Member 'obs'
#include "aspn23_ros_interfaces/msg/detail/type_direction2_d_to_point__traits.hpp"

namespace aspn23_ros_interfaces {

namespace msg {

inline void to_flow_style_yaml(const MeasurementDirection2DToPoints &msg,
                               std::ostream &out) {
  out << "{";
  // member: header
  {
...
inline void to_block_style_yaml(const MeasurementDirection2DToPoints &msg,
...
inline std::string to_yaml(const MeasurementDirection2DToPoints &msg,
...
inline void
to_yaml(const aspn23_ros_interfaces::msg::MeasurementDirection2DToPoints &msg,
        std::ostream &out, size_t indentation = 0) {
...
template <>
inline const char *
data_type<aspn23_ros_interfaces::msg::MeasurementDirection2DToPoints>() {
  return "aspn23_ros_interfaces::msg::MeasurementDirection2DToPoints";
}

template <>
inline const char *
name<aspn23_ros_interfaces::msg::MeasurementDirection2DToPoints>() {
  return "aspn23_ros_interfaces/msg/MeasurementDirection2DToPoints";
}
...
template <>
struct is_message<aspn23_ros_interfaces::msg::MeasurementDirection2DToPoints>
    : std::true_type {};

} // namespace rosidl_generator_traits

#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_DIRECTION2_D_TO_POINTS__TRAITS_HPP_
