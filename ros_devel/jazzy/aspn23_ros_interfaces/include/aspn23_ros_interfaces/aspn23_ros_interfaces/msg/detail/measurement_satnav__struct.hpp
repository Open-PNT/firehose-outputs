...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_SATNAV__STRUCT_HPP_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_SATNAV__STRUCT_HPP_
...
#ifndef _WIN32
#define DEPRECATED__aspn23_ros_interfaces__msg__MeasurementSatnav              \
...
// message struct
template <class ContainerAllocator> struct MeasurementSatnav_ {
  using Type = MeasurementSatnav_<ContainerAllocator>;

  explicit MeasurementSatnav_(
  ...
  // pointer types
  using RawPtr =
      aspn23_ros_interfaces::msg::MeasurementSatnav_<ContainerAllocator> *;
  using ConstRawPtr =
      const aspn23_ros_interfaces::msg::MeasurementSatnav_<ContainerAllocator>
          *;
  using SharedPtr = std::shared_ptr<
      aspn23_ros_interfaces::msg::MeasurementSatnav_<ContainerAllocator>>;
  using ConstSharedPtr = std::shared_ptr<
      aspn23_ros_interfaces::msg::MeasurementSatnav_<ContainerAllocator> const>;
  ...
  // properly
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementSatnav
      std::shared_ptr<
          aspn23_ros_interfaces::msg::MeasurementSatnav_<ContainerAllocator>>
          Ptr;
  typedef DEPRECATED__aspn23_ros_interfaces__msg__MeasurementSatnav
      std::shared_ptr<aspn23_ros_interfaces::msg::MeasurementSatnav_<
          ContainerAllocator> const>
          ConstPtr;

  // comparison operators
  bool operator==(const MeasurementSatnav_ &other) const {
...
}; // struct MeasurementSatnav_

// alias to use template instance with default allocator
using MeasurementSatnav =
    aspn23_ros_interfaces::msg::MeasurementSatnav_<std::allocator<void>>;
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_SATNAV__STRUCT_HPP_
