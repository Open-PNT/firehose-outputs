...
#ifndef ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_BAROMETER__STRUCT_H_
#define ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_BAROMETER__STRUCT_H_
...
/// Constant 'ASPN23_MEASUREMENT_BAROMETER_ERROR_MODEL_NONE'.
/**
 * No additional error model provided (num_error_model_params = 0).
 */
enum {
  aspn23_ros_interfaces__msg__MeasurementBarometer__ASPN23_MEASUREMENT_BAROMETER_ERROR_MODEL_NONE =
      0
};
...
/// Struct defined in msg/MeasurementBarometer in the package
/// aspn23_ros_interfaces.
typedef struct aspn23_ros_interfaces__msg__MeasurementBarometer {
  /// This code is generated via firehose.
  /// DO NOT hand edit code.  Make any changes required using the firehose repo
  /// instead Barometric pressure. Description: Standard ASPN measurement
  /// header. Units: none
...
// Struct for a sequence of aspn23_ros_interfaces__msg__MeasurementBarometer.
typedef struct aspn23_ros_interfaces__msg__MeasurementBarometer__Sequence {
...
#endif // ASPN23_ROS_INTERFACES__MSG__DETAIL__MEASUREMENT_BAROMETER__STRUCT_H_
