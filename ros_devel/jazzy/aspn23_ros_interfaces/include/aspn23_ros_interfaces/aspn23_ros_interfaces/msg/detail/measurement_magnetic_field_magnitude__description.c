...
aspn23_ros_interfaces__msg__MeasurementMagneticFieldMagnitude__get_type_hash(
  ...
  static rosidl_type_hash_t hash = {
      1,
      {
          0xae, 0x9d, 0x8d, 0x9f, 0x1d, 0xf4, 0x31, 0xbc, 0x93, 0xc0, 0xa2,
          0xb9, 0xa7, 0x3c, 0xc1, 0xb2, 0xc1, 0xde, 0xf6, 0x21, 0x8f, 0xdb,
          0x28, 0xb8, 0xe9, 0xf9, 0xde, 0xb3, 0x50, 0x78, 0xbd, 0x35,
      }};
  return &hash;
}
...
static char
    aspn23_ros_interfaces__msg__MeasurementMagneticFieldMagnitude__TYPE_NAME[] =
...
static char
    aspn23_ros_interfaces__msg__MeasurementMagneticFieldMagnitude__FIELD_NAME__header
        [] = "header";
static char
    aspn23_ros_interfaces__msg__MeasurementMagneticFieldMagnitude__FIELD_NAME__time_of_validity
        [] = "time_of_validity";
static char
    aspn23_ros_interfaces__msg__MeasurementMagneticFieldMagnitude__FIELD_NAME__field_strength
        [] = "field_strength";
static char
    aspn23_ros_interfaces__msg__MeasurementMagneticFieldMagnitude__FIELD_NAME__variance
        [] = "variance";
static char
    aspn23_ros_interfaces__msg__MeasurementMagneticFieldMagnitude__FIELD_NAME__error_model
        [] = "error_model";
static char
    aspn23_ros_interfaces__msg__MeasurementMagneticFieldMagnitude__FIELD_NAME__num_error_model_params
        [] = "num_error_model_params";
static char
    aspn23_ros_interfaces__msg__MeasurementMagneticFieldMagnitude__FIELD_NAME__error_model_params
        [] = "error_model_params";
static char
    aspn23_ros_interfaces__msg__MeasurementMagneticFieldMagnitude__FIELD_NAME__num_integrity
        [] = "num_integrity";
static char
    aspn23_ros_interfaces__msg__MeasurementMagneticFieldMagnitude__FIELD_NAME__integrity
        [] = "integrity";

static rosidl_runtime_c__type_description__Field
    aspn23_ros_interfaces__msg__MeasurementMagneticFieldMagnitude__FIELDS[] = {
        {
            {aspn23_ros_interfaces__msg__MeasurementMagneticFieldMagnitude__FIELD_NAME__header,
             6, 6},
            {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription
    aspn23_ros_interfaces__msg__MeasurementMagneticFieldMagnitude__REFERENCED_TYPE_DESCRIPTIONS
        [] = {
            {
                {aspn23_ros_interfaces__msg__TypeHeader__TYPE_NAME, 36, 36},
                {NULL, 0, 0},
...
static char toplevel_type_raw_source[] =
    ...
    "\n"
    "# Description: Field strength magnitude of magnetic field in nanoTesla "
    "(nT).\n"
    "# Units: nT\n"
    "float64 field_strength\n"
    "\n"
    ...
    "uint8 ASPN23_MEASUREMENT_MAGNETIC_FIELD_MAGNITUDE_ERROR_MODEL_NONE=0\n"
    "\n"
...
aspn23_ros_interfaces__msg__MeasurementMagneticFieldMagnitude__get_individual_type_description_source(
  ...
  static const rosidl_runtime_c__type_description__TypeSource source = {
      {aspn23_ros_interfaces__msg__MeasurementMagneticFieldMagnitude__TYPE_NAME,
       59, 59},
      {msg_encoding, 3, 3},
      {toplevel_type_raw_source, 1556, 1556},
  };
  return &source;
}
