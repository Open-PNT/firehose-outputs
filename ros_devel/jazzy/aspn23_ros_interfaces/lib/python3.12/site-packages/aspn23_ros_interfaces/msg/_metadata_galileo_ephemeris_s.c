...
bool aspn23_ros_interfaces__msg__metadata_galileo_ephemeris__convert_from_py(
  ...
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aspn23_ros_interfaces.msg._metadata_galileo_ephemeris."
  ...
  { // nav_msg_type
    PyObject *field = PyObject_GetAttrString(_pymsg, "nav_msg_type");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->nav_msg_type = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  { // prn
  ...
  { // bgd
    PyObject *field = PyObject_GetAttrString(_pymsg, "bgd");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->bgd = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject *aspn23_ros_interfaces__msg__metadata_galileo_ephemeris__convert_to_py(
    void *raw_ros_message) {
  /* NOTE(esteve): Call constructor of MetadataGalileoEphemeris */
  PyObject *_pymessage = NULL;
  {
    PyObject *pymessage_module = PyImport_ImportModule(
        "aspn23_ros_interfaces.msg._metadata_galileo_ephemeris");
    assert(pymessage_module);
    PyObject *pymessage_class =
        PyObject_GetAttrString(pymessage_module, "MetadataGalileoEphemeris");
  ...
  { // nav_msg_type
    PyObject *field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->nav_msg_type);
    {
      int rc = PyObject_SetAttrString(_pymessage, "nav_msg_type", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  { // bgd
    PyObject *field = NULL;
    field = PyFloat_FromDouble(ros_message->bgd);
    {
      int rc = PyObject_SetAttrString(_pymessage, "bgd", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
