...
bool aspn23_ros_interfaces__msg__type_image_feature__convert_from_py(
  ...
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
               "aspn23_ros_interfaces.msg._type_image_feature.TypeImageFeature",
               full_classname_dest, 62) == 0);
  }
  aspn23_ros_interfaces__msg__TypeImageFeature *ros_message = _ros_message;
  { // response
  ...
  { // octave
    ...
    assert(PyLong_Check(field));
    ros_message->octave = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  { // descriptor_size
    PyObject *field = PyObject_GetAttrString(_pymsg, "descriptor_size");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->descriptor_size = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  { // descriptor
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      if (!rosidl_runtime_c__uint8__Sequence__init(&(ros_message->descriptor),
                                                   size)) {
      ...
      uint8_t *dest = ros_message->descriptor.data;
      ...
      PyObject *seq_field =
          PySequence_Fast(field, "expected a sequence in 'descriptor'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
PyObject *aspn23_ros_interfaces__msg__type_image_feature__convert_to_py(
  ...
  /* NOTE(esteve): Call constructor of TypeImageFeature */
  PyObject *_pymessage = NULL;
  {
    PyObject *pymessage_module =
        PyImport_ImportModule("aspn23_ros_interfaces.msg._type_image_feature");
    assert(pymessage_module);
    PyObject *pymessage_class =
        PyObject_GetAttrString(pymessage_module, "TypeImageFeature");
  ...
  { // octave
    PyObject *field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->octave);
    {
  ...
  { // descriptor_size
    PyObject *field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->descriptor_size);
    {
      int rc = PyObject_SetAttrString(_pymessage, "descriptor_size", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  { // descriptor
    ...
    if (ros_message->descriptor.size > 0) {
      ...
      uint8_t *src = &(ros_message->descriptor.data[0]);
      PyObject *data = PyBytes_FromStringAndSize(
          (const char *)src, ros_message->descriptor.size * sizeof(uint8_t));
      assert(data != NULL);
