...
bool aspn23_ros_interfaces__msg__metadata_magnetic_field__convert_from_py(
  ...
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aspn23_ros_interfaces.msg._metadata_magnetic_field."
                   "MetadataMagneticField",
                   full_classname_dest, 72) == 0);
  }
  aspn23_ros_interfaces__msg__MetadataMagneticField *ros_message = _ros_message;
  { // info
  ...
  { // k
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      PyObject *seq_field =
          PySequence_Fast(field, "expected a sequence in 'k'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  { // b
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      PyObject *seq_field =
          PySequence_Fast(field, "expected a sequence in 'b'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
PyObject *aspn23_ros_interfaces__msg__metadata_magnetic_field__convert_to_py(
    void *raw_ros_message) {
  /* NOTE(esteve): Call constructor of MetadataMagneticField */
  PyObject *_pymessage = NULL;
  {
    PyObject *pymessage_module = PyImport_ImportModule(
        "aspn23_ros_interfaces.msg._metadata_magnetic_field");
    assert(pymessage_module);
    PyObject *pymessage_class =
        PyObject_GetAttrString(pymessage_module, "MetadataMagneticField");
  ...
  { // k
    ...
    if (ros_message->k.size > 0) {
      ...
      PyObject *data = PyBytes_FromStringAndSize(
          (const char *)src, ros_message->k.size * sizeof(double));
      assert(data != NULL);
  ...
  { // b
    ...
    if (ros_message->b.size > 0) {
      ...
      PyObject *data = PyBytes_FromStringAndSize(
          (const char *)src, ros_message->b.size * sizeof(double));
      assert(data != NULL);
      PyObject *ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
