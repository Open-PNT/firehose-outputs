...
bool aspn23_ros_interfaces__msg__measurement_tdoa2_tx1_rx__convert_from_py(
  ...
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aspn23_ros_interfaces.msg._measurement_tdoa2_tx1_rx."
                   "MeasurementTdoa2Tx1Rx",
                   full_classname_dest, 73) == 0);
  }
  aspn23_ros_interfaces__msg__MeasurementTdoa2Tx1Rx *ros_message = _ros_message;
  { // header
  ...
  { // tx1_position_and_covariance
    PyObject *field =
        PyObject_GetAttrString(_pymsg, "tx1_position_and_covariance");
    if (!field) {
      return false;
    }
    if (!aspn23_ros_interfaces__msg__type_remote_point__convert_from_py(
            field, &ros_message->tx1_position_and_covariance)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  { // tx2_position_and_covariance
    PyObject *field =
        PyObject_GetAttrString(_pymsg, "tx2_position_and_covariance");
    if (!field) {
      return false;
    }
    if (!aspn23_ros_interfaces__msg__type_remote_point__convert_from_py(
            field, &ros_message->tx2_position_and_covariance)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject *aspn23_ros_interfaces__msg__measurement_tdoa2_tx1_rx__convert_to_py(
    void *raw_ros_message) {
  /* NOTE(esteve): Call constructor of MeasurementTdoa2Tx1Rx */
  PyObject *_pymessage = NULL;
  {
    PyObject *pymessage_module = PyImport_ImportModule(
        "aspn23_ros_interfaces.msg._measurement_tdoa2_tx1_rx");
    assert(pymessage_module);
    PyObject *pymessage_class =
        PyObject_GetAttrString(pymessage_module, "MeasurementTdoa2Tx1Rx");
  ...
  { // tx1_position_and_covariance
    ...
    field = aspn23_ros_interfaces__msg__type_remote_point__convert_to_py(
        &ros_message->tx1_position_and_covariance);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "tx1_position_and_covariance",
                                      field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
  ...
  { // tx2_position_and_covariance
    PyObject *field = NULL;
    field = aspn23_ros_interfaces__msg__type_remote_point__convert_to_py(
        &ros_message->tx2_position_and_covariance);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "tx2_position_and_covariance",
                                      field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
