...
bool aspn23_ros_interfaces__msg__measurement_time__convert_from_py(
  ...
  // check that the passed message is of the expected Python class
  {
    ...
    assert(
        strncmp("aspn23_ros_interfaces.msg._measurement_time.MeasurementTime",
                full_classname_dest, 59) == 0);
  }
  aspn23_ros_interfaces__msg__MeasurementTime *ros_message = _ros_message;
  { // header
  ...
  { // time_of_validity_attosec
    PyObject *field =
        PyObject_GetAttrString(_pymsg, "time_of_validity_attosec");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->time_of_validity_attosec = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  { // num_obs
    ...
    assert(PyLong_Check(field));
    ros_message->num_obs = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  { // clock_id
    PyObject *field = PyObject_GetAttrString(_pymsg, "clock_id");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      if (!rosidl_runtime_c__uint8__Sequence__init(&(ros_message->clock_id),
                                                   size)) {
      ...
      uint8_t *dest = ros_message->clock_id.data;
      ...
      PyObject *seq_field =
          PySequence_Fast(field, "expected a sequence in 'clock_id'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  { // elapsed_nsec
    PyObject *field = PyObject_GetAttrString(_pymsg, "elapsed_nsec");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      if (!rosidl_runtime_c__int64__Sequence__init(&(ros_message->elapsed_nsec),
                                                   size)) {
        PyErr_SetString(PyExc_RuntimeError,
                        "unable to create int64__Sequence ros_message");
        PyBuffer_Release(&view);
        Py_DECREF(field);
        return false;
      }
      int64_t *dest = ros_message->elapsed_nsec.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject *seq_field =
          PySequence_Fast(field, "expected a sequence in 'elapsed_nsec'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  { // elapsed_attosec
    PyObject *field = PyObject_GetAttrString(_pymsg, "elapsed_attosec");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      if (!rosidl_runtime_c__int32__Sequence__init(
              &(ros_message->elapsed_attosec), size)) {
        PyErr_SetString(PyExc_RuntimeError,
                        "unable to create int32__Sequence ros_message");
        PyBuffer_Release(&view);
        Py_DECREF(field);
        return false;
      }
      int32_t *dest = ros_message->elapsed_attosec.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject *seq_field =
          PySequence_Fast(field, "expected a sequence in 'elapsed_attosec'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
PyObject *aspn23_ros_interfaces__msg__measurement_time__convert_to_py(
    void *raw_ros_message) {
  /* NOTE(esteve): Call constructor of MeasurementTime */
  PyObject *_pymessage = NULL;
  {
    PyObject *pymessage_module =
        PyImport_ImportModule("aspn23_ros_interfaces.msg._measurement_time");
    assert(pymessage_module);
    PyObject *pymessage_class =
        PyObject_GetAttrString(pymessage_module, "MeasurementTime");
  ...
  { // time_of_validity_attosec
    PyObject *field = NULL;
    field = PyLong_FromLong(ros_message->time_of_validity_attosec);
    {
      int rc =
          PyObject_SetAttrString(_pymessage, "time_of_validity_attosec", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  { // clock_id
    PyObject *field = NULL;
    field = PyObject_GetAttrString(_pymessage, "clock_id");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->clock_id.size > 0) {
      // populating the array.array using the frombytes method
      PyObject *frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint8_t *src = &(ros_message->clock_id.data[0]);
      PyObject *data = PyBytes_FromStringAndSize(
          (const char *)src, ros_message->clock_id.size * sizeof(uint8_t));
      assert(data != NULL);
  ...
  { // elapsed_nsec
    PyObject *field = NULL;
    field = PyObject_GetAttrString(_pymessage, "elapsed_nsec");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->elapsed_nsec.size > 0) {
      // populating the array.array using the frombytes method
      PyObject *frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int64_t *src = &(ros_message->elapsed_nsec.data[0]);
      PyObject *data = PyBytes_FromStringAndSize(
          (const char *)src, ros_message->elapsed_nsec.size * sizeof(int64_t));
      assert(data != NULL);
      PyObject *ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  { // elapsed_attosec
    PyObject *field = NULL;
    field = PyObject_GetAttrString(_pymessage, "elapsed_attosec");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->elapsed_attosec.size > 0) {
      // populating the array.array using the frombytes method
      PyObject *frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int32_t *src = &(ros_message->elapsed_attosec.data[0]);
      PyObject *data = PyBytes_FromStringAndSize(
          (const char *)src,
          ros_message->elapsed_attosec.size * sizeof(int32_t));
      assert(data != NULL);
      PyObject *ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
