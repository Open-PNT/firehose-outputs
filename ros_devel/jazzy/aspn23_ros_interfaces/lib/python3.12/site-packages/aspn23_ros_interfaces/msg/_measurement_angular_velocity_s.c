...
bool aspn23_ros_interfaces__msg__measurement_angular_velocity__convert_from_py(
  ...
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aspn23_ros_interfaces.msg._measurement_angular_velocity."
...
aspn23_ros_interfaces__msg__measurement_angular_velocity__convert_to_py(
    void *raw_ros_message) {
  /* NOTE(esteve): Call constructor of MeasurementAngularVelocity */
  PyObject *_pymessage = NULL;
  {
    PyObject *pymessage_module = PyImport_ImportModule(
        "aspn23_ros_interfaces.msg._measurement_angular_velocity");
    assert(pymessage_module);
    PyObject *pymessage_class =
        PyObject_GetAttrString(pymessage_module, "MeasurementAngularVelocity");
  ...
  { // meas
    PyObject *field = NULL;
    field = PyObject_GetAttrString(_pymessage, "meas");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
