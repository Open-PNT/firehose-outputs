...
bool aspn23_ros_interfaces__msg__type_timestamp__convert_from_py(
  ...
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aspn23_ros_interfaces.msg._type_timestamp.TypeTimestamp",
                   full_classname_dest, 55) == 0);
  }
  aspn23_ros_interfaces__msg__TypeTimestamp *ros_message = _ros_message;
  { // elapsed_nsec
    ...
    ros_message->elapsed_nsec = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
...
PyObject *aspn23_ros_interfaces__msg__type_timestamp__convert_to_py(
  ...
  /* NOTE(esteve): Call constructor of TypeTimestamp */
  PyObject *_pymessage = NULL;
  {
    PyObject *pymessage_module =
        PyImport_ImportModule("aspn23_ros_interfaces.msg._type_timestamp");
    assert(pymessage_module);
    PyObject *pymessage_class =
        PyObject_GetAttrString(pymessage_module, "TypeTimestamp");
  ...
  { // elapsed_nsec
    PyObject *field = NULL;
    field = PyLong_FromLongLong(ros_message->elapsed_nsec);
    {
      int rc = PyObject_SetAttrString(_pymessage, "elapsed_nsec", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
