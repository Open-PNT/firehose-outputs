...
bool aspn23_ros_interfaces__msg__metadata_beidou_ephemeris__convert_from_py(
  ...
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aspn23_ros_interfaces.msg._metadata_beidou_ephemeris."
  ...
  { // t_gd1
    PyObject *field = PyObject_GetAttrString(_pymsg, "t_gd1");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->t_gd1 = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  { // t_gd2
    PyObject *field = PyObject_GetAttrString(_pymsg, "t_gd2");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->t_gd2 = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  { // aodc
    PyObject *field = PyObject_GetAttrString(_pymsg, "aodc");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->aodc = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  { // aode
    PyObject *field = PyObject_GetAttrString(_pymsg, "aode");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->aode = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
PyObject *aspn23_ros_interfaces__msg__metadata_beidou_ephemeris__convert_to_py(
    void *raw_ros_message) {
  /* NOTE(esteve): Call constructor of MetadataBeidouEphemeris */
  PyObject *_pymessage = NULL;
  {
    PyObject *pymessage_module = PyImport_ImportModule(
        "aspn23_ros_interfaces.msg._metadata_beidou_ephemeris");
    assert(pymessage_module);
    PyObject *pymessage_class =
        PyObject_GetAttrString(pymessage_module, "MetadataBeidouEphemeris");
  ...
  { // t_gd1
    PyObject *field = NULL;
    field = PyFloat_FromDouble(ros_message->t_gd1);
    {
      int rc = PyObject_SetAttrString(_pymessage, "t_gd1", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  { // t_gd2
    PyObject *field = NULL;
    field = PyFloat_FromDouble(ros_message->t_gd2);
    {
      int rc = PyObject_SetAttrString(_pymessage, "t_gd2", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  { // aodc
    PyObject *field = NULL;
    field = PyLong_FromLong(ros_message->aodc);
    {
      int rc = PyObject_SetAttrString(_pymessage, "aodc", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  { // aode
    PyObject *field = NULL;
    field = PyLong_FromLong(ros_message->aode);
    {
      int rc = PyObject_SetAttrString(_pymessage, "aode", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
