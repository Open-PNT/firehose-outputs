...
bool aspn23_ros_interfaces__msg__metadata_gps_lnav_ephemeris__convert_from_py(
  ...
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aspn23_ros_interfaces.msg._metadata_gps_lnav_ephemeris."
...
aspn23_ros_interfaces__msg__metadata_gps_lnav_ephemeris__convert_to_py(
    void *raw_ros_message) {
  /* NOTE(esteve): Call constructor of MetadataGpsLnavEphemeris */
  PyObject *_pymessage = NULL;
  {
    PyObject *pymessage_module = PyImport_ImportModule(
        "aspn23_ros_interfaces.msg._metadata_gps_lnav_ephemeris");
    assert(pymessage_module);
    PyObject *pymessage_class =
        PyObject_GetAttrString(pymessage_module, "MetadataGpsLnavEphemeris");
