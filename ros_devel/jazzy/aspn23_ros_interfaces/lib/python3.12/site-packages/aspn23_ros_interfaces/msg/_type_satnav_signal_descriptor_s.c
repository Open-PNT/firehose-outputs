...
bool aspn23_ros_interfaces__msg__type_satnav_signal_descriptor__convert_from_py(
  ...
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aspn23_ros_interfaces.msg._type_satnav_signal_descriptor."
  ...
  { // signal_descriptor
    ...
    ros_message->signal_descriptor = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
aspn23_ros_interfaces__msg__type_satnav_signal_descriptor__convert_to_py(
  ...
  /* NOTE(esteve): Call constructor of TypeSatnavSignalDescriptor */
  PyObject *_pymessage = NULL;
  {
    PyObject *pymessage_module = PyImport_ImportModule(
        "aspn23_ros_interfaces.msg._type_satnav_signal_descriptor");
    assert(pymessage_module);
    PyObject *pymessage_class =
        PyObject_GetAttrString(pymessage_module, "TypeSatnavSignalDescriptor");
  ...
  { // signal_descriptor
    PyObject *field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->signal_descriptor);
    {
