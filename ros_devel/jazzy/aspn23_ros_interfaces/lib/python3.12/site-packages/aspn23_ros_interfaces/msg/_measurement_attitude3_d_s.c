...
bool aspn23_ros_interfaces__msg__measurement_attitude3_d__convert_from_py(
  ...
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aspn23_ros_interfaces.msg._measurement_attitude3_d."
                   "MeasurementAttitude3D",
                   full_classname_dest, 72) == 0);
  }
  aspn23_ros_interfaces__msg__MeasurementAttitude3D *ros_message = _ros_message;
  { // header
  ...
  { // tilt_error_covariance
    PyObject *field = PyObject_GetAttrString(_pymsg, "tilt_error_covariance");
    if (!field) {
      return false;
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_FLOAT64);
      Py_ssize_t size = 9;
      double *dest = ros_message->tilt_error_covariance;
      for (Py_ssize_t i = 0; i < size; ++i) {
        double tmp = *(npy_float64 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(double));
      }
...
PyObject *aspn23_ros_interfaces__msg__measurement_attitude3_d__convert_to_py(
    void *raw_ros_message) {
  /* NOTE(esteve): Call constructor of MeasurementAttitude3D */
  PyObject *_pymessage = NULL;
  {
    PyObject *pymessage_module = PyImport_ImportModule(
        "aspn23_ros_interfaces.msg._measurement_attitude3_d");
    assert(pymessage_module);
    PyObject *pymessage_class =
        PyObject_GetAttrString(pymessage_module, "MeasurementAttitude3D");
  ...
  { // tilt_error_covariance
    PyObject *field = NULL;
    field = PyObject_GetAttrString(_pymessage, "tilt_error_covariance");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    assert(sizeof(npy_float64) == sizeof(double));
    npy_float64 *dst = (npy_float64 *)PyArray_GETPTR1(seq_field, 0);
    double *src = &(ros_message->tilt_error_covariance[0]);
