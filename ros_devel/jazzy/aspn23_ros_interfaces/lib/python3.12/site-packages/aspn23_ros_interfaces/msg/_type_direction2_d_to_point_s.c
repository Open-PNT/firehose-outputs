...
bool aspn23_ros_interfaces__msg__type_direction2_d_to_point__convert_from_py(
  ...
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aspn23_ros_interfaces.msg._type_direction2_d_to_point."
  ...
  aspn23_ros_interfaces__msg__TypeDirection2DToPoint *ros_message =
      _ros_message;
  { // remote_point
    PyObject *field = PyObject_GetAttrString(_pymsg, "remote_point");
    if (!field) {
      return false;
    }
    if (!aspn23_ros_interfaces__msg__type_remote_point__convert_from_py(
            field, &ros_message->remote_point)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  { // obs
    ...
    ros_message->obs = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  { // variance
  ...
  { // has_observation_characteristics
    PyObject *field =
        PyObject_GetAttrString(_pymsg, "has_observation_characteristics");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->has_observation_characteristics = (Py_True == field);
    Py_DECREF(field);
  }
  { // observation_characteristics
    PyObject *field =
        PyObject_GetAttrString(_pymsg, "observation_characteristics");
    if (!field) {
      return false;
    }
    if (!aspn23_ros_interfaces__msg__type_image_feature__convert_from_py(
            field, &ros_message->observation_characteristics)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject *aspn23_ros_interfaces__msg__type_direction2_d_to_point__convert_to_py(
    void *raw_ros_message) {
  /* NOTE(esteve): Call constructor of TypeDirection2DToPoint */
  PyObject *_pymessage = NULL;
  {
    PyObject *pymessage_module = PyImport_ImportModule(
        "aspn23_ros_interfaces.msg._type_direction2_d_to_point");
    assert(pymessage_module);
    PyObject *pymessage_class =
        PyObject_GetAttrString(pymessage_module, "TypeDirection2DToPoint");
  ...
  { // remote_point
    PyObject *field = NULL;
    field = aspn23_ros_interfaces__msg__type_remote_point__convert_to_py(
        &ros_message->remote_point);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "remote_point", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  { // obs
    PyObject *field = NULL;
    field = PyFloat_FromDouble(ros_message->obs);
    {
  ...
  { // has_observation_characteristics
    PyObject *field = NULL;
    field =
        PyBool_FromLong(ros_message->has_observation_characteristics ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage,
                                      "has_observation_characteristics", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  { // observation_characteristics
    PyObject *field = NULL;
    field = aspn23_ros_interfaces__msg__type_image_feature__convert_to_py(
        &ros_message->observation_characteristics);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "observation_characteristics",
                                      field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
