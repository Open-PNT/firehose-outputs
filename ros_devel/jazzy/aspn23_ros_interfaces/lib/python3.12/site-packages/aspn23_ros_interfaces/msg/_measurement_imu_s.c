...
bool aspn23_ros_interfaces__msg__measurement_imu__convert_from_py(
  ...
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aspn23_ros_interfaces.msg._measurement_imu.MeasurementImu",
                   full_classname_dest, 57) == 0);
  }
  aspn23_ros_interfaces__msg__MeasurementImu *ros_message = _ros_message;
  { // header
  ...
  { // meas_accel
    PyObject *field = PyObject_GetAttrString(_pymsg, "meas_accel");
    if (!field) {
      return false;
    }
    {
      ...
      Py_ssize_t size = 3;
      double *dest = ros_message->meas_accel;
  ...
  { // meas_gyro
    ...
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_FLOAT64);
      Py_ssize_t size = 3;
      double *dest = ros_message->meas_gyro;
      for (Py_ssize_t i = 0; i < size; ++i) {
        double tmp = *(npy_float64 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(double));
      }
...
PyObject *aspn23_ros_interfaces__msg__measurement_imu__convert_to_py(
    void *raw_ros_message) {
  /* NOTE(esteve): Call constructor of MeasurementImu */
  PyObject *_pymessage = NULL;
  {
    PyObject *pymessage_module =
        PyImport_ImportModule("aspn23_ros_interfaces.msg._measurement_imu");
    assert(pymessage_module);
    PyObject *pymessage_class =
        PyObject_GetAttrString(pymessage_module, "MeasurementImu");
  ...
  { // meas_accel
    PyObject *field = NULL;
    field = PyObject_GetAttrString(_pymessage, "meas_accel");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    double *src = &(ros_message->meas_accel[0]);
  ...
  { // meas_gyro
    ...
    assert(sizeof(npy_float64) == sizeof(double));
    npy_float64 *dst = (npy_float64 *)PyArray_GETPTR1(seq_field, 0);
    double *src = &(ros_message->meas_gyro[0]);
    memcpy(dst, src, 3 * sizeof(double));
    Py_DECREF(field);
  }
  { // num_integrity
