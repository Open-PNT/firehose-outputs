...
bool aspn23_ros_interfaces__msg__measurement_direction2_d_to_points__convert_from_py(
  ...
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aspn23_ros_interfaces.msg._measurement_direction2_d_to_"
                   "points.MeasurementDirection2DToPoints",
  ...
  { // obs
    ...
    if (!aspn23_ros_interfaces__msg__TypeDirection2DToPoint__Sequence__init(
      ...
      PyErr_SetString(PyExc_RuntimeError,
                      "unable to create "
                      "aspn23_ros_interfaces__msg__TypeDirection2DToPoint__"
                      "Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    aspn23_ros_interfaces__msg__TypeDirection2DToPoint *dest =
        ros_message->obs.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!aspn23_ros_interfaces__msg__type_direction2_d_to_point__convert_from_py(
...
aspn23_ros_interfaces__msg__measurement_direction2_d_to_points__convert_to_py(
    void *raw_ros_message) {
  /* NOTE(esteve): Call constructor of MeasurementDirection2DToPoints */
  PyObject *_pymessage = NULL;
  {
    PyObject *pymessage_module = PyImport_ImportModule(
        "aspn23_ros_interfaces.msg._measurement_direction2_d_to_points");
    assert(pymessage_module);
    PyObject *pymessage_class = PyObject_GetAttrString(
        pymessage_module, "MeasurementDirection2DToPoints");
