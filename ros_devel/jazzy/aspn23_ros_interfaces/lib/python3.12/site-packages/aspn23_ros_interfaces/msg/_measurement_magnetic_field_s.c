...
bool aspn23_ros_interfaces__msg__measurement_magnetic_field__convert_from_py(
  ...
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aspn23_ros_interfaces.msg._measurement_magnetic_field."
  ...
  { // x_field_strength
    PyObject *field = PyObject_GetAttrString(_pymsg, "x_field_strength");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->x_field_strength = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  { // y_field_strength
    PyObject *field = PyObject_GetAttrString(_pymsg, "y_field_strength");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->y_field_strength = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  { // z_field_strength
    PyObject *field = PyObject_GetAttrString(_pymsg, "z_field_strength");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->z_field_strength = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  { // covariance
...
PyObject *aspn23_ros_interfaces__msg__measurement_magnetic_field__convert_to_py(
    void *raw_ros_message) {
  /* NOTE(esteve): Call constructor of MeasurementMagneticField */
  PyObject *_pymessage = NULL;
  {
    PyObject *pymessage_module = PyImport_ImportModule(
        "aspn23_ros_interfaces.msg._measurement_magnetic_field");
    assert(pymessage_module);
    PyObject *pymessage_class =
        PyObject_GetAttrString(pymessage_module, "MeasurementMagneticField");
  ...
  { // x_field_strength
    PyObject *field = NULL;
    field = PyFloat_FromDouble(ros_message->x_field_strength);
    {
      int rc = PyObject_SetAttrString(_pymessage, "x_field_strength", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  { // y_field_strength
    PyObject *field = NULL;
    field = PyFloat_FromDouble(ros_message->y_field_strength);
    {
      int rc = PyObject_SetAttrString(_pymessage, "y_field_strength", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  { // z_field_strength
    PyObject *field = NULL;
    field = PyFloat_FromDouble(ros_message->z_field_strength);
    {
      int rc = PyObject_SetAttrString(_pymessage, "z_field_strength", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
